 ...
 * @return 返回格式化的金额
 */
 function formatAmountForTP(strData)
 {
 	if(isInnerFloat(strData))
 	{
 		if(strData!="")
	...
	if (window.event.keyCode!=13)//
	{
	 	...
	 	if (isInnerFloat(strOldData))//是否是浮点数
	 	{
			...
			else
			{
    	 			...
    	 			{
					strNewData=formatAmountForTP(strOldData);
				}
			}
			if(strNewData=="")//
			{
...
* 可以写多个同名的金额控件,内部使用接口
*/
function createMutiAmountBaseFun(strFormName,strCtrlName,strData,deci,sProperty,strNextCtrlName,txtStyle){
  document.writeln(" <input class='" + txtStyle + "' type='text' name='"+ strCtrlName + "' value='" + formatNumber( strData,deci ) +"' onkeypress='filterKey(this)' size='18' maxlength='15' onblur='adjustNumber(\"" + strNextCtrlName + "\",this," + deci +",1)'  onfocus='adjustNumber(\"" + strNextCtrlName + "\",this," + deci +",2)' " + sProperty + ">");
  }
...
*/
  ...
  createMutiAmountBaseFun(strFormName,strCtrlName,strData,2,"",strNextCtrlName,"tar");
  }
...
createMutiAmountBaseFun(strFormName,strCtrlName,strData,deci,"",strNextCtrlName,"tar");
}
...
createMutiAmountBaseFun(strFormName,strCtrlName,strData,deci,"",strNextCtrlName,txtStyle);
}
