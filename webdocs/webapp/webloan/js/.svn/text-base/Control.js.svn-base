...
var gSignForShow="off"; //jzw 2010-04-21 是否勾选计算利息的复选框
		...
		{ // enter key pressed
			if(gnIsSelectCtrl==0)
			{
				...
				{ // we're not done yet, send focus to next box
					//*modified by qhzhou 2008-03-21
					if(nextfield=="" || nextfield == null || nextfield == 'undifined')
					{
				 		executeSubmitFunction();
						return false;
					}
					...
					{
					//*/
						var o=eval('document.' + gFormName + '.' + nextfield);
						if(o && !o.disabled){
...
function createClientCtrl(strFormName,strCtrlName,lClientID,strClientNo,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + "> " + strTitle + "：<a href='javascript:showClientCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
...
//	alert("2");
	  alert("enter1");
	//g_win=window.open( "/NASApp/iTreasury-loan/jsp/SelectClient.jsp?"+paraState  , "SelectCustom" , sFeatures , false );
	g_win=window.open( "/NASApp/iTreasury-loan/jsp/SelectClient.jsp?"+paraState  );
	alert("3");
	g_win.focus();
}
...
//				eval("strAccountNo" + nNum + "=" + strAccountNo.substring(nStart,i-1));
	...
	document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:if(" + strFormName + "." + strCtrlName +"Ctrl.disabled == false) {showAccountCtrl(\"" + strFormName + "\",\"" + strCtrlName+ "\",\"" + lOfficeID+ "\",\"" + lCurrencyID+ "\",\"" + lAccountTypeID + "\",\"" + lGetOrPay+ "\",\"" + strNextCtrlName + "\");}'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
			+ "  "
...
function createContractCtrl(strFormName,strCtrlName,lContractID,strContractNo,lOfficeID,lCurrencyID,strTitle,objClientID,lTransactionTypeID,strNextCtrlName,strFirstTD,strSecondTD)
{
	...
	document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showContractCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID+ "\",\"" + lCurrencyID + "\",\"" + lTransactionTypeID + "\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
			+ "  "
...
function createTypeBranchCtrl(strFormName,strCtrlName,lBranchID,strBranch,lOfficeID,strTitle,objAccountID,strNextCtrlName,strType,strFirstTD,strSecondTD,lIsSingleBank)
{
		...
		//add by ming(if(" + strFormName + "." + strCtrlName +"Ctrl.disabled == false) {})
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:if(" + strFormName + "." + strCtrlName +"Ctrl.disabled == false) {showBranchCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + strType + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\");}'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createGeneralLedgerCtrl(strFormName,strCtrlName,lGeneralLedgerID,strGeneralLedger,strGeneralLedgerCode,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showGeneralLedgerCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createAbstractCtrl(strFormName,strCtrlName,strAbstract,strCode,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showAbstractCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createSubjectNoCtrl(strFormName,strCtrlName,strSubjectNo,strCode,lOfficeID,lCurrencyID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showSubjectNoCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strSubjectNo+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ "</td>"
				+ "<td " + strSecondTD + " ><input class=box   type='text' name='" + strCtrlName + "Ctrl' value='" + strSubjectNo + "' onkeydown='javascript:isSelectSubjectNo(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID + "\",\"" + strNextCtrlName + "\")'>"
				+ " </td>");
}
...
function createAdjustReasonCtrl(strFormName,strCtrlName,strAdjustReason,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showAdjustReasonCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ "</td>"
...
function createFixedDepositCtrl(strFormName,strCtrlName,lFixedDepositID,strFixedDepositNo,lOfficeID,lCurrencyID,strTitle,objClientID,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showFixedDepositCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createLetoutRequisitionCtrl(strFormName,strCtrlName,lLetoutRequisitionID,strLetoutRequisitionCode,lOfficeID,lCurrencyID,strTitle,objContractID,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showLetoutRequisitionCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createDiscountCredenceCtrl(strFormName,strCtrlName,lDiscountCredenceID,strDiscountCredenceCode,lOfficeID,lCurrencyID,lIsGrantOrRecede,strTitle,objContractID,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showDiscountCredenceCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\",\"" + lIsGrantOrRecede +"\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createLetoutRequisitionCtrl1(strFormName,strCtrlName,lLetoutRequisitionID,strLetoutRequisitionCode,lOfficeID,lCurrencyID,strTitle,objContractID,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showLetoutRequisitionCtrl1(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lLetoutRequisitionID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strLetoutRequisitionCode+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
				+ " <input type='hidden' name='" + strCtrlName + "objContractID' value='" + objContractID + "'>"
...
function createExtendApplyNewCtrl(strFormName,strCtrlName,lExtendApplyNewID,strExtendApplyNewCode,lOfficeID,lCurrencyID,strTitle,objContractID,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showExtendApplyNewCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createTableNameCtrl(strFormName,strCtrlName,strTableName,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showTableNameCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ "</td>"
...
function createLoanDueBillCtrl(strFormName,strCtrlName,lLoanDueBillID,strLoanDueBillCode,lOfficeID,lCurrencyID,strTitle,objContractID,lTransactionTypeID,strNextCtrlName,strFirstTD,strSecondTD,objLoanTypeID,strNextCtrlName1)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showLoanDueBillCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID +"\",\"" + lTransactionTypeID +"\",\"" + strNextCtrlName + "\",\"" + strNextCtrlName1 + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createNotifyAccountCtrl(strFormName,strCtrlName,lNotifyAccountID,strNotifyAccountCode,lOfficeID,lCurrencyID,strTitle,objAccountID,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showNotifyAccountCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createNotifyAccountCtrlNoAmount(strFormName,strCtrlName,lNotifyAccountID,strNotifyAccountCode,lOfficeID,lCurrencyID,strTitle,objAccountID,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showNotifyAccountCtrlNoAmount(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lNotifyAccountID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strNotifyAccountCode+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
				+ " <input type='hidden' name='" + strCtrlName + "objAccountID' value='" + objAccountID + "'>"
...
function createOutOfCPFBankCtrl(strFormName,strCtrlName,strOutOfCPFBank,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:if ("+strFormName+"."+strCtrlName+".disabled == false ) {showOutOfCPFBankCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\");}'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ "</td>"
...
function createMultiCodeCtrl(strFormName,strCtrlName,strMultiCode,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:if ("+strFormName+"."+strCtrlName+".disabled == false ) {showMultiCodeCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\");}'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
...
function createOutOfCPFAccountCtrl(strFormName,strCtrlName,strOutOfCPFAccount,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:if ("+strFormName+"."+strCtrlName+".disabled == false) {showOutOfCPFAccountCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\");}'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ "</td>"
 ...
 /***	if(isNaN(nCurrencyID)) 
 	{
 		...
 		//mzh_fu 2007-3-13 解决了粘贴的问题
 		document.writeln(" <input class=tar  onChange='adjustAmount(\"" + strFormName +"\",\"" + strCtrlName +"\",2,\"" + strChineseCtrl +"\"," + nCurrencyID + ")' type='text' name='"+ strCtrlName + "' value='" + formatAmount( strData ,nCurrencyID ) +"' size='18' maxlength='12' onblur='adjustAmount(\"" + strFormName +"\",\"" + strCtrlName +"\",1,\"" + strChineseCtrl +"\"," + nCurrencyID+")'  onfocus='adjustAmount(\"" + strFormName +"\",\"" + strCtrlName +"\",2,\"" + strChineseCtrl +"\"," + nCurrencyID + ")'> <input type='hidden' name='" + strCtrlName + "NextCtrlName' value='" + strNextCtrlName + "'>");
 */
 }
...
// 	alert("n c=" + nCurrencyID);
 ...
 function createAmountCtrl2(strFormName,strCtrlName,strData,strNextCtrlName,strChineseCtrl,nCurrencyID,strOnChange)
 {
 	 //modified by mzh_fu(付明正) 解决金额控件的系列问题
	createAmountCtrl_standard(strFormName,strCtrlName,false,strData,strNextCtrlName,strChineseCtrl,nCurrencyID,"",strOnChange);
...
// 	alert("n c=" + nCurrencyID);
 	if(isNaN(nCurrencyID)) 
 	{
 		...
 		document.writeln(" <input class=tar   type='text' name='"+ strCtrlName + "' value='" + formatAmount( strData ,nCurrencyID ) +"' size='18' maxlength='15' onblur='adjustAmount(\"" + strFormName +"\",\"" + strCtrlName +"\",1,\"" + strChineseCtrl +"\"," + nCurrencyID+")' onchange=" + strOnChange + " onfocus='adjustAmount(\"" + strFormName +"\",\"" + strCtrlName +"\",2,\"" + strChineseCtrl +"\"," + nCurrencyID + ")'> <input type='hidden' name='" + strCtrlName + "NextCtrlName' value='" + strNextCtrlName + "'>");
 */
 }

	/**
	 * 金融空间可以添加属性。
	 * @param sProperty 可以设置成只读的
	 * @author yunchang(常允)
	 * @date 2010-05-18 16:47
	 */ 
	function createAmountCtrlProperty(strFormName,strCtrlName,strData,strNextCtrlName,strChineseCtrl,nCurrencyID,sProperty,strOnChange)
 	{
		//modified by yunchang(常允) 解决金额控件改换成可以加入属性
		//date 2010-05-18
		createAmountCtrl_standard(strFormName,strCtrlName,false,strData,strNextCtrlName,strChineseCtrl,nCurrencyID,sProperty,strOnChange);
	}
 ...
 * Date: 2010/04/21
 */
function createAmountCtrl_standard_jzw(strFormName,strCtrlName,isCanInputNegative,strData,strNextCtrlName,strChineseCtrl,nCurrencyID,sProperty,strSelfOnChange,signForShow){
	 gSignForShow = signForShow;
	 createAmountCtrl_standard(strFormName,strCtrlName,isCanInputNegative,strData,strNextCtrlName,strChineseCtrl,nCurrencyID,sProperty,strSelfOnChange);
}
 ...
 * Date: 2010/06/3
 */
function createAmountCtrl_standard_fhx(strFormName,strCtrlName,isCanInputNegative,strData,strNextCtrlName,strChineseCtrl,nCurrencyID,sProperty,strSelfOnChange,a,code,id){
 		...
 		document.writeln(" <input class=tar type='text' id='"+strCtrlName+"' name='"+ strCtrlName + "' value='" + formatAmount( strData ,nCurrencyID ) +"' size='18' maxlength='" + maxlength + "' onKeyPress = 'event.returnValue=IsDigit(" + isCanInputNegative + ");' onchange = 'onAmountChangeEven_fhx(this," + isCanInputNegative + "," + intDigit + "," + decimalFractionDigit + "," + a + "," + code + "," + id + ");" + strSelfOnChange + ";'  onblur='adjustAmount(\"" + strFormName +"\",\"" + strCtrlName +"\",1,\"" + strChineseCtrl +"\"," + nCurrencyID+")'  onfocus='adjustAmount(\"" + strFormName +"\",\"" + strCtrlName +"\",2,\"" + strChineseCtrl +"\"," + nCurrencyID + ")' " + sProperty + "><input type='hidden' name='" + strCtrlName + "NextCtrlName' value='" + strNextCtrlName + "'>");
}
...
function createAmountCtrl_standard(strFormName,strCtrlName,isCanInputNegative,strData,strNextCtrlName,strChineseCtrl,nCurrencyID,sProperty,strSelfOnChange){
 		...
 		var intDigit = 12;
 		var decimalFractionDigit = 2;
 		document.writeln(" <input class=textbox type='text'  id='"+strCtrlName+"' name='"+ strCtrlName + "' value='" + formatAmount( strData ,nCurrencyID ) +"' size='18' maxlength='" + maxlength + "' onKeyPress = 'event.returnValue=IsDigit(" + isCanInputNegative + ");' onchange = 'onAmountChangeEven(this," + isCanInputNegative + "," + intDigit + "," + decimalFractionDigit + ");" + strSelfOnChange + ";'  onblur='adjustAmount(\"" + strFormName +"\",\"" + strCtrlName +"\",1,\"" + strChineseCtrl +"\"," + nCurrencyID+")'  onfocus='adjustAmount(\"" + strFormName +"\",\"" + strCtrlName +"\",2,\"" + strChineseCtrl +"\"," + nCurrencyID + ")' " + sProperty + "><input type='hidden' name='" + strCtrlName + "NextCtrlName' value='" + strNextCtrlName + "'>");
}
...
function onAmountChangeEven(amountObj,isCanInputNegative,intDigit,decimalFractionDigit){
	...
	if(!verifyAmount(amountObj.value,isCanInputNegative,intDigit,decimalFractionDigit)){	
		...
		amountObj.select();
	}else if(gSignForShow == "on"){      //jzw 2010-04-21 如果金额校验无误，并且勾选了计算利息，那么执行此方法
		gSignForShow = "off";
		onChangeCompute();
	}
}
 ...
 * Date: 2010/06/28
 */
function onAmountChangeEven_fhx(amountObj,isCanInputNegative,intDigit,decimalFractionDigit,a,code,id){
 ...
 * @return        返回格式化的数值
 * @author        yunchang
 * @date          2010-09-06 16:24
 * @function      进行金额比例的设置保留六位小数
 */
 function formatAmountRate(strData1)
 {
 	if(strData1 !=null && strData1 !=""){
 		strData1 = strData1.replace(/\s/gim,"");
		strData1 = strData1.replace(/,/g,'');
...
function createLoanInfoCtrl(strFormName,strCtrlName,lLoanInfoID,strLoanInfoNo,lLoanTypeID,lOfficeID,lCurrencyID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + "> " + strTitle + "：<a href='javascript:showLoanInfoCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID  + "\",\"" + lLoanTypeID + "\",\""+ strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createLoanInfoCtrl1(strFormName,strCtrlName,lLoanInfoID,strLoanInfoNo,objTypeID,lOfficeID,lCurrencyID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + "> " + strTitle + "：<a href='javascript:showLoanInfoCtrl1(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID  + "\",\""+ strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lLoanInfoID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strLoanInfoNo+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
...
function createContractInfoCtrl(strFormName,strCtrlName,lContractInfoID,strContractInfoNo,lLoanTypeID,lOfficeID,lCurrencyID,strTitle,objClientID,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + "> " + strTitle + "：<a href='javascript:showContractInfoCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID  + "\",\"" + lLoanTypeID + "\",\""+ strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createContractInfoCtrl1(strFormName,strCtrlName,lContractInfoID,strContractInfoNo,lLoanTypeID,lOfficeID,lCurrencyID,lStatusID,strTitle,objClientID,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + "> " + strTitle + "：<a href='javascript:showContractInfoCtrl1(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID  + "\",\"" + lLoanTypeID + "\",\""+ lStatusID + "\",\""+ strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lContractInfoID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strContractInfoNo+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
				+ " <input type='hidden' name='" + strCtrlName + "objClientID' value='" + objClientID + "'>"
...
function createContractInfoCtrl2(strFormName,strCtrlName,lContractInfoID,strContractInfoNo,lOfficeID,lCurrencyID,strTitle,objClientID,objTypeID,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + "> " + strTitle + "：<a href='javascript:showContractInfoCtrl2(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID + "\",\""+ strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lContractInfoID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strContractInfoNo+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
				+ " <input type='hidden' name='" + strCtrlName + "objClientID' value='" + objClientID + "'>"
...
function createContractInfoCtrl3(strFormName,strCtrlName,lContractInfoID,strContractInfoNo,lOfficeID,lCurrencyID,lStatusID,strTitle,objClientID,objTypeID,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + "> " + strTitle + "：<a href='javascript:showContractInfoCtrl3(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID + "\",\""+ lStatusID + "\",\""+ strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lContractInfoID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strContractInfoNo+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
				+ " <input type='hidden' name='" + strCtrlName + "objClientID' value='" + objClientID + "'>"
...
function createConsignContractCtrl(strFormName,strCtrlName,lConsignContractID,strConsignContractNo,lLoanTypeID,lOfficeID,lCurrencyID,objClientID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + "> " + strTitle + "：<a href='javascript:showConsignContractCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID  + "\",\"" + lLoanTypeID + "\",\""+ strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createConsignContractCtrl1(strFormName,strCtrlName,lConsignContractID,strConsignContractNo,lLoanTypeID,lOfficeID,lCurrencyID,lStatusID,objClientID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + "> " + strTitle + "：<a href='javascript:showConsignContractCtrl1(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID  + "\",\"" + lLoanTypeID  + "\",\"" + lStatusID + "\",\""+ strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lConsignContractID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strConsignContractNo+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
			  + "<input type='hidden' name='" + strCtrlName + "objClientID' value='" + objClientID + "'>"
...
function createConsignContractCtrl2(strFormName,strCtrlName,lConsignContractID,strConsignContractNo,lLoanTypeID,lOfficeID,lCurrencyID,lStatusID,objClientID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + "> " + strTitle + "：<a href='javascript:showConsignContractCtrl2(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID  + "\",\"" + lLoanTypeID  + "\",\"" + lStatusID + "\",\""+ strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lConsignContractID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strConsignContractNo+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
			  + "<input type='hidden' name='" + strCtrlName + "objClientID' value='" + objClientID + "'>"
...
Calendar.prototype.show = function() {
 ...
 this.wwrite("</style>");
 this.wwrite("<link rel='stylesheet' href='../graphics/template.css' type='text/css'>");
 this.wwrite("</head>");
...
function createUserNameCtrl(strFormName,strCtrlName,strUserName,strCode,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showUserNameCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\""+ strUserName + "\",\""  + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strCode+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
				+ "</td>"
...
function createUserNameCtrl1(strFormName,strCtrlName,strUserName,strCode,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
  	if (strFirstTD=="" || strFirstTD==null)
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showUserNameCtrl1(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strCode+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
				+ "</td>"
...
function createUserNameCtrl2(strFormName,strCtrlName,strUserName,strCode,lModuleID,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
  	if (strFirstTD=="" || strFirstTD==null)
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showUserNameCtrl2(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lModuleID + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strCode+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
				+ "</td>"
...
function createUserNameCtrl3(strFormName,strCtrlName,strUserName,strCode,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
  	if (strFirstTD=="" || strFirstTD==null)
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showUserNameCtrl3(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strCode+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
				+ "</td>"
...
function createLoginCtrl(strFormName,strCtrlName,strLogin,strCode,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showLoginCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + strLogin + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strCode+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
				+ "</td>"
...
function createGroupNameCtrl(strFormName,strCtrlName,strGroupName,strCode,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD,strProperty)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showGroupNameCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + strGroupName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strCode+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
				+ "</td>"
...
function createRatePlanCtrl(strFormName,strCtrlName,strRatePlan,lRateID,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD,nTypeID)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:if(" + strFormName + "." + strCtrlName +"Ctrl.disabled == false) {showRatePlanCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\");}'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
 ...
 * @param strSecondTD 第二个TD里面的参数
 */
function createRateCtrl(strFormName,strCtrlName,strRateName,lRateID,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showRateCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lRateID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ " <INPUT TYPE='HIDDEN' VALUE='' ID='"+strCtrlName+ "Value' NAME='"+strCtrlName+"Value'>"
				+ "</td>"
				+ "<td " + strSecondTD + " ><input class='box'  type='text' name='" + strCtrlName + "Ctrl' value='" + strRateName + "' onkeydown='javascript:isSelectRate(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + strNextCtrlName + "\")'>"
				+ " </td>");
}
 ...
 * @param strNextCtrlName 下一个控件的名称，当关闭了选择窗口的时候，焦点到这个控件
 */
function showRateCtrl(strFormName,strCtrlName,lOfficeID,strNextCtrlName)//收款方客户编号
{
	...
	var paraState="lOfficeID=" + lOfficeID + "&strFormName=" + strFormName +"&strCtrlName="+strCtrlName +"&strNextCtrlName=" + strNextCtrlName + "&strName="+ strName;
 ...
 * @param strNextCtrlName 下一个控件的名称，当关闭了选择窗口的时候，焦点到这个控件
 */
function isSelectRate(strFormName,strCtrlName,lOfficeID,strNextCtrlName)
{
	if(gnIsShowSending==0)
	{
		if (window.event.keyCode==13)//回车说明选择
		{
			gnIsSelectCtrl=1;
			showRateCtrl(strFormName,strCtrlName,lOfficeID,strNextCtrlName);
		}
		else
		{
			eval(strFormName+ "." + strCtrlName + ".value=-1");
 ...
 * @param lRateID 利率代码
 */
function outputRateCtrl(strFormName,strCtrlName,strRateName,lRateID,dInterestRate)
{
	var strTempCtrl;
	var i,k=0;
	var Ind;
...
function createClientTypeNoCtrl(strFormName,strCtrlName,strClientTypeNoName,lClientTypeID,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showClientTypeNoCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createClientTypeNameCtrl(strFormName,strCtrlName,strClientTypeNameName,lClientTypeID,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showClientTypeNameCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lClientTypeID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ "</td>"
...
function createLiborRateCtrl(strFormName,strCtrlName,strLiborRateName,lLiborRateID,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showLiborRateCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createRateCodeCtrl(strFormName,strCtrlName,strRateCode,lRateID,lCurrencyID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showRateCodeCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lRateID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ "</td>"
...
function createRateCodeCtrl2(strFormName,strCtrlName,strRateValue,lRateID,lCurrencyID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showRateCodeCtrl2(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lRateID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ "</td>"
...
function createRateCodeCtrl1(strFormName,strCtrlName,strRateCode,lRateID,lCurrencyID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showRateCodeCtrl1(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lRateID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ "</td>"
...
function createRateCodeCtrl3(strFormName,strCtrlName,strRateCode,lRateID,lCurrencyID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showRateCodeCtrl3(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lRateID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ "</td>"
...
function createRateNameCtrl(strFormName,strCtrlName,strRateName,lRateID,lCurrencyID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showRateNameCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lRateID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ "</td>"
...
function createClientNameCtrl(strFormName,strCtrlName,strClientName,lClientID,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showClientNameCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lClientID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ "</td>"
...
function createExtendApplyCtrl(strFormName,strCtrlName,lExtendApplyID,strExtendApplyNo,lLoanTypeID,lOfficeID,lCurrencyID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + "> " + strTitle + "：<a href='javascript:showExtendApplyCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID  + "\",\"" + lLoanTypeID + "\",\""+ strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createClientAccountCtrl(strFormName,strCtrlName,strClientAccount,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showClientAccountCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ "</td>"
...
function createDiscountCtrl(strFormName,strCtrlName,lDiscountID,strDiscountNo,lOfficeID,lCurrencyID,strTitle,objClientID,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + "> " + strTitle + "：<a href='javascript:showDiscountCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID  + "\",\"" +  strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createDiscountCtrl1(strFormName,strCtrlName,lDiscountID,strDiscountNo,lOfficeID,lCurrencyID,strTitle,objClientID,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + "> " + strTitle + "：<a href='javascript:showDiscountCtrl1(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID  + "\",\"" +  strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lDiscountID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strDiscountNo+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
				+ "</td>"
...
function createCreditNameCtrl(strFormName,strCtrlName,strCreditName,lCreditID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showCreditNameCtrl(\"" + strFormName + "\",\"" + strCtrlName +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createCreditCodeCtrl(strFormName,strCtrlName,strCreditCode,lCreditID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showCreditCodeCtrl(\"" + strFormName + "\",\"" + strCtrlName +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lCreditID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ "</td>"
...
function createInvestmentCodeCtrl(strFormName,strCtrlName,strInvestmentCode,lInvestmentID,lCurrencyID,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showInvestmentCodeCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lCurrencyID + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
 ...
 */
	...
	*/
    ...
    /**
	 * 显示中文金额
	 * 全哨 2010-4-21 修改，转码根据  Constant.java  601 行
...
function createLiborRateCodeCtrl(strFormName,strCtrlName,strLiborRateCode,lLiborRateID, lCurrencyID,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showLiborRateCodeCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + strLiborRateCode + "\",\"" + lOfficeID + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lLiborRateID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ "</td>"
...
function createOfficeAccountCtrl1(strFormName,strCtrlName,strOfficeAccount,objClientID, lCurrencyID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showOfficeAccountCtrl1(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + strOfficeAccount + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createOfficeAccountCtrl(strFormName,strCtrlName,strOfficeAccount,lCLIENTID, lCurrencyID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showOfficeAccountCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + strOfficeAccount + "\",\"" + lCLIENTID + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strOfficeAccount+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ "</td>"
...
function createStatusLoanInfoCtrl(strFormName,strCtrlName,lLoanInfoID,strLoanInfoNo,lLoanTypeID,lOfficeID,lCurrencyID,strTitle,lStatusID,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + "> " + strTitle + "：<a href='javascript:showStatusLoanInfoCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID  + "\",\"" + lLoanTypeID+ "\",\"" + lStatusID + "\",\""+ strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lLoanInfoID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strLoanInfoNo+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
				+ "</td>"
...
{ 
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showCashFlowCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createFixedRateCtrl(strFormName,strCtrlName,fFixedRate,strCode,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showFixedRateCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strCode+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
				+ "</td>"
...
function createAheadRepayRequisitionCtrl(strFormName,strCtrlName,lOfficeID,lCurrencyID,lContractID,lLetoutRequisitionID,lAheadRepayRequisitionID,strAheadRepayRequisitionCode,dAmount,tsInterestStart,strTitle,strAmount,dtInterestDate,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showAheadRepayRequisitionCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createDiscountBillCtrl(strFormName,strCtrlName,lOfficeID,lCurrencyID,lContractID,lDiscountCredenceID,strDiscountBillCode,dAmount,tsStartDate,tsEndDate,strTitle,strAmount,strStartDate,strEndDate,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showDiscountBillCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/graphics/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function iframeAutoFit(arg0)
{
	...
	/**
 	 * 格式化数字 add by xfma (马现福) 2009-6-2
 	 * frm 只能是 “this”参数
	 * msg 当数字为null时默认参数
 	 * deci为小数点后保留位数
 	 */
 	function formatNumber(frm,msg,deci){
 		num = frm.value;
 		...
 		if (intPart.length>3){
 			...
 			if (deciPart.length>0){
 				tmpToReturn = signPart + tmpToReturn + "." + deciPart;
 			}
 		}
 		else{
 			if (intPart == ""){
