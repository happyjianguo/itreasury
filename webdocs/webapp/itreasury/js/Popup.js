...
(function($) {
    $.popup = {
        ...
        help: function(elem, title, msg, height,clientX,clientY) {
            this.ID = 'help';
            ...
            else
            {
            	...
            	if(!(scrollLeft||scrollTop)&&document.body)
            	{
            	...
            	if (top - 70 - this.height > 0) {
            		this.top = top - 70 - this.height;
            		this.popType = 'help_up';
            	}else
            	{
            		this.top = top + 23;
            	...
            	this.left = clientX + scrollLeft - 70;
            }
            ...
            if ($("#_Popup_" + this.ID).length < 1) {
			    ...
			    '<div class="popup_' + this.popType + '" id="_Popup_' + this.ID + '" style="width:' + this.width + 'px">\
                  ...
                  <div class="popup_content">\
                    <td id="_Container_' + this.ID + (this.height == 0 ? '">' : '" style="height:' + this.height + 'px;word-wrap:break-word;word-break:break-all">') + msg + '</td></div>' +
    ...
    showHelper = function(elem, title, msg, height,clientX,clientY) {
        $.popup.help(elem, title, msg, height,clientX,clientY);
    }
