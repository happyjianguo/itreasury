...
(function($) {
	...
	$.flexme = function(t, p) {
						...
						$("#printpanel").dialog({
							...
							buttons : {
								...
								"确定" : function() {
									...
									tempForm.action = '/NASApp/iTreasury-ebank/JasperPrintServlet';
						...
						$("#exportpanel").dialog({
							...
							buttons : {
								...
								"确定" : function() {
									...
									$.post('/NASApp/iTreasury-ebank/AjaxServlet?strUsePager=true&strIsEncode=true&strIsExcel=true&' + $.param(_p.params)+"&export=true",
									{
									...
									{	
										window.location.href('/NASApp/iTreasury-ebank/DownLoadFileServlet?file=' + data);
									});
								}
							},
							close : function() {
		...
		var contextUrl = '/NASApp/iTreasury-ebank/AjaxServlet?strUsePager='+p.usepager+'&strIsEncode=true&strClassMethod=' + p.classMethod;
