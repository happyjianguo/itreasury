										...
										if(cm.elType && cm.elType == 'checkbox')
											{
												...
												if(!row.validate)
												{
													$(td).append('<input type="checkbox" isFalsified=true class="checkbox_flex" id="'+ cm.elName + '_' + i +'" name="'+ cm.elName + '" value="'+value  +'"  chkExcept="' + cm.chkExcept + '" />');
												}else
												{
													$(td).append('<input type="checkbox" class="checkbox_flex" id="'+ cm.elName + '_' + i +'" name="'+ cm.elName + '" value="'+value  +'"  chkExcept="' + cm.chkExcept + '" />');
												}
											}
										else if(cm.elType && cm.elType == 'radio')
											{
												$(td).append('<input type="radio" id="'+ cm.elName +'" name="'+ cm.elName + '" value="'+ idx +'"  chkExcept="' + cm.chkExcept + '" />');
											}
