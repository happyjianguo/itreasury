...
function createClientCtrl(strFormName,strCtrlName,lClientID,strClientNo,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + "> " + strTitle + "：<a href='javascript:showClientCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				...
				+ "</td>"
				+ "<td " + strSecondTD + " ><input class=box  type='text' name='" + strCtrlName + "Ctrl' ID='"+strClientNo+ "' value='" + strClientNo + "' onkeydown='javascript:isSelectClient(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + strNextCtrlName + "\")'>"
				+ " </td>");
...
function createClientCtrl1(strFormName,strCtrlName,Client,lClientID,strClientNo,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		if (strFirstTD=="" || strFirstTD==null)
		{
				strFirstTD="valign='middle' height='20' width='33%'";
		...
		document.writeln("<td " + strFirstTD + "> " + strTitle + "：<a href='javascript:showClientCtrl1(\"" + strFormName + "\",\"" + Client + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lClientID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lClientID+"' ID='"+strCtrlName+ "ForAccount' NAME='"+strCtrlName+"ForAccount'>"
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strClientNo+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
				+ " <INPUT TYPE='HIDDEN' VALUE='-1' ID='"+strCtrlName+ "AccountID' NAME='"+strCtrlName+"AccountID'>"
				+ "</td>"
				+ "<td " + strSecondTD + " ><input class=box  type='text' name='" + strCtrlName + "Ctrl' value='" + strClientNo + "' onkeydown='javascript:isSelectClient1(\"" + strFormName + "\",\"" + Client + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + strNextCtrlName + "\")'>"
				+ " </td>");
//		gFormName[gNo]=strFormName;
//		gNoClientID=gNoClientID+1;
//		gNo=gNo+1;
...
//	alert("2");
	g_win=window.open( "/NASApp/iTreasury-system/jsp/SelectClient.jsp?"+paraState  , "SelectCustom" , sFeatures , false );
//	alert("3");
	g_win.focus();
}

function showClientCtrl1(strFormName,Client,strCtrlName,lOfficeID,strNextCtrlName)//收款方客户编号
{
	var sFeatures="toolbar=no,menubar=no,resizable=no,location=no,width=436,height=340,scrollbars=yes";
	var g_win;
	var strClientNo;
	eval("strClientNo="+ strFormName + "."+ strCtrlName + "Ctrl.value");
	var paraState="lOfficeID=" + lOfficeID + "&strFormName=" + strFormName +"&strCtrlName="+strCtrlName + "&strClientNo=" + strClientNo + "&strNextCtrlName=" + strNextCtrlName+"&Client="+Client;
//	alert("SelectClient.jsp?"+paraState );
//	alert("2");
	g_win=window.open( "/NASApp/iTreasury-system/jsp/SelectClient1.jsp?"+paraState  , "SelectCustom" , sFeatures , false );
//	alert("3");
	g_win.focus();
}
...
function isSelectClient1(strFormName,Client,strCtrlName,lOfficeID,strNextCtrlName)
{
	if (window.event.keyCode==13)//回车说明选择
	{
		gnIsSelectCtrl=1;
		showClientCtrl1(strFormName,Client,strCtrlName,lOfficeID,strNextCtrlName);
	}
	else
	{
		eval(strFormName+ "." + strCtrlName + ".value=-1");
...
function outputClientCtrl(strFormName,strCtrlName,lClientID,strClientName,strClientNo,strAccountID,strChiefRepCode)
{
	...
	var i,k=0;
	var Ind; 
	//if (strChiefRepCode=="null")	   strChiefRepCode = "";
...
//				eval("strAccountNo" + nNum + "=" + strAccountNo.substring(nStart,i-1));
	...
	document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:if(" + strFormName + "." + strCtrlName +"Ctrl.disabled == false) {showAccountCtrl(\"" + strFormName + "\",\"" + strCtrlName+ "\",\"" + lOfficeID+ "\",\"" + lCurrencyID+ "\",\"" + lAccountTypeID + "\",\"" + lGetOrPay+ "\",\"" + strNextCtrlName + "\");}'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
			+ "  "
...
function createContractCtrl(strFormName,strCtrlName,lContractID,strContractNo,lOfficeID,lCurrencyID,strTitle,objClientID,lTransactionTypeID,strNextCtrlName,strFirstTD,strSecondTD)
{
	...
	document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showContractCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID+ "\",\"" + lCurrencyID + "\",\"" + lTransactionTypeID + "\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
			+ "  "
...
function createTypeBranchCtrl(strFormName,strCtrlName,lBranchID,strBranch,lOfficeID,strTitle,objAccountID,strNextCtrlName,strType,strFirstTD,strSecondTD,lIsSingleBank)
{
		...
		//add by ming(if(" + strFormName + "." + strCtrlName +"Ctrl.disabled == false) {})
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:if(" + strFormName + "." + strCtrlName +"Ctrl.disabled == false) {showBranchCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + strType + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\");}'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createGeneralLedgerCtrl(strFormName,strCtrlName,lGeneralLedgerID,strGeneralLedger,strGeneralLedgerCode,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showGeneralLedgerCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createAbstractCtrl(strFormName,strCtrlName,strAbstract,strCode,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showAbstractCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createSubjectNoCtrl(strFormName,strCtrlName,strSubjectNo,strCode,lOfficeID,lCurrencyID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showSubjectNoCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createAdjustReasonCtrl(strFormName,strCtrlName,strAdjustReason,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showAdjustReasonCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ "</td>"
...
function createFixedDepositCtrl(strFormName,strCtrlName,lFixedDepositID,strFixedDepositNo,lOfficeID,lCurrencyID,strTitle,objClientID,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showFixedDepositCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createLetoutRequisitionCtrl(strFormName,strCtrlName,lLetoutRequisitionID,strLetoutRequisitionCode,lOfficeID,lCurrencyID,strTitle,objContractID,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showLetoutRequisitionCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createDiscountCredenceCtrl(strFormName,strCtrlName,lDiscountCredenceID,strDiscountCredenceCode,lOfficeID,lCurrencyID,lIsGrantOrRecede,strTitle,objContractID,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showDiscountCredenceCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\",\"" + lIsGrantOrRecede +"\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createLetoutRequisitionCtrl1(strFormName,strCtrlName,lLetoutRequisitionID,strLetoutRequisitionCode,lOfficeID,lCurrencyID,strTitle,objContractID,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showLetoutRequisitionCtrl1(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lLetoutRequisitionID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strLetoutRequisitionCode+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
				+ " <input type='hidden' name='" + strCtrlName + "objContractID' value='" + objContractID + "'>"
...
function createExtendApplyNewCtrl(strFormName,strCtrlName,lExtendApplyNewID,strExtendApplyNewCode,lOfficeID,lCurrencyID,strTitle,objContractID,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showExtendApplyNewCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createTableNameCtrl(strFormName,strCtrlName,strTableName,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showTableNameCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ "</td>"
...
function createLoanDueBillCtrl(strFormName,strCtrlName,lLoanDueBillID,strLoanDueBillCode,lOfficeID,lCurrencyID,strTitle,objContractID,lTransactionTypeID,strNextCtrlName,strFirstTD,strSecondTD,objLoanTypeID,strNextCtrlName1)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showLoanDueBillCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID +"\",\"" + lTransactionTypeID +"\",\"" + strNextCtrlName + "\",\"" + strNextCtrlName1 + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createNotifyAccountCtrl(strFormName,strCtrlName,lNotifyAccountID,strNotifyAccountCode,lOfficeID,lCurrencyID,strTitle,objAccountID,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showNotifyAccountCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createNotifyAccountCtrlNoAmount(strFormName,strCtrlName,lNotifyAccountID,strNotifyAccountCode,lOfficeID,lCurrencyID,strTitle,objAccountID,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showNotifyAccountCtrlNoAmount(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lNotifyAccountID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strNotifyAccountCode+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
				+ " <input type='hidden' name='" + strCtrlName + "objAccountID' value='" + objAccountID + "'>"
...
function createOutOfCPFBankCtrl(strFormName,strCtrlName,strOutOfCPFBank,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:if ("+strFormName+"."+strCtrlName+".disabled == false ) {showOutOfCPFBankCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\");}'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ "</td>"
...
function createMultiCodeCtrl(strFormName,strCtrlName,strMultiCode,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:if ("+strFormName+"."+strCtrlName+".disabled == false ) {showMultiCodeCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\");}'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
...
function createOutOfCPFAccountCtrl(strFormName,strCtrlName,strOutOfCPFAccount,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:if ("+strFormName+"."+strCtrlName+".disabled == false) {showOutOfCPFAccountCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\");}'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ "</td>"
...
function createLoanInfoCtrl(strFormName,strCtrlName,lLoanInfoID,strLoanInfoNo,lLoanTypeID,lOfficeID,lCurrencyID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + "> " + strTitle + "：<a href='javascript:showLoanInfoCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID  + "\",\"" + lLoanTypeID + "\",\""+ strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createLoanInfoCtrl1(strFormName,strCtrlName,lLoanInfoID,strLoanInfoNo,objTypeID,lOfficeID,lCurrencyID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + "> " + strTitle + "：<a href='javascript:showLoanInfoCtrl1(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID  + "\",\""+ strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lLoanInfoID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strLoanInfoNo+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
...
function createContractInfoCtrl(strFormName,strCtrlName,lContractInfoID,strContractInfoNo,lLoanTypeID,lOfficeID,lCurrencyID,strTitle,objClientID,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + "> " + strTitle + "：<a href='javascript:showContractInfoCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID  + "\",\"" + lLoanTypeID + "\",\""+ strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createContractInfoCtrl1(strFormName,strCtrlName,lContractInfoID,strContractInfoNo,lLoanTypeID,lOfficeID,lCurrencyID,lStatusID,strTitle,objClientID,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + "> " + strTitle + "：<a href='javascript:showContractInfoCtrl1(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID  + "\",\"" + lLoanTypeID + "\",\""+ lStatusID + "\",\""+ strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lContractInfoID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strContractInfoNo+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
				+ " <input type='hidden' name='" + strCtrlName + "objClientID' value='" + objClientID + "'>"
...
function createContractInfoCtrl2(strFormName,strCtrlName,lContractInfoID,strContractInfoNo,lOfficeID,lCurrencyID,strTitle,objClientID,objTypeID,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + "> " + strTitle + "：<a href='javascript:showContractInfoCtrl2(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID + "\",\""+ strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lContractInfoID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strContractInfoNo+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
				+ " <input type='hidden' name='" + strCtrlName + "objClientID' value='" + objClientID + "'>"
...
function createContractInfoCtrl3(strFormName,strCtrlName,lContractInfoID,strContractInfoNo,lOfficeID,lCurrencyID,lStatusID,strTitle,objClientID,objTypeID,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + "> " + strTitle + "：<a href='javascript:showContractInfoCtrl3(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID + "\",\""+ lStatusID + "\",\""+ strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lContractInfoID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strContractInfoNo+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
				+ " <input type='hidden' name='" + strCtrlName + "objClientID' value='" + objClientID + "'>"
...
function createConsignContractCtrl(strFormName,strCtrlName,lConsignContractID,strConsignContractNo,lLoanTypeID,lOfficeID,lCurrencyID,objClientID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + "> " + strTitle + "：<a href='javascript:showConsignContractCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID  + "\",\"" + lLoanTypeID + "\",\""+ strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createConsignContractCtrl1(strFormName,strCtrlName,lConsignContractID,strConsignContractNo,lLoanTypeID,lOfficeID,lCurrencyID,lStatusID,objClientID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + "> " + strTitle + "：<a href='javascript:showConsignContractCtrl1(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID  + "\",\"" + lLoanTypeID  + "\",\"" + lStatusID + "\",\""+ strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lConsignContractID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strConsignContractNo+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
			  + "<input type='hidden' name='" + strCtrlName + "objClientID' value='" + objClientID + "'>"
...
function createConsignContractCtrl2(strFormName,strCtrlName,lConsignContractID,strConsignContractNo,lLoanTypeID,lOfficeID,lCurrencyID,lStatusID,objClientID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + "> " + strTitle + "：<a href='javascript:showConsignContractCtrl2(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID  + "\",\"" + lLoanTypeID  + "\",\"" + lStatusID + "\",\""+ strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lConsignContractID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strConsignContractNo+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
			  + "<input type='hidden' name='" + strCtrlName + "objClientID' value='" + objClientID + "'>"
...
function createUserNameCtrl(strFormName,strCtrlName,strUserName,strCode,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showUserNameCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\""+ strUserName + "\",\""  + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strCode+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
				+ "</td>"
...
function showUserNameCtrl(strFormName,strCtrlName,strUserName,lOfficeID,strNextCtrlName)//收款方客户编号
{
	...
	g_win=window.open( "/NASApp/iTreasury-system/jsp/SelectUserName.jsp?"+paraState  , "SelectUserName" , sFeatures , false );
	g_win.focus();
}
...
function createUserNameCtrl1(strFormName,strCtrlName,strUserName,strCode,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
  	if (strFirstTD=="" || strFirstTD==null)
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showUserNameCtrl1(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strCode+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
				+ "</td>"
...
function createUserNameCtrl2(strFormName,strCtrlName,strUserName,strCode,lModuleID,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
  	if (strFirstTD=="" || strFirstTD==null)
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showUserNameCtrl2(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lModuleID + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strCode+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
				+ "</td>"
...
function createUserNameCtrl3(strFormName,strCtrlName,strUserName,strCode,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
  	if (strFirstTD=="" || strFirstTD==null)
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showUserNameCtrl3(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strCode+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
				+ "</td>"
...
function createLoginCtrl(strFormName,strCtrlName,strLogin,strCode,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showLoginCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + strLogin + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strCode+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
				+ "</td>"
...
function createGroupNameCtrl(strFormName,strCtrlName,strGroupName,strCode,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD,strProperty)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showGroupNameCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + strGroupName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strCode+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
				+ "</td>"
...
function showGroupNameCtrl(strFormName,strCtrlName,strGroupName,lOfficeID,strNextCtrlName)//收款方客户编号
{
	...
	var sFeatures="toolbar=no,menubar=no,resizable=no,location=no,width=436,height=340,scrollbars=yes";
	var g_win;
	eval ("strGroupValue = "+strFormName+"."+strCtrlName +".value");
	var paraState="lOfficeID=" + lOfficeID +"&strGroupValue=" + strGroupValue + "&strFormName=" + strFormName + "&strGroupName=" + strGroupName +"&strCtrlName="+strCtrlName +"&strNextCtrlName=" + strNextCtrlName;
...
function createRatePlanCtrl(strFormName,strCtrlName,strRatePlan,lRateID,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD,nTypeID)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:if(" + strFormName + "." + strCtrlName +"Ctrl.disabled == false) {showRatePlanCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\");}'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createRateCtrl(strFormName,strCtrlName,strRateName,lRateID,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showRateCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lRateID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
...
function createClientTypeNoCtrl(strFormName,strCtrlName,strClientTypeNoName,lClientTypeID,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showClientTypeNoCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createClientTypeNameCtrl(strFormName,strCtrlName,strClientTypeNameName,lClientTypeID,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showClientTypeNameCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lClientTypeID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ "</td>"
...
function createLiborRateCtrl(strFormName,strCtrlName,strLiborRateName,lLiborRateID,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showLiborRateCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createRateCodeCtrl(strFormName,strCtrlName,strRateCode,lRateID,lCurrencyID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showRateCodeCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lRateID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ "</td>"
...
function createRateCodeCtrl2(strFormName,strCtrlName,strRateValue,lRateID,lCurrencyID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showRateCodeCtrl2(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lRateID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ "</td>"
...
function createRateCodeCtrl1(strFormName,strCtrlName,strRateCode,lRateID,lCurrencyID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showRateCodeCtrl1(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lRateID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ "</td>"
...
function createRateCodeCtrl3(strFormName,strCtrlName,strRateCode,lRateID,lCurrencyID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showRateCodeCtrl3(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lRateID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ "</td>"
...
function createRateNameCtrl(strFormName,strCtrlName,strRateName,lRateID,lCurrencyID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showRateNameCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lRateID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ "</td>"
...
function createClientNameCtrl(strFormName,strCtrlName,strClientName,lClientID,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showClientNameCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lClientID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ "</td>"
...
function createExtendApplyCtrl(strFormName,strCtrlName,lExtendApplyID,strExtendApplyNo,lLoanTypeID,lOfficeID,lCurrencyID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + "> " + strTitle + "：<a href='javascript:showExtendApplyCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID  + "\",\"" + lLoanTypeID + "\",\""+ strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createClientAccountCtrl(strFormName,strCtrlName,strClientAccount,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showClientAccountCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ "</td>"
...
function createDiscountCtrl(strFormName,strCtrlName,lDiscountID,strDiscountNo,lOfficeID,lCurrencyID,strTitle,objClientID,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + "> " + strTitle + "：<a href='javascript:showDiscountCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID  + "\",\"" +  strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createDiscountCtrl1(strFormName,strCtrlName,lDiscountID,strDiscountNo,lOfficeID,lCurrencyID,strTitle,objClientID,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + "> " + strTitle + "：<a href='javascript:showDiscountCtrl1(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID  + "\",\"" +  strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lDiscountID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strDiscountNo+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
				+ "</td>"
...
function createCreditNameCtrl(strFormName,strCtrlName,strCreditName,lCreditID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showCreditNameCtrl(\"" + strFormName + "\",\"" + strCtrlName +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createCreditCodeCtrl(strFormName,strCtrlName,strCreditCode,lCreditID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showCreditCodeCtrl(\"" + strFormName + "\",\"" + strCtrlName +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lCreditID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ "</td>"
...
function createInvestmentCodeCtrl(strFormName,strCtrlName,strInvestmentCode,lInvestmentID,lCurrencyID,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showInvestmentCodeCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lCurrencyID + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createLiborRateCodeCtrl(strFormName,strCtrlName,strLiborRateCode,lLiborRateID, lCurrencyID,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showLiborRateCodeCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + strLiborRateCode + "\",\"" + lOfficeID + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lLiborRateID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ "</td>"
...
function createOfficeAccountCtrl1(strFormName,strCtrlName,strOfficeAccount,objClientID, lCurrencyID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showOfficeAccountCtrl1(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + strOfficeAccount + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createOfficeAccountCtrl(strFormName,strCtrlName,strOfficeAccount,lCLIENTID, lCurrencyID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showOfficeAccountCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + strOfficeAccount + "\",\"" + lCLIENTID + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strOfficeAccount+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ "</td>"
...
function createStatusLoanInfoCtrl(strFormName,strCtrlName,lLoanInfoID,strLoanInfoNo,lLoanTypeID,lOfficeID,lCurrencyID,strTitle,lStatusID,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + "> " + strTitle + "：<a href='javascript:showStatusLoanInfoCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID  + "\",\"" + lLoanTypeID+ "\",\"" + lStatusID + "\",\""+ strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+lLoanInfoID+"' ID='"+strCtrlName+ "' NAME='"+strCtrlName+"'>"
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strLoanInfoNo+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
				+ "</td>"
...
{ 
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showCashFlowCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createFixedRateCtrl(strFormName,strCtrlName,fFixedRate,strCode,lOfficeID,strTitle,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showFixedRateCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
				+ " <INPUT TYPE='HIDDEN' VALUE='"+strCode+"' ID='"+strCtrlName+ "Code' NAME='"+strCtrlName+"Code'>"
				+ "</td>"
...
function createAheadRepayRequisitionCtrl(strFormName,strCtrlName,lOfficeID,lCurrencyID,lContractID,lLetoutRequisitionID,lAheadRepayRequisitionID,strAheadRepayRequisitionCode,dAmount,tsInterestStart,strTitle,strAmount,dtInterestDate,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showAheadRepayRequisitionCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
...
function createDiscountBillCtrl(strFormName,strCtrlName,lOfficeID,lCurrencyID,lContractID,lDiscountCredenceID,strDiscountBillCode,dAmount,tsStartDate,tsEndDate,strTitle,strAmount,strStartDate,strEndDate,strNextCtrlName,strFirstTD,strSecondTD)
{
		...
		document.writeln("<td " + strFirstTD + ">" + strTitle + "：<a href='javascript:showDiscountBillCtrl(\"" + strFormName + "\",\"" + strCtrlName + "\",\"" + lOfficeID + "\",\"" + lCurrencyID +"\",\"" + strNextCtrlName + "\")'><img border= '0' src='/websys/image/icon.gif' width='15' height='15'></a> "
				+ "  "
 ...
 */
 function gettxtApprovalNames(ApprovalName)
 {
 	var sql="";
 	if(ApprovalName != null && ApprovalName.length > 0)
	{
	  sql += " and a.sName like '%25" + ApprovalName + "%25'";
	}
	return sql;
 }
/**
 *
 */
 function getsUserNames(userName)
 {
 	var sql="";
 	if(userName != null && userName.length > 0)
	{
	  sql += " and a.sUserName like '%25" + userName + "%25'";
	}
	return sql;
 }
