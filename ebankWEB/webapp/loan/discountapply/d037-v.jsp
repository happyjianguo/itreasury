      ...
      <TABLE align=center border=0 height=60 width=740>
        ...
        <TR>
          ...
          <TD colSpan=8 height=2>
            <HR>
            <FONT size=2><U>贴现基本资料</U></FONT></TD>
        ...
        <TR>
          ...
          <TD align=right colSpan=7 height=50>            
            <DIV align=right><FONT size=2>
				<INPUT class=button name="tjtxshq" onclick="confirmSave(frm)" type=button value="保存贴现凭证">
			...
			<% } %>
				...
				<INPUT class=button name=Submit42232 onclick="backto(frm)" type=button value=" 返 回 ">
            </FONT></DIV>
		  </TD>
		</TR>
		<TR>
