...
//--------------------------------------------do add end----------------------------------------------------------
		...
		//cancel操作
		long lResult = e_ejb.updateStatus(lExtendID,OBConstant.LoanInstrStatus.CANCEL,secinfo);
		if(txtSearch.equals("modify"))
		{
			//response.sendRedirect("../query/q003-c.jsp");
		}else
		{
			//response.sendRedirect("../extendapply/e001-v.jsp?control=view");
		}
