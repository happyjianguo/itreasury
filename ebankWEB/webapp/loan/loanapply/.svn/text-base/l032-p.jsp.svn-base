...
<%	
    ...
    try 
    {
	   ...
	   double staidAdjustRate=laInfo.getStaidAdjustRate();
		...
		if ( bankInterestID>0)
		{
    			//LoanInterestSettingHome home=(LoanInterestSettingHome)EJBObject.getEJBHome("LoanInterestSettingHome");
...
<html>
<head>
<title><%=Env.getClientName()%>贷款审批表</title>
...
<td  class="td-rightbottom" width="32%"><%=DataFormat.formatString(clientInfo.getAddress())%>&nbsp;</td>
