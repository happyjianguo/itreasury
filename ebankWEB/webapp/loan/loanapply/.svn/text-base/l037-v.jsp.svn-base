...
<TABLE border=0 class=top width=730>
  ...
  <TR class="tableHeader">
      <TD class=FormTitle  colspan=11><B><%=loanTypeName%>——修改</B></TD>
  </TR>
  <TR>
    <TD vAlign=top colspan=11>
        <TABLE align=center border=0  width=730>
          <TBODY> 
          <TR> 
            <TD colSpan=9 height=22><FONT size=2>申请指令编号：<%=applyCode%></FONT></TD>
			</tr>
          <tr> 
            <TD height=22 width=10>&nbsp;</TD>
            <TD height=22 width=10>&nbsp;</TD>
            <TD height=22 width=10>&nbsp;</TD>
            <TD colSpan=5 height=22 align="right" width="800"> <FONT size=2> 
              ...
              <table align=center border=0 width="100%">
                ...
                <TR> 
                  <TD colSpan=3 ><FONT size=2><BR>
                    <INPUT class=button name=Submit22 onclick="modifyWTClient()" type=button value=修改借款资料>
                    </FONT></TD>
                  <TD colSpan=2 >&nbsp;</TD>
                  <TD  width="40%">&nbsp;</TD>
                </TR>
...
<%if (Config.getBoolean(ConfigConstant.LOAN_CLIENT_REPORT,false)){%>
                <TR> 
                  <TD colspan=9>
                    &nbsp;&nbsp;<!--INPUT class=button name="dcb" type=button onfocus="nextfield='xyb'" value="贷款调查表" onclick="Javascript:window.open('../../content/c220-c.jsp?ParentID=<%=loanID%>&control=edit','','width=800,height=600,status=yes,toolbar=no,menubar=no,location=no,resizable=yes,scrollbars =yes');"-->  
...
{%>
          <TR> 
            ...
            <TD align=right height=14 width=10>&nbsp;</TD>
          </TR>
<%}%>
                <TR> 
          ...
          <TR> 
            ...
            <TD colSpan=4 height=29><U><FONT size=2> <A href="#" onclick="modifyLoanBasic()"> <%=str1%>
               </A></FONT></U></TD>
			 ...
			 <%
              ...
              %> 
                ...
                <TR> 
                  <TD height=24 width=1>&nbsp;</TD>
                  <TD colSpan=4><SPAN style="FONT-SIZE: 10pt"> 
                    <INPUT class=button name=Submit423222222222222 onclick="modifyLoanBasic()" type=button value="修改贷款基本资料">
                    </SPAN></TD>
                </TR>
         ...
         <% }else{ %> 
				...
				<%}%>
                    ...
                    <table width="100%" border="0">
                      <tr> 
                        ...
                        <td width="83%"><iframe src="../../attach/AttachFrame.jsp?lID=<%=loanID%>&lTypeID=<%=LOANConstant.AttachParentType.LOAN%>&sCaption=<%=URLEncoder.encode("链接附件")%>" width=600 height="100" scrolling="Auto" frameborder="0" name="iFrame" ></iframe>
                        </td>
                      </tr>
                    </table>
		  ...
		  <%}%>
          <TR> 
          <td colspan=12><hr><table><tr>
            <TD height=29 width=1>&nbsp;</TD>
			<TD align=left >&nbsp;
			<% if (loanType!=OBConstant.LoanInstrType.ASSURE) { %>
            
              <INPUT class=button name=Submit4 onclick="modifyPlan()"  type=button value=修改原始计划>
              </TD>
			  <%}%>
...
{
	window.open('<%=Env.EBANK_URL%>loan/loanapply/l034-c.jsp?lLoanType=<%=loanType%>&lLoanID=<%=appInfo.getID()%>&lClientID=<%=wtClientInfo==null?-1:wtClientInfo.getClientID()%>&txtAction=modify&statusID=<%=appInfo.getStatusID()%>&mType=wtclient', '修改客户基本资料', 'toolbar=yes,menubar=yes,resizable=yes,location=yes,width=800,height=600,scrollbars=yes', false)
}
function modifyClient()
{
	window.open('<%=Env.EBANK_URL%>loan/loanapply/l034-c.jsp?lLoanType=<%=loanType%>&lLoanID=<%=appInfo.getID()%>&lClientID=<%=cInfo.getClientID()%>&txtAction=modify&statusID=<%=appInfo.getStatusID()%>&mType=client', '修改客户基本资料', 'toolbar=yes,menubar=yes,resizable=yes,location=yes,width=800,height=600,scrollbars=yes', false)
}
function modifyLoanBasic()
{
	window.open('<%=Env.EBANK_URL%>loan/loanapply/l034-c.jsp?lLoanType=<%=loanType%>&lLoanID=<%=appInfo.getID()%>&txtAction=modify&statusID=<%=appInfo.getStatusID()%>&mType=loanBasic', '修改贷款基本资料', 'toolbar=yes,menubar=yes,resizable=yes,location=yes,width=800,height=600,scrollbars=yes', false)
}
function modifyLoanProperty()
{
	window.open('<%=Env.EBANK_URL%>loan/loanapply/l034-c.jsp?lLoanType=<%=loanType%>&lLoanID=<%=appInfo.getID()%>&txtAction=modify&statusID=<%=appInfo.getStatusID()%>&mType=loanProperty', '修改贷款属性资料', 'toolbar=yes,menubar=yes,resizable=yes,location=yes,width=800,height=600,scrollbars=yes', false)
}
function modifyAssure()
{
	window.open('<%=Env.EBANK_URL%>loan/loanapply/l034-c.jsp?lLoanType=<%=loanType%>&lLoanID=<%=appInfo.getID()%>&txtAction=modify&statusID=<%=appInfo.getStatusID()%>&mType=assure', '修改贷款保证资料', 'toolbar=yes,menubar=yes,resizable=yes,location=yes,width=800,height=600,scrollbars=yes', false)
}
function modifyPlan()
{
	window.open('<%=Env.EBANK_URL%>loan/loanapply/l034-c.jsp?lLoanType=<%=loanType%>&lLoanID=<%=appInfo.getID()%>&txtAction=modify&statusID=<%=appInfo.getStatusID()%>&mType=plan', '修改贷款计划资料', 'toolbar=yes,menubar=yes,resizable=yes,location=yes,width=800,height=600,scrollbars=yes', false)
}
...
<%  }  %>		
   		<% if (action.equals("modify")) {%>
   			frm.backurl.value="<%=Env.EBANK_URL%>loan/query/q003-c.jsp";
   		<% } %>
