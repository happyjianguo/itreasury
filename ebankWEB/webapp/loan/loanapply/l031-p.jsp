...
<%	
     ...
     try 
    {
		...
		OBLoanApplyInfo laInfo=(OBLoanApplyInfo)request.getAttribute("LoanApplyInfo");
		...
		if ( (assVector!=null)&&(assVector.size()>0) )	assInfo=(OBAssureInfo)assVector.get(0);
		...
		if ( (planVector!=null)&&(planVector.size()>0) )
		{
			...
			{
				OBLoanPlanDetailInfo tmpPlan=(OBLoanPlanDetailInfo)planVector.get(i);
...
<tr>
<td  class="td-rightbottom" colspan="2" align="center" height="25">委托单位</td>
<td  class="td-bottom" colspan="3" width="32%" ><%=wtClientInfo.getName()%>&nbsp;</td>
</tr>
<tr>
<td  class="td-rightbottom" colspan="2" align="center" height="25">委托单位电话</td>
...
<td class="td-bottom" width="32%"><%="("+DataFormat.formatString(wtClientInfo.getZipCode())+")"+DataFormat.formatString(wtClientInfo.getAddress())%>&nbsp;</td>
</tr>
<tr>
<td  class="td-rightbottom" colspan="2" align="center" height="25" width="25%">委托单位开户行</td>
...
<tr>
<td  class="td-rightbottom" colspan="2" align="center" height="25">邮　　编</td>
...
<tr>
	...
	<td  class="td-rightbottom" width="32%"><%=DataFormat.formatString(clientInfo.getFinanceManager())%>&nbsp;</td>
...
<%
	...
	if (laInfo.getAssureInfo() != null)
	{
		...
		{
			OBAssureInfo asInfo = new OBAssureInfo();
			asInfo = (OBAssureInfo)itAssure.next();
...
<tr>
<td class="td-right"width="5%" align="center" height=50>借<br>
款<br>
单<br>
位<br>
情<br>
...
<%
	...
	double d1=0;
	double d2=0;
	OBLoanPlanDetailInfo p1=null;
	OBLoanPlanDetailInfo p2=null;
	
	for ( int i=0;i<n;i++ )
	{
	 	if (i<payPlan.size())
	 	{
	 		p1=(OBLoanPlanDetailInfo)payPlan.get(i);
	 		t1=p1.getPlanDate();
	 		d1=p1.getAmount();
	 	}
	 	if ( i<repayPlan.size())
	 	{
	 		p2=(OBLoanPlanDetailInfo)repayPlan.get(i);
	 		t2=p2.getPlanDate();
	 		d2=p2.getAmount();
	 	}
%>
