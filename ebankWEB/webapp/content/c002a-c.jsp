...
<%
	...
	try
	{
		...
		if ( request.getParameterValues("textfield") != null )
		{
			...
			{		
				for (int i = 0; i < nLen; i++)
				{
					if (i < nLen - 1)
					{
						strContent = strContent + arrContent[i] + OBContentDao.CONTENT_SEPERATOR;
					}
					else
					{
			...
			{
				strContent = arrContent[0] + OBContentDao.CONTENT_SEPERATOR;
			}
		}
		else
		{
		...
		if (!sName.equals(""))
		{
			...
			String sURL = "/content/c001a-c.jsp";
			/* 获取上下文环境 */
