						...
						<TABLE align="center" height="129" width="97%">
							<TBODY>
								...
								<TR bordercolor="#ffffff">
									...
									<TD>		
										<input type="text" name="strReceiveGLName" class="box" size="20" maxlength="15" value="<%=strReceiveGLName%>" disabled>
									</TD>
								</TR>
								<TR bordercolor="#ffffff">
								...
								<TR bordercolor="#ffffff">
									...
									<TD height="2" width="35%">										
										<textarea name="strPayClientName" rows="2" cols="30"><%=strPayClientName%></textarea>
									</TD>
								</TR>
								<TR bordercolor="#ffffff">
									<TD colspan="4">
...
<script language="javascript">showDisableAccountCtrl("strAccountNo","<%=strReceiveAccountNo%>","账号","height='35' width='50%'","height='35' width='50%'");
								...
								<TR bordercolor="#ffffff">
									<TD height="25" nowrap>										
										<INPUT name=radiobutton disabled type=radio value=radiobutton <%=(lPayGL != -1)?"checked":""%>>总账类类型
									</TD>
									<TD nowrap>	
										<INPUT class=box disabled name="strPayGLName" value="<%=strPayGLName%>">
									</TD>
									<TD nowrap>&nbsp;	
									</TD>
									<TD nowrap>&nbsp;	
...
function doCheck()
{
	...
	{
		isSubmited = true;
		document.frmV098.strAction.value="<%=SETTConstant.Actions.CHECK%>";
		showSending();
		document.frmV098.submit();
	}
}
function doUndoCheck()
{
	...
	{
		if(!validateFields(frmV098)) return;

		isSubmited = true;
		document.frmV098.strAction.value="<%=SETTConstant.Actions.CANCELCHECK%>";
		showSending();
		document.frmV098.submit();
	}
}
...
function doPrint()
{
	window.open("<%=strContext%>/accountinfo/a410-v.jsp?lID=<%=lId%>&lReturn=<%=lReturn%>&strSuccessPageURL=/iTreasury-ebank/accountinfo/a410-v.jsp&strFailPageURL=/iTreasury-ebank/accountinfo/a398-v.jsp");
}
...
%>
<script language="JavaScript">
firstFocus(document.frmV098.strCheckAbstract);
