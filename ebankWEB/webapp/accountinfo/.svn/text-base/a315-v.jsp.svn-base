...
<%
    Log.print("\n*******进入页面--ebank/capital/accountinfo/a315-v.jsp******\n");
    //标题变量
    ...
    try {
        ...
        OBHtml.showOBHomeHead(out, sessionMng, strTitle, OBConstant.ShowMenu.YES);
			...
			String sAccountID = (String)request.getAttribute("lAccountID");
			if (sAccountID != null && sAccountID.trim().length() > 0)
			{
				lAccountID = Long.valueOf(sAccountID).longValue();
			}
...
%>
	<form name="frmV015" method="post" action="">
		...
		<input name="lPayAccountID"  type="hidden" value="<%=lPayAccountID%>">
		<input name="lReceiveAccountID"  type="hidden" value="<%=lReceiveAccountID%>">
		<input name="lAccountID"  type="hidden" value="<%=lAccountID%>">
		<TABLE border="0" class="top" height="290" width="99%">
			<TBODY>
				<TR class="tableHeader">
					<TD class="FormTitle" height="2" width="100%"><B>内部转账</B>
					</TD>
				</TR>
				<TR>
							...
							<TBODY>
								<TR>
									<TD height="107" vAlign="top" width="95%">
										<TABLE align="center" height="80" width="97%">
											<TBODY>
												<TR>
													<TD height="106" vAlign="top" width="50%">
														<TABLE border="1" borderColor="#999999" height="80" width="100%">
															<TBODY>
																<TR borderColor="#E8E8E8">
																	<TD height="20" Align="center" width="34%"><U>付款方详细资料 </U>
																	</TD>
																	<TD height="20" vAlign="top" width="66%">&nbsp;	
																	</TD>
																</TR>
																<TR borderColor="#E8E8E8">
																	<TD height="20" Align="center" width="29%">	付款方客户编号：
																	</TD>
																...
																<TR borderColor="#E8E8E8">
																	<TD height="20" Align="center" width="34%">	付款方客户名称：
																	</TD>
																	<TD height="20" vAlign="top" width="66%">
																...
																<TR borderColor="#E8E8E8">
<script language="javascript">showDisableAccountCtrl("strPayAccountNo","<%=strPayAccountNo%>","付款方账号","height='35' width='50%'","height='35' width='50%'");
</script>
																</TR>
															</TBODY>
														</TABLE>
													...
													<TD height="106" vAlign="top" width="50%">
														<TABLE align="center" border="1" borderColor="#999999" height="80" width="100%">
															<TBODY>
																<TR borderColor="#E8E8E8">
																	<TD height="20" Align="center" width="28%"><U>收款方详细资料</U>
																	</TD>
																	<TD height="20" vAlign="top" width="72%">&nbsp;	
																	</TD>
																</TR>
																<TR borderColor="#E8E8E8">
																	<TD height="20" Align="center" width="29%">	收款方客户编号：
																	</TD>
																	<TD height="20" vAlign="top" width="71%">
																...
																<TR borderColor="#E8E8E8">
																	<TD height="20" Align="center" width="28%">	收款方客户名称：
																	</TD>
																	<TD height="20" vAlign="top" width="72%">
								...
								<TR>
									<TD height="2" width="95%">
										<TABLE align="center" height="2" width="97%">
											<TBODY>
												<TR>
													<TD align="left" height="20" Align="center" width="8%">	金 额：
													</TD>
													<TD align="left" height="20" Align="center" width="22%">	￥
														<input type="text" name="textfield82" size="17" disabled class="tar" value="<%=DataFormat.formatDisabledAmount(dAmount)%>">
													</TD>
													<TD align="left" height="20" Align="center" width="13%">	起息日：
													</TD>
													<TD align="left" height="20" Align="center" width="19%">
														<input type="text" name="textfield92" size="20" disabled class="box" value="<%=strInterestStartDate%>">
													</TD>
													<TD align="left" height="20" Align="center" width="14%">	执行日：
													</TD>
													<TD align="left" height="20" Align="center" width="24%">
														<input type="text" name="textfield102" size="20" disabled class="box" value="<%=strExecuteDate%>">
													</TD>
												</TR>
												<TR>
													<TD align="left" height="20" Align="center" width="8%">	交易号：
													</TD>
													<TD align="left" height="20" Align="center" width="22%">
														<input type="text" name="textfield2352" size="20" disabled class="box" value="<%=strTransNo%>">
													</TD>
													<TD align="left" height="20" Align="center" width="14%">	摘 要：
													</TD>
													<TD align="left" height="20" Align="center" width="24%">
...
function checkSuccess()
{
	...
	document.location.href="<%=strContext%>/settlement/tran/current/view/v014.jsp";
...
function doPrint()
{
	window.open("<%=strContext%>/accountinfo/a401-v.jsp?lID=<%=lId%>&lTransactionTypeID=<%=lTransactionTypeID%>&lReturn=<%=lReturn%>&strSuccessPageURL=/iTreasury-ebank/accountinfo/a401-v.jsp&strFailPageURL=/iTreasury-ebank/accountinfo/a315-v.jsp");
}
...
function doReturn()
{
	...
	{%>
		document.location.href="<%=strContext%>/settlement/tran/current/control/c003.jsp?lStatusID=<%=SETTConstant.TransactionStatus.CHECK%>&lTransactionTypeID=<%=SETTConstant.TransactionType.INTERNALVIREMENT%>&strSuccessPageURL=../view/v016.jsp&strFailPageURL=../view/v016.jsp&strAction=<%=SETTConstant.Actions.LINKSEARCH%>";
	<%
	}else
	{
	%>
...
%>
<script language="JavaScript">
firstFocus(document.frmV015.strCheckAbstractStr);
