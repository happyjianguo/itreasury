...
<%
    Log.print("\n*******进入页面--ebank/capital/accountinfo/a304-v.jsp******\n");
    //标题变量
    String strTitle = "";
    try {
         /* 用户登录检测 */
...
Log.print("info="+info);
	...
	<form name="frmV004" action="" method="post">	<!--利用隐藏控件，来控制页面-->
		...
		<input name="strSuccessPageURL"  type="hidden" value="<%
				...
				{out.print("../a304-v.jsp");
				}else if(lStatusID == SETTConstant.TransactionStatus.CHECK)
				{out.print("../a303-c.jsp");}%>">
		<input name="strFailPageURL" type="hidden" value="../a303-c.jsp">
  ...
  <tr>
    ...
    <td width="90" background="/webob/graphics/lab_conner2.gif"  class="txt_til2"> 定期开立</td>
									...
									<TD height="147" vAlign="top" width="95%">
										<TABLE align="center" border="0" borderColor="#999999" height="40" width="97%" cellpadding="0" cellspacing="0" class=normal id="table1">
											<TBODY>
												...
												<TR borderColor="#D7DFE5">	<!--*****************************************************************************-->
<script language="javascript">showDisableAccountCtrl("strAccountNo","<%=strAccountNo%>","定期账号","width=15%","width=30%");
</script><!--*****************************************************************************-->
													<TD borderColor="#D7DFE5" height="20" width="16%">&nbsp;	
													</TD>
													<TD borderColor="#D7DFE5" height="20" width="39%">&nbsp;	
													</TD>
												</TR>
												<TR borderColor="#D7DFE5">
						
						              <TD height=20 width="15%">定期存款单据号： </TD>	
													<TD height="20" width="30%">
			  ...
			  %><!--
														<select class="box" name="slcFixedInterval" disabled>
															...
															<option value="10001">1天</option>
														</select>	-->
													</TD>
													<TD height="20" width="15%">	到期日期：
													</TD>
													<TD height="20" width="30%">
														<INPUT class="box" disabled name="strEndDate" size="18" value="<%=strEndDate%>">
													</TD>
												</TR>
												<TR borderColor="#D7DFE5">	<!--
													<TD height="20" width="15%">	利率计划 ：
													</TD>
													<TD height="20" width="30%">
														<INPUT class="box" disabled name="textfield64228" size="30" value="null">
													</TD>	-->
        ...
        <TR>
          <TD height=20 vAlign=top width="95%">
            <TABLE align=center border=0  height=40 
...
%>		
                ...
                <TD borderColor=#D7DFE5 colSpan=3 height=20 vAlign=top></TD></TR>
              <TR borderColor=#D7DFE5>
...
%>					
                ...
                <TD colSpan=3 height=20 vAlign=top></TD></TR>
              <TR borderColor=#D7DFE5 Align=center>
        ...
        <TR>
          <TD height=2 width="95%">
            <TABLE align=center height=2 width="97%" >
              <TBODY>
              <TR>
                <TD align=left height=20 Align=center  width="10%">金 额：</TD>
                <TD align=left height=20 Align=center width="20%">				
              ...
              <TR>
                ...
                <TD align=left height=20 Align=center 
width="25%">&nbsp;</TD></TR>
...
%>
	...
	//标识是否已提交请求
		...
		{			
		    ...
		    {
				window.open("<%=strContext%>/settlement/print/view/v002.jsp?lID=<%=lID%>&lTransTypeID=<%=lTransactionTypeID%>&strSuccessPageURL=/settlement/tran/fixed/view/v004.jsp&strFailPageURL=/settlement/tran/fixed/view/v004.jsp");
		        document.location.href="<%=strContext%>/settlement/tran/fixed/view/v003.jsp";
		    }
			else
			{
				document.location.href="<%=strContext%>/settlement/tran/fixed/view/v003.jsp";
		...
		function doPrint()
		{			
			window.open("<%=strContext%>/accountinfo/a402-v.jsp?lID=<%=lID%>&lTransactionTypeID=<%=lTransactionTypeID%>&lReturn=<%=lReturn%>&lTransTypeID=<%=lTransactionTypeID%>&strSuccessPageURL=/iTreasury-ebank/accountinfo/a304-v.jsp&strFailPageURL=/iTreasury-ebank/accountinfo/a304-c.jsp");
		}
		function doCheck()
		{
			if(isSubmited == true)
		...
		{
			document.location.href="<%=strContext%>/settlement/tran/fixed/control/c003.jsp?strAction=<%=SETTConstant.Actions.LINKSEARCH%>&lTransactionTypeID=<%=SETTConstant.TransactionType.OPENFIXEDDEPOSIT%>&strSuccessPageURL=../view/v006.jsp&strFailPageURL=../view/v006.jsp";
		}
		function doReturn()
		{
