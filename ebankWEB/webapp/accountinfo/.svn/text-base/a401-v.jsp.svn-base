...
<%
    Log.print("\n*******进入页面--ebank/capital/accountinfo/a401-v.jsp******\n");
    //标题变量
...
%>
<%
		if(lTransactionTypeID != SETTConstant.TransactionType.CONSIGNSAVE)
		{
%>
...
<%
		if(lTransactionTypeID != SETTConstant.TransactionType.CONSIGNSAVE && lTransactionTypeID != SETTConstant.TransactionType.CAUTIONMONEYSAVE)
		{
%>
...
<%
		if(lTransactionTypeID != SETTConstant.TransactionType.BANKPAY)
		{
%>
			if (document.frmv001.tz1.checked == true)
			{
...
%>
/*
		if (document.frmv001.PrintTemplate1.checked == true)
		{
		...
		if (document.frmv001.PrintTemplate2.checked == true)
		{
		...
		if (document.frmv001.PrintTemplate3.checked == true)
		{
		...
		if (document.frmv001.PrintTemplate4.checked == true)
		{
		...
		if (document.frmv001.PrintTemplate5.checked == true)
		{
		...
		if (document.frmv001.PrintTemplate6.checked == true)
		{
		...
		if (document.frmv001.PrintTemplate7.checked == true)
		{
		...
		if (document.frmv001.PrintTemplate8.checked == true)
		{
		...
		if (document.frmv001.PrintTemplate9.checked == true)
		{
		...
		if (document.frmv001.PrintTemplate10.checked == true)
		{
		...
		if (document.frmv001.PrintTemplate11.checked == true)
		{
		...
		if (document.frmv001.PrintTemplate12.checked == true)
		{
		...
		if (document.frmv001.PrintTemplate13.checked == true)
		{
...
*/
	...
	{
		window.open("<%=strContext%>/common/p001-c.jsp?lID=<%=lID%>&printPage=/accountinfo/a401-c.jsp&lTransTypeID=<%=lTransactionTypeID%>&strPrintPage="+strfrmList);
		window.close();
	}
}
