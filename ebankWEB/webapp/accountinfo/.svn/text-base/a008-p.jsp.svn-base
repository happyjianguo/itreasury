...
<input type="hidden" name="strSuccessPageURL" value="../a008-v.jsp">
   ...
   %> 
	...
	<table  class="table1"　border="0" bordercolor="#999999"  width="85%"   cellspacing="0" cellpadding="0">
              ...
              <tr align=center > 
                <td class=td-rightbottom width="18%" nowrap height="23">账户类型</td>
                <td class=td-rightbottom width="14%" nowrap height="23">账号</td>
                <td class=td-rightbottom width="48%" nowrap height="23">账户名称</td>
                <td class=td-bottom width="20%" nowrap height="23">资金余额</td>
   ...
   { lLine=0;
    ...
    <b>
     账户余额</b>
        ...
        <tr >           
          <td colspan="10" height="23" class="td-bottom">&nbsp;&nbsp;&nbsp;&nbsp;定期账户</td>          
        </tr>
		<tr  >           	  
    ...
    <b>
     账户余额</b>
	       ...
	       <table border="0" bordercolor="#999999" class="table1" width="85%"  border="0" cellspacing="0" cellpadding="0">
	        <tr >           
	          <td colspan="9" height="23" class="td-bottom">&nbsp;&nbsp;&nbsp;&nbsp;定期账户</td>          
	        </tr>
			<tr >           	  
		...
		%>
		  ...
		  <!--利率-->
		  <td class="td-rightbottom" align="<%=sRate.equals("小计")?"center":"right" %>" height="23" >&nbsp;<%=sRate%><%=sRate.equals("小计")?"&nbsp;":"" %></td>
		  <!--存款金额-->
      ...
      <td class="td-rightbottom"  height="23" align="right" nowrap><strong>存款余额总计：</strong></td>
		  <!--存款余额-->
...
%>
		    ...
		    <!--期限-->
            <td class="td-rightbottom"  aling="<%=sTerm.equals("小计")?"center":"right" %>" height="23">&nbsp;<%=sTerm%><%=sTerm.equals("小计")?"&nbsp;":"" %></td>
		    <!--贷款金额-->
	...
	<tr align="center" > 
      ...
      <td class="td-rightbottom"  height="23" align="right" nowrap> <strong>贷款余额总计：</strong> 
      </td>
		    <!--贷款余额-->
            <td class="td-rightbottom"  height="23" align="right" nowrap> 
