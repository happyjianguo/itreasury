...
<%
    Log.print("\n*******进入页面--ebank/capital/accountinfo/a355-v.jsp******\n");
    //标题变量
	...
	<form name="frmV055" method="post" action="">
		...
		<TABLE width="99%" border="0" class="top" height="290">
			<TR class="tableHeader">
				<TD height="2" class="FormTitle" width="100%"><B>现金收款</B>
				</TD>
			</TR>
			<TR>
										...
										<TD width="100%" height="80" valign="top">
											<TABLE width="100%" border="1" height="100%" align="center" bordercolor="#999999">
												<TR bordercolor="#E8E8E8">
													<TD valign="middle" height="20" width="25%"><U>收款方详细资料</U>
													</TD>
													<TD valign="top" height="20" width="75%">&nbsp;	
													</TD>
												</TR>
												<TR bordercolor="#E8E8E8">
													<TD valign="middle" height="23" width="25%">	收款方客户编号：
													</TD>
													<TD valign="top" height="23" width="75%">														
														<INPUT type="text" name="kehh" size="6" class="box" onFocus="nextfield ='zhh1';" maxlength="6" disabled value="<%=strReceiveClientCode%>">
													</TD>
												</TR>
												<TR bordercolor="#E8E8E8">
													<TD valign="middle" height="20" width="25%">	收款方客户名称 
	                        ：
													</TD>
													<TD valign="top" height="20" width="75%">
												...
												<TR bordercolor="#E8E8E8">
<script language="javascript">showDisableAccountCtrl("strReceiveAccountNo","<%=strReceiveAccountNo%>","收款方账号","height='35' width='25%'","height='35' width='75%'");
</script>
												</TR>
												<TR bordercolor="#E8E8E8">
													<TD valign="middle" height="20" width="25%">	开户行：
													</TD>
													<TD valign="top" height="20" width="75%">
												...
												<TR bordercolor="#E8E8E8">
													<TD valign="middle" height="20" width="25%">	报单号：
													</TD>
													<TD valign="top" height="20" width="75%">														
										...
										<TD width="50%" height="80" valign="top">
											<TABLE width="100%" border="1" height="100%" align="center" bordercolor="#999999">
												<TR bordercolor="#E8E8E8">
													<TD valign="middle" height="20" width="26%"><U>付款方详细资料</U>
													</TD>
													<TD valign="top" height="20" width="74%">	&nbsp;
													</TD>
												</TR>
												<TR bordercolor="#E8E8E8">
													<TD valign="middle" height="20" width="26%">	付款方账号：
													</TD>
													<TD valign="top" height="20" width="74%">														
												...
												<TR bordercolor="#E8E8E8">
													<TD valign="middle" height="20" width="26%">	付款方名称 
	                        ：
													</TD>
													<TD valign="top" height="20" width="74%">
												...
												<TR bordercolor="#E8E8E8">
													<TD valign="middle" height="20" width="26%">	&nbsp;
													</TD>
													<TD valign="top" height="20" width="74%">	&nbsp;
													</TD>
												</TR>
...
function checkSuccess()
{
	...
	document.location.href="<%=strContext%>/settlement/tran/current/view/v054.jsp";
...
function doCheck()
{
	...
	{
		isSubmited = true;
		document.frmV055.strAction.value="<%=SETTConstant.Actions.CHECK%>";
		document.frmV055.submit();
	}
}
function doUndoCheck()
{
	...
	{
		if(!validateFields(frmV055)) return;

		isSubmited = true;
		document.frmV055.strAction.value="<%=SETTConstant.Actions.CANCELCHECK%>";
		document.frmV055.submit();
	}
}
...
function doPrint()
{
	window.open("<%=strContext%>/accountinfo/a401-v.jsp?lID=<%=lId%>&lTransactionTypeID=<%=lTransactionTypeID%>&lReturn=<%=lReturn%>&strSuccessPageURL=/iTreasury-ebank/accountinfo/a401-v.jsp&strFailPageURL=/iTreasury-ebank/accountinfo/a355-v.jsp");
}
...
function doReturn()
{
	...
	{%>					
		document.location.href="<%=strContext%>/settlement/tran/current/control/c003.jsp?lStatusID=<%=SETTConstant.TransactionStatus.CHECK%>&lTransactionTypeID=<%=SETTConstant.TransactionType.CASHRECEIVE%>&strSuccessPageURL=../view/v056.jsp&strFailPageURL=../view/v056.jsp&strAction=<%=SETTConstant.Actions.LINKSEARCH%>";
	<%
	}else
	{
	%>
...
%>
<script language="JavaScript">
firstFocus(document.frmV055.strCheckAbstractStr);
