    ...
    <TD colSpan=2 height=20 vAlign=top width="100%">
      <TABLE align=center borderColor=#999999 height=40 width="97%">
        <TR borderColor=#E8E8E8>
          ...
          <TD height=20 width="16%">自营贷款客户名称 ：</TD>
...
<script language=javascript>			  
		showDisableAccountCtrl("txtTrustLoanAccountNoCtrl","<%=NameRef.getAccountNoByID(info.getLoanAccountID())%>","自营贷款账号","width=17%","width=33%")
</script>				  
<!--*********************************************************************************-->			
  ...
  <TR>
    <TD height=20 rowSpan=2 vAlign=bottom width="35%">
      <TABLE align=right border=1 borderColor=#999999 height="100%" 
        width="96%">
        <TR borderColor=#E8E8E8>
          <TD colSpan=2 height=23 vAlign=middle><U>自营贷款详细资料 
            </U></TD>
  ...
  <TR>
    <TD colSpan=2 height=262 vAlign=top width="100%">
      <TABLE align=center border=1 borderColor=#999999 height=40 width="97%">
        <TR borderColor=#E8E8E8>
          <TD colSpan=5 height=30><U>自营贷款放款账户详细资料 
        </U></TD></TR>
        <TR borderColor=#E8E8E8>
...
%>
			...
			{
			%>
			<INPUT class=button name=Submit3 onclick="doCheck(frmV006);" type=button value=" 复 核 "> 
			<%
			}
			else if (lStatusID == SETTConstant.TransactionStatus.CHECK)
			{
			%>
			<INPUT class=button name=Submit31 onclick="doCancelCheck(frmV006);" type=button value=" 取消复核 "> 			
			<%
			}
			%>
            <INPUT class=button name=Submit32 onclick="print()" type=button value=" 打 印 "> 
			<INPUT class=button name=Submit322 onclick="doBack(frmV006);" type=button value=" 返 回 "> 
<%
	}
%>
