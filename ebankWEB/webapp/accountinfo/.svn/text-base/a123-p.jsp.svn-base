...
%>
		...
		<table width="600" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td width="15%">&nbsp;</td>
				<td width="70%" align="center"><b><font style="font-size:22px">当日余额查询</font></b></td>
				<td width="15%">&nbsp;</td>
			</tr>								
			<tr align=center>
				<td colspan="3" class=td-rightbottom height=4> 活期账户</td>
			</tr>
			<TR>
			<TD  colspan="3">
				<TABLE border=0  class="table1" cellspacing="1" width="100%">
					<TBODY>
						
						<TR align=center>
				            <TD class=td-rightbottom width="30%">账户类型</TD>
				            <TD class=td-rightbottom width="35%">账号</TD>
				            <TD class=td-bottom width="30%">资金余额</TD>
					 		</TR>
<%
//开始中油财务内部账户显示------------------------------------------------------------------------------------------
...
%>
	...
	{
%>					
										<TR align="center" bordercolor="#999999" class="td-topright">
...
%>
								...
								<tr align=center>
									<td colspan="2" class=td-rightbottom height=4> 定期账户</td>
								</tr>
								<TR>
								<TD>
									<TABLE border=0  class="table1" cellspacing="1" width="100%">
...
%>
								...
								<tr>
									<td colspan="2" class=td-rightbottom height=4 align=center> 贷款账户</td>
								</tr>
								<TR>
								<TD>
									<TABLE border=0 class="table1" cellspacing="1" width="100%">
										<TBODY>
										<TR align=center>
										<TD class=td-rightbottom width="12%">账户类型
										</TD>
										<TD class=td-rightbottom width="12%">账号/合同号
										 </TD>
										<TD class=td-rightbottom width="20%">借款单位
										</TD>	
										<TD class=td-rightbottom width="15%">&nbsp;
										</TD>
										<TD class=td-rightbottom width="4%">&nbsp;
										</TD>
...
%>
			...
			<table width="98%">
			<tr>
			<td width="450"><div align="left"><span class="graytext">打印日期：<%=DataFormat.getDateString()%></span> 
			</div></td>
			</tr>
			</table>			
