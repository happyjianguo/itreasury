...
function sendback1()
{
	...
	{
		if (document.frmv001.ckzzpz.checked == true)
		{
		...
		if (document.frmv001.bjshpz.checked == true)
		{
		...
		if (document.frmv001.lxshpz.checked == true)
		{
		...
		window.open('a608-c.jsp?lID=<%=lID%>&strPrintPage='+strfrmList);
		window.close();
	}
}
...
<body bgcolor="#d6d3ce"  text="#000000">
  ...
  <table width="163" class="table" align="center">
  <%
  ...
  %>
    <tr bordercolor="#d6d3ce"> 
      <td colspan="2" height="30"> 
        <input type="checkbox" name="ckzzpz" value="checkbox" onClick="check(this)">
        存款支取凭证
      </td>
    </tr>
    <tr bordercolor="#d6d3ce"> 
     <td colspan="2" height="30">  
        <input type="checkbox" name="bjshpz" value="checkbox" onClick="check(this)">
        银团贷款本金收回凭证</td>
    </tr>
	<tr bordercolor="#d6d3ce"> 
      <td colspan="2" height="30">  
        <input type="checkbox" name="lxshpz" value="checkbox" onClick="check(this)">
        银团贷款利息收回凭证</td>
    </tr>
	<tr bordercolor="#d6d3ce">
