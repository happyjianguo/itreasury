...
<%
    Log.print("\n*******进入页面--ebank/capital/accountinfo/a403-v.jsp******\n");
    //标题变量
...
*/
	...
	{
		window.open("<%=strContext%>/common/p001-c.jsp?lID=<%=lID%>&printPage=/accountinfo/a403-c.jsp&lTransTypeID=<%=lTransactionTypeID%>&strPrintPage="+strfrmList);
		window.close();
	}
}
...
<form name="frmv003" method="post" action="../a303-c.jsp">
