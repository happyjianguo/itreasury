	    ...
	    <td height="22">
		    <table cellspacing="0" cellpadding="0" class=title_Top1>
				<TR>
			       ...
			       <td class=title_right><a class=img_title></a></td>
				</TR>
			</TABLE>  
    </td>
  </tr>
...
<table width=80% border="0"  cellspacing="0" cellpadding="0" class=normal id="table1">
		...
		<td width="4" height="25" ></td>
          ...
          <td width="5" height="25" ><div align="right" ><%= sessionMng.m_strCurrencySymbol %></div></td>
          <td width="457" height="29" width="29">
          <script  language="JavaScript">
				createAmountCtrl("exp_frm","dAmount","0.00","lCount","sChineseAmount","<%=sessionMng.m_lCurrencyID%>");
			</script>
          </td>
...
function addme()
{
	...
	exp_frm.action = "batchpay_c.jsp?dAmount=" + exp_frm.dAmount.value + "&lCount=" + exp_frm.lCount.value;
	showSending();
	exp_frm.submit();
}
