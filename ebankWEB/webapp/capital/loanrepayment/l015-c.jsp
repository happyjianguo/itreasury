...
<%
  try
  {
	Log.print("*******进入页面--ebank/capital/loanrepayment/l015-c.jsp*******");
	   ...
	   /* 用户登录检测 */
		...
		long lTransType = OBConstant.SettInstrType.CONSIGNLOANRECEIVE;
		long lPayerAcctID = -1;
		long lPayeeAcctID = -1;
		double dBalance = 0.0;
		double dAmount = 0.0;
	...
	pageControllerInfo.setUrl("/capital/loanrepayment/l016-v.jsp");
	//分发
