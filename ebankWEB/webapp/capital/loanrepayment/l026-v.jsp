...
<%
  try
  {
	Log.print("*******进入页面--ebank/capital/loanrepayment/l026-v.jsp.jsp*******");
...
<table width="730" border="0" cellspacing="0" cellpadding="0" class=top>
        <tr  class="FormTitle">
          ...
          <td width="560"height="25" ><font size="3" >利息费用清还确认</font></td>
        ...
        <tr >
          ...
          <td height="25" >
            <p>利息费用清还确认指令将于复核后才提交到<%=NameRef.getOfficeNameByID(sessionMng.m_lOfficeID)%>！<br>
			  <br>
              该笔交易有待复核人复核！
			  <br>
              <br>
...
<td>    <table width="730" border="0" cellspacing="0" cellpadding="0" class=top>
          <tr  class="FormTitle"> 
            <td  width="5" valign="top" align="left" height="25"></td>
            <td width="560"height="25"  colspan="2"><font size="3" >活期账户 
              </font></td>
          ...
          <tr > 
            <td width="5" height="25"></td>
            <td width="130" height="25" >付款方账号：</td>
            <td width="430" height="25" > <%=financeInfo.getPayerAcctNo()%></td>
            <td width="5"></td>
          </tr>
		  <tr >
...
<td>
      <table width="730" border="0" cellspacing="0" cellpadding="0" class=top>
        <tr class="FormTitle">
          <td  width="5" valign="top" align="left" height="25"></td>
          <td width="560"height="25" ><font size="3">贷款资料</font></td>
          <td width="5" valign="top" align="right" height="25">
            <div align="right"></div>
          </td>
        </tr>
      ...
      <table width="730" border="0" cellspacing="0" cellpadding="0" class=top>
        ...
        <tr >
          ...
          <tr >
            <td  width="5"  height="25"></td>
            <td width="130" height="25" class="graytext">利率：</td>
            <td  width="430" height="25" class="graytext"><%=DataFormat.formatRate(financeInfo.getRate())%>%</td>
            <td  width="1" height="25" ></td>
          </tr>
          ...
          <tr > 
            <td width="5" height="25"></td>
            <td width="130" height="25" class="graytext"> <p>结息日：</p></td>
            <td width="430" height="25" class="graytext"><%=DataFormat.formatDate(financeInfo.getClearInterest())%></td>
            <td width="1" height="25"></td>
          </tr>
        </table>
      <br>
      <table width="730" border="0" cellspacing="0" cellpadding="0" class=top>
          ...
          <tr > 
           ...
           <tr > 
            ...
            <td class="graytext"   width="430"><%=sessionMng.m_strCurrencySymbol%><%=financeInfo.getRealSuretyFee() > 0 ? DataFormat.formatDisabledAmount(financeInfo.getRealSuretyFee()):"0.00"%></td>
            <td></td>
          </tr>
          <tr > 
            <td colspan="6" height="1"></td>
...
function PrintConsignVoucher()
{
	...
	function returnme()
	{
		...
		%>	
			frm.lID.value="";
			frm.action="../loanrepayment/l021-c.jsp";
		<%
		}
		%>
	...
	function deleteme()
	{
		...
		showSending();
		frm.action="../loanrepayment/l027-c.jsp";
		frm.submit();
	}
	/* 复核匹配函数 */
