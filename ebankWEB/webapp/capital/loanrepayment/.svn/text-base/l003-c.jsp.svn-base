...
<%
  try
  {
	Log.print("*******进入页面--ebank/capital/loanrepayment/l003-c.jsp*******");
	   ...
	   /* 用户登录检测 */
		...
		SubLoanAccountDetailInfo subLoanAccountDetailInfo = null;
		  ...
		  Log.print("==========subLoanAccountDetailInfo 贷款利息:"+subLoanAccountDetailInfo.getInterest());
		  ...
		  if(dAmount < dBalance)
		{
		  ...
		  //lxr后增加
		  subLoanAccountDetailInfo.setInterestIncome(0.0);		  
		    Log.print("＝＝＝＝＝＝＝＝＝＝＝应付总额:"+subLoanAccountDetailInfo.getTotal());
	...
	pageControllerInfo.setUrl("/capital/loanrepayment/l004-v.jsp");
	//分发
