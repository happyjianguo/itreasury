...
<%
  try
  {
	   Log.print("*******进入页面--ebank/capital/loanrepayment/l011-c.jsp*******");
       ...
       if (sessionMng.hasRight(request) == false)
		...
		long lCurrencyID = sessionMng.m_lCurrencyID;
		 ...
		 //获取贷款账号
		PayerOrPayeeInfo payerOrPayeeInfo = obFinanceInstr.getLoanAccountInfo(sessionMng.m_lClientID,sessionMng.m_lCurrencyID,SETTConstant.AccountGroupType.CONSIGN);
	...
	pageControllerInfo.setUrl("/capital/loanrepayment/l012-v.jsp");
	//分发
