...
<%
  try
  {
	Log.print("*******进入页面--ebank/capital/loanrepayment/l006-v.jsp.jsp*******");
...
if(strTag != null && financeInfo.getStatus() == OBConstant.SettInstrStatus.SAVE)
{
%>
<table width="730" border="0" cellspacing="0" cellpadding="0" class="top">
        <tr  class="FormTitle">
          ...
          <td width="560"height="25" >
		  <font size="3"><%=tempTitle%>确认</font></td>
        ...
        <tr >
          ...
          <td height="25" >
			...
			<br>
			<p>
			&nbsp;&nbsp;<%=tempTitle%>指令将于复核后才提交到<%=NameRef.getOfficeNameByID(sessionMng.m_lOfficeID)%>！<br>
			  <br>
              &nbsp;&nbsp;该笔交易有待复核人复核！
			  <br>
              <br>
...
<td>    <table width="730" border="0" cellspacing="0" cellpadding="0" class="top">
          <tr  class="FormTitle"> 
            <!--td  width="5" valign="top" align="left" height="25"><img src="\webob\graphics\blue_top_left.gif" width="3" height="3"></td-->
            <td width="560"height="25"  colspan="4"><font size="3" >付款方资料 
              </font></td>
          ...
          <tr > 
            <td width="5" height="25"></td>
            <td width="130" height="25"  class="graytext">付款方账户名称：</td>
...
<td>
      <table width="730" border="0" cellspacing="0" cellpadding="0" class="top">
        <tr  class="FormTitle">
          <!--td  width="5" valign="top" align="left" height="25"><img src="\webob\graphics\blue_top_left.gif" width="3" height="3"></td-->
          <td width="560"height="25" colspan="4"><font size="3" >收款方资料</font></td>
          <!--td width="5" valign="top" align="right" height="25">
            <div align="right"></div>
          </td-->
        </tr>
      ...
      <table width="730" border="0" cellspacing="0" cellpadding="0" class="top">
        <tr  class="FormTitle">
          <!--td  width="5" valign="top" align="left" height="25"><img src="\webob\graphics\blue_top_left.gif" width="3" height="3"></td-->
          <td width="560" height="25"  colspan="5"><font size="3" >划款资料</font></td>
          <!--td width="5" valign="top" align="right" height="25">
            <div align="right"></div>
          </td-->
        </tr>
      ...
      <table width="730" border="0" cellspacing="0" cellpadding="0" class="top">
          <tr  class="FormTitle"> 
            <!--td  width="5" valign="top" align="left" height="25"><img src="\webob\graphics\blue_top_left.gif" width="3" height="3"></td-->
            <td width="560"height="25"  colspan="5"><font size="3">利息费用资料</font></td>
            <!--td width="5" valign="top" align="right" height="25"> <div align="right"></div></td-->
          </tr>
          <tr > 
            <td colspan="5" height="1"></td>
          ...
          <tr > 
            <td width="5" height="25"></td>
            <td width="130" height="25"  class="graytext" colspan="2" nowrap> 贷款利息：</td>
            <td width="430" height="25"  class="graytext"><%=sessionMng.m_strCurrencySymbol%><%=financeInfo.getInterest() > 0 ? DataFormat.formatDisabledAmount(financeInfo.getInterest()):"0.00"%></td>
            <td width="5"></td>
          </tr>
		   <tr >
          <td colspan="5" height="1"></td>
          ...
          <tr > 
            <td height="25"></td>
            <td height="25" class="graytext"   width="130" colspan="2"> 复利：</td>
          ...
          <tr >
            <td height="25"></td>
            <td height="25" class="graytext"    width="130" colspan="2"> 担保费：</td>
            <td height="25" class="graytext"   width="430"><%=sessionMng.m_strCurrencySymbol%><%=financeInfo.getSuretyFee() > 0 ? DataFormat.formatDisabledAmount(financeInfo.getSuretyFee()):"0.00"%></td>
            <td></td>
          </tr>
		   <tr >
          <td colspan="5" height="1"></td>
...
<input name="isYT" value="<%=isYT%>" type="hidden">
<%
/* 从指令查询页面过来的 */
String search="";
...
search=(String)request.getAttribute("search");
		...
		if (((financeInfo.getStatus() == OBConstant.SettInstrStatus.SAVE) || (financeInfo.getStatus() == OBConstant.SettInstrStatus.SAVE)) && (sessionMng.m_lUserID == financeInfo.getConfirmUserID())){// 未、已确认、登录人＝确认人 %>
		   ...
		   <!--img src="\webob\graphics\button_xiugai.gif" width="46" height="18" border="0" onclick="Javascript:updateme();">
            ...
            <% if ( strTag != null &&  lShowMenu != OBConstant.ShowMenu.NO) {%>
...
function PrintConsignVoucher()
{
	...
	function returnme()
	{
		...
		%>	
		    frm.lID.value="";
			frm.action="../loanrepayment/l001-c.jsp";
		<%
		}
		%>
			showSending();
	...
	function deleteme()
	{
		...
		showSending();
		frm.action="../loanrepayment/l007-c.jsp";
		frm.submit();
	}
	/* 复核匹配函数 */
