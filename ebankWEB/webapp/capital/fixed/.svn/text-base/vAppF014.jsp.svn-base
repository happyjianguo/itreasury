...
<br/>
	 <table width="80%" border="0" cellspacing="0" cellpadding="0" align="">
      <tr>
        ...
        <table width="110" border="0" cellspacing="0" cellpadding="0">
          	<tr>
				...
				<td class="lab_title2" style="width:150px"> 定期支取确认</td>
      ...
      <p><br>定期支取将<%if(!OBFSWorkflowManager.isAutoCheck()){ if(financeInfo.getStatus()==OBConstant.SettInstrStatus.APPROVALED){%>于复核后才<%} else if(financeInfo.getStatus()==OBConstant.SettInstrStatus.APPROVALING){%>于审批并复核后才<%} }%>提交到<%=NameRef.getOfficeNameByID(sessionMng.m_lOfficeID)%>！<br>
              <!--br>
              已通知复核人复核！
			  <br-->
      ...
      <tr>
        <td>
	        <table width="110" border="0" cellspacing="0" cellpadding="0">
	          	<tr>
					<td width="3"><a class=lab_title1></td>
					<td class="lab_title2" style="width:150px"> 定期账户资料</td>
					<td width="17"><a class=lab_title3></td>
				</tr>
	        </table>
        </td>
