...
<%
	...
	String url = "/capital/fixed/f002-v.jsp?oldtsExecute="+request.getParameter("oldtsExecute");
	pageControllerInfo.setUrl("/capital/fixed/f002-v.jsp?oldtsExecute="+request.getParameter("oldtsExecute"));
	//分发
