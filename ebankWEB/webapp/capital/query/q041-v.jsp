...
<form method="post" name="frm">
	...
	<input type="hidden" name="hdnTransActionType" value="<%=SETTConstant.TransactionType.FREEZE%>">
	<!--隐含业务数据-->
...
function doGoSearch()
{
	if(isSubmited)	
   {
	...
	frm.strSuccessPageURL.value="../view/v028.jsp";
	frm.strFailPageURL.value="../view/v028.jsp";
...
function validate(frm)
{
       ...
       var b = true;
		 if (!CompareDate(frm.startdate,frm.enddate,"执行日期	不能由大到小 "))
			return(false);
