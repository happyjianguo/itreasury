             ...
             <TABLE width="100%" height=64 border=0 align=center cellspacing="1" class=ItemList>
               <TBODY>
                 <TR>
                   ...
                   <td nowrap class="ItemTitle" align="center" ><A href="javascript:OrderPage(<%=ReportLossOrFreezeBean.OrderBy_EffectiveDate%>)">生效日期</a></td>
                   ...
                   <td nowrap class="ItemTitle" align="center"><A href="javascript:OrderPage(<%=ReportLossOrFreezeBean.OrderBy_NewDepositNo%>)">新存单号</a></td>
...
<%
	...
	if(queryResults!=null && queryResults.length>0)
	{
		for( int i=0; queryResults != null && i<queryResults.length; i++ )
		{
			...
			strDetailPageURL = strContext+"/capital/query/q051-c.jsp?hdnId="+info.getId()+"&strAction="+SETTConstant.Actions.TODETAIL+"&strSuccessPageURL=/capital/query/q051-v.jsp&strFailPageURL=/capital/query/q051-v.jsp";
%>
                 <TR>
                   <td class="ItemBody" height="20" align="right" ><A href="<%= strDetailPageURL %>"  target="blank">
				   <%=DataFormat.formatString(info.getTransNo())%> </a></td>
                   ...
                   <td class="ItemBody" align="right" height="20"><%=DataFormat.formatString(info.getNewDepositNo())%></td>
               ...
               <TBODY>
                 <TR vAlign=middle>
                   <TD width="70%" height=20>
                     <DIV align=right></DIV>
                     <DIV align=right>
                       <INPUT name="cmdBack" type=button class=button onclick="javascript:location.href='<%=strContext%>/capital/query/q031-v.jsp';" value=" 返 回 ">
                     </DIV>
                   </TD>
                 </TR>
               </TBODY>
...
function queryDetail(id)
{
	...
	frm.strSuccessPageURL.value="../view/v009.jsp";
	frm.strFailPageURL.value="../view/v009.jsp";
