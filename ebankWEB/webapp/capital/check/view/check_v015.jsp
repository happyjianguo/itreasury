  ...
  <tr>
    <td height="24">
	    <table cellspacing="0" cellpadding="0" class=title_Top1>
			<TR>
		       <td class=title><span class="txt_til2">批量复核-定期</span></td>
      ...
      <table width=100% border="0" cellspacing="0" cellpadding="0" class=normal >
		...
		OBConstant.SettInstrType.showList(out,"lTransType",3,lTransType,true,false,"   onfocus=\"nextfield ='NSTATUS';\" ",null,false);
...
//setSubmitFunction("doSearch()");
 ...
 /* 查询处理函数 */
	...
	{
	if (validate() == true) {
	frmjysqcx.sign.value="fixd";
	frmjysqcx.strAction.value="search";
	frmjysqcx.action = "<%=strContext%>/capital/check/control/check_c005.jsp";
	frmjysqcx.strSuccessPageURL.value="<%=strContext%>/capital/check/view/check_v015.jsp";
	frmjysqcx.strFailPageURL.value="<%=strContext%>/capital/check/view/check_v015.jsp";
	showSending();
	frmjysqcx.submit();
	}   
	 }
