	  ...
	  <tr>
	    <td height="22">
		    <table cellspacing="0" cellpadding="0" class=title_Top1>
				<TR>
			       <td class=title><span class="txt_til2">取消复核-活期</span></td>
...
<%
		OBHtmlCom.showQueryCheckTypeListControl1(out,"SelectType",(rsForm == null)?-1:rsForm.getTransType()," onfocus=\"nextfield ='txtConfirmA';\" ",sessionMng.m_lOfficeID,sessionMng.m_lCurrencyID,sessionMng.m_lClientID,true);
%>       
        ...
        <tr class="MsoNormal">
          ...
          <%  Timestamp tss=Env.getSystemDateTime(sessionMng.m_lOfficeID,sessionMng.m_lCurrencyID); %>
             ...
             <span class="graytext">&nbsp;&nbsp;&nbsp;&nbsp;至
           		...
           		<fs_c:calendar 
		          	    name="txtExecuteB"
			          	value="<%=request.getAttribute("txtExecuteB")!=null?rsForm.getStartExe():tss.toString().substring(0,10)%>" 
