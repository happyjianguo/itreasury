...
//    case (int)OBConstant.SettInstrType.BANKPAY_DOWNTRANSFER://资金划拨－下划
    ...
    case (int)OBConstant.SettInstrType.NOTIFYDEPOSITDRAW://7;通知支取
        ...
        break;
     case (int)OBConstant.SettInstrType.DRIVEFIXDEPOSIT://19;定期续存
        strFrom = "/capital/check/view/check_v011.jsp?src=1&checktype=1";
        break;
     case (int)OBConstant.SettInstrType.CHANGEFIXDEPOSIT://20;定期转存	
