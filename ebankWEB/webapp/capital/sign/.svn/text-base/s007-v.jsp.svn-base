...
<%
    Log.print("\n111*******进入页面--ebank/capital/sign/s007-v.jsp******\n");
    //标题变量
    String strTitle = "";
    try {
         /* 用户登录检测 */
	  ...
	  <tr>
	    <td height="22">
		    <table cellspacing="0" cellpadding="0" class=title_Top1>
				<TR>
			       <td class=title><span class="txt_til2">业务签认-活期</span></td>
...
<%
		...
		{		
			OBHtmlCom.showQueryTypeListControl2(out,"SelectType",(rsForm == null)?-1:
            rsForm.getTransType()," onfocus=\"nextfield ='txtConfirmA';\" colspan=\"4\"  ", true);
		}
%>
          </td>
