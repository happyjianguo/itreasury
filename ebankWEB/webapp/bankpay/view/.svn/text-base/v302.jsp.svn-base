...
<safety:resources />
   ...
   %>    
     ...
     %>   
      ...
      <%
      	...
      	System.out.println("liuyuekai刘悦恺刘悦恺=========="+info.getNstatus());
      	if(info.getNstatus()==OBConstant.OBBankPayStatus.AUDITING)
     	{
     %>   
     	<tr valign="middle">
          <td width="10%" align="left" class="ItemBody" height="25">
        ...
        <tr valign="middle">
         ...
         <tr valign="middle">
          ...
          <td bgcolor="#C8D7EC" class="ItemBody" width="30%" height="25">
            <div align="center"><%=NameRef.getUserNameByID(info.getNauditinguserid())%></div>
          </td>          
          <td bgcolor="#C8D7EC" class="ItemBody" width="30%" height="25">
          ...
          <td bgcolor="#C8D7EC" class="ItemBody" width="30%" height="25">
            <div align="center"><%= info.getDtauditing().toString().substring(0,10) %></div>
          </td>
        </tr>
     ...
     %>   
        ...
        if(info.getNauditinguserid()<0)
        {
         %>
          ...
          <td bgcolor="#C8D7EC" class="ItemBody" width="30%" height="25">
            <div align="center"><%=NameRef.getUserNameByIDForSett(info.getNsignuserid())%></div>
          </td>          
          <td bgcolor="#C8D7EC" class="ItemBody" width="30%" height="25">
 ...
 <br>
      ...
      <td width="730" align="right"> 
		...
		<%if(info.getNstatus()==OBConstant.OBBankPayStatus.SAVE && info.getNconfirmuserid()==sessionMng.m_lUserID)
   		 {	
   		%> 
   			<input class=button name=add type=button value=" 修  改 "  onClick="Javascript:updateme();" >
   			<input class=button name=add type=button value=" 删  除 "  onClick="Javascript:deleteme();" >
   		<%}%>	
        <!--
...
-->
		...
		<input class=button name=add type=button value=" 打  印 " onClick="Javascript:printme();" >
...
function PrintConsignVoucher()
{
	...
	function printme()
	{
		//frmzjhb.action="capital/captransfer/S00-Ipt.jsp";
		frmzjhb.action="../view/v307.jsp?id="+<%=id%>;
	...
	function updateme()
	{
		...
		frmzjhb.doact.value="querymodify";
	...
	function deleteme()
	{
		...
		//showMenu();
		frmzjhb.doact.value="querydelete";
