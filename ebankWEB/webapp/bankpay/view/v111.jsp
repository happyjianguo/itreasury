...
<table cellpadding="0" cellspacing="0" class="title_top">
	  <tr>
	    <td height="24">
		    <table cellspacing="0" cellpadding="0" class=title_Top1>
				<TR>
			       <td class=title><span class="txt_til2" style="width:130px">日期：<%=obCSI.getFormatConfirmDate().toString().substring(0,10)%></span></td>
      ...
      <table width="80%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="right">
			<input type="button" name="Submitv00204" value=" 打印 " class="button1" onClick="printMe();">&nbsp;&nbsp;

			<input type="button" name="Submitv00204" value=" 返回 " class="button1" onClick="returnMe();">&nbsp;&nbsp;
