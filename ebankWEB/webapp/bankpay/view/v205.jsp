   ...
   %>
    ...
    <td height="" class="MsoNormal" >
           ...
           <%
				...
				if(info.getNstatus()==OBConstant.OBBankPayStatus.AUDITING) out.print("这笔业务现为<b>已审核状态</b>,");	
				if(info.getNiscanaccept()!=1 ) out.print("需要审核后才能发送银行指令");
     ...
     <%}%>
        <tr class="MsoNormal">
          ...
          <td width="60" class="MsoNormal">
			...
			<input type="button" name="Submitv00204" value=" 关  闭 " class="button" onClick="javascript:doclose();"></div>
