...
%>
	<TABLE width="1000" border="0" cellspacing="0" cellpadding="0">
		<TR>
			<TD width="100%" align="center" colspan="8"><B><FONT style="font-size:22px">业务日志查询</FONT></B></TD>
		</TR>
	</TABLE>
...
<%
		...
		for( int i=0; resultInfos != null && i<resultInfos.length; i++ )
		{
			...
			<TABLE width="1000" border="0" cellspacing="4" cellpadding="0">
				<TR>
					<TD width="500" align="left">操作人：<%=sessionMng.m_strUserName%></TD>
					<TD  align="center">&nbsp;</TD>
					<TD  align="center">&nbsp;</TD>
					<TD  align="center">&nbsp;</TD>
					<TD  align="center">&nbsp;</TD>
					<TD  align="center">&nbsp;</TD>
					<TD  align="center">&nbsp;</TD>
					<TD width="500" align="right">打印时间：<%=Env.getSystemDateString(sessionMng.m_lOfficeID,sessionMng.m_lCurrencyID)%></TD>
				</TR>
			</TABLE>
