...
<%
    ...
    try
	{
        ...
        if(pageCtrl.getP_Action().equals("findFirst"))
		{
		   ...
		   //列表信息
		   pageLoader = biz.findBillByCondition_accountForEbank(paramInfo);		   
		}
