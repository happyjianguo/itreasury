...
<%	
    ...
    try {
        ...
        String strURL = "";
		//查询是否有未审批完成的业务
		vResult = (Vector)AppChangeBiz.findApprovalItemForChange(lApprovalID,sessionMng.m_lOfficeID,sessionMng.m_lCurrencyID,lUserID,lPageLineCount,lPageNo,lOrderParam,lDesc);
		if (vResult == null)
		{		
			//如果没有记录，则直接返回
		...
		else
		{
			...
			strURL = "../view/v004.jsp?control=view";
		}
