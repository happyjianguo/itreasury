    ...
    try
	{
		...
		OBQueryApprovalRecordBiz biz=new OBQueryApprovalRecordBiz();
			...
			if(transactionTypeID==OBConstant.SettInstrType.BUDGETNEW 
				...
				|| transactionTypeID==-1){
				pageLoader = biz.getHistoryListBudget(conditionworkInfo,lDesc,lOrderField);
			}
		...
		request.setAttribute("strSuccessPageURL","/approval/view/v034_budget.jsp");
		request.setAttribute("strFailPageURL","/approval/view/v034_budget.jsp");
