...
<TABLE border=0  height=18 width=774 align="center"  style="display:none">
	<TR>
    	...
    	<TD height=3 vAlign=top>
    			...
    			<thead>
        		 <TR>
          			...
          			<TD height=22 width="10%"><DIV align=center>开始日期</DIV></TD>
          			<TD height=22 width="10%"><DIV align=center>结束日期</DIV></TD>
...
%> 
				<TR>
					...
					<TD height=22 >
						<DIV align=center><%=workInfo.getBudgetStartDate()==null?"":DataFormat.getDateString(workInfo.getBudgetStartDate()) %></DIV>
					</TD>
					<TD  height=22 >
						<DIV align=center><%=workInfo.getBudgetEndDate()==null?"":DataFormat.getDateString(workInfo.getBudgetEndDate()) %></DIV>
					</TD>
					<TD  height=22 >
