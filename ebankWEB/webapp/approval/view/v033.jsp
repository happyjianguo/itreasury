...
{       //请求检测
		...
		Collection c_CurrentWork = workBiz.queryCurrentWork(qInfo);
%>
...
<form name="frmCurrent" method="post" action="<%=strContext%>/approval/view/v033.jsp">
	  ...
	  <tr>
	    <td height="24">
		    <table cellspacing="0" cellpadding="0" class=title_Top1>
				<TR>
			       <td class=title><span class="txt_til2">待办业务查询</span></td>
					...
					<TD width="2">&nbsp;</TD>
								...
								<TR>
									<TD colspan="6" align="right" height=25>
										<INPUT class="button1" name=toQuery type="button"
