...
<html>
	<head>
	<title><bean:message key="label.webmanage.currentstepList.title"/></title>
		...
		<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
			...
			--%>
				<td valign="top">
					...
					<html:form action="/currentStep">
					<input name="operate" type="hidden" value="selectCurrentStepList"/>
					<!-- <input name="entryid" type="hidden">
					<input name="actioncode" type="hidden">
					<input name="wfid" type="hidden">
					<input name="stepcode" type="hidden">-->
					...
					<table width="100%" border="0" cellspacing="3" cellpadding="2">
						<tr>
							<td colspan="22" height="22" bgcolor="#C4DAFA" style="font-size:12px; font-weight:bold; border-bottom:1px solid #fff;">　
								<bean:message key="label.webmanage.currentstepList.head"/>
							</td>
						</tr>
					</table>
					<table width="100%" border="0" cellspacing="3" cellpadding="2" class="tblist" id="DataTable">
					<tr class="thead">
					  <td align="center" bgcolor="#ECE9D8"><bean:message key="label.webmanage.common.condition.stepStartDate"/><bean:message key="label.webmanage.common.condition.startDate"/>				  
					...
					<tr class="thead">
					  ...
					  <td align="center" bgcolor="#ECE9D8"><bean:message key="label.webmanage.currentstepList.elementname"/></td>
					  <td align="center" bgcolor="#ECE9D8"><bean:message key="label.webmanage.currentstepList.workflowid"/></td>
					  <td align="center" bgcolor="#ECE9D8"><bean:message key="label.webmanage.currentstepList.workflowmodename"/></td>
					  <td align="center" bgcolor="#ECE9D8"><bean:message key="label.webmanage.currentstepList.caller"/></td>
					  <td align="center" bgcolor="#ECE9D8"><bean:message key="label.webmanage.currentstepList.createtime"/></td>
					  <td align="center" bgcolor="#ECE9D8"><bean:message key="label.webmanage.currentstepList.finishtime"/></td>
					  <td align="center" bgcolor="#ECE9D8"><bean:message key="label.webmanage.currentstepList.status"/></td>
					</tr>
					...
					<td align="center" bgcolor="#F8F8F8"><bean:write name="result" property="dueDate"format="yyyy-MM-dd HH:mm:ss"/></td>
