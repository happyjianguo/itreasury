...
%>
	...
	try
	{
		...
		if ( strAction.equals("save") )
		{
           ...
           PrintEbankApply printEbankApply = null;
			...
			for ( int i=0;i<seleAll.length;i++ )
			{
	            ...
	            printEbankApply.setNstatusid(VOUConstant.VoucherStatus.SAVE);
			    ...
			    printEbankApplyBiz.saveEbankPrint(printEbankApply);
		...
		//回到查询所有信息页面
		request.setAttribute("strSuccessPageURL",strContext + "/print/view/v012_P.jsp");
