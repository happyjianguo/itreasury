...
try {
	...
	*/
	...
	for (int i=0;i<itemNo.length;i++)
	{
		...
		strTmp = (String)request.getAttribute("hdValue0_"+itemNo[i]);
		originalAmout = Double.parseDouble(strTmp);
		...
		detailInfo.setBudgetAmount(amount + originalAmout);
		detailInfo.setOriginalAmount(originalAmout);
	...
	*/
	...
	if (pageInfo.getStrAction().equals(String.valueOf(Constant.Actions.CREATESAVE)))	//创建保存
	{
		...
		sessionMng.getActionMessages().addMessage("调整成功");
		pageInfo.success();
