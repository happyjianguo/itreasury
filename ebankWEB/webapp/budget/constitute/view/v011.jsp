...
<td >到：</td>
<td><input type="text" name="endDate" size="20" maxlength="30" class="box" onFocus="nextfield='remark';" readonly>&nbsp;</td>
</TR>
...
{
	showSending();//显示正在执行
	form_1.strSuccessPageURL.value="../view/v014.jsp";	//定义操作成功后跳往的页面
	form_1.strFailPageURL.value="../view/v011.jsp";		//定义失败后跳往的页面
...
function doNext()
{
	...
	{
		showSending();//显示正在执行
		form_1.strSuccessPageURL.value="../view/v012.jsp";	//定义操作成功后跳往的页面
		form_1.strFailPageURL.value="../view/v011.jsp";		//定义失败后跳往的页面
