...
try
{
	...
	%>
	<form name="frmV003" method="post" action="../control/c001.jsp">
               ...
               <TBODY>
                 <TR>
                   <TD colSpan='6' height="10"><DIV align=right>
					<input class="button" name="next" type="button" value=" 返 回 " onClick="javascript:location.href='../view/v001.jsp'">
                     </DIV>
                   </TD>
                 </TR>
               </TBODY>
...
function find(systemID,periodID,startDate,versionNo,planId,endDate){
	...
	frmV003.strSuccessPageURL.value="../view/v002.jsp";	//定义操作成功后跳往的页面
	frmV003.strFailPageURL.value="../view/v001.jsp";		//定义失败后跳往的页面
	frmV003.strAction.value="<%=Constant.Actions.LINKSEARCH%>";	//定义操作代码
	frmV003.submit();
}
</script>
<%	
