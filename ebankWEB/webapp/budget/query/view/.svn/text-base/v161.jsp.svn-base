...
<form name="form_1" method="post" action="../control/c161.jsp">
<!-- 定义页面控制参数 -->
...
try
{
	//请求检测
	/** 权限检查 **/
	String strTableTitle = "分析考核 - 银行滞留比例分析";
	...
	System.out.println("lOfficeID----(("+lOfficeID+"lCurrencyID----(("+lCurrencyID+"operatorId----(("+operatorId);
	/**
	* 定义业务变量
	*/
	%>
		<br>
	<TABLE width="100%" height="10" border=0 class=top><TBODY><TR><TD class=FormTitle height=2 width="100%"><B>		分析考核 - 银行滞留比例分析</B></TD></TR><TR>
...
<%
		...
		String SecondTDPCS = "";
		String[] sNextControlsPCS = {"itemIDCtrl"};
...
<input type="text" name="lClientIDCtrl2" class="box" maxlength='30' disabled value="<%=BUDGETNameRef.getClientNameByID(clientId)%>"></TD>

</tr><tr><td>
<%
		String strFormNamePCS4 = "form_1";
		String strCtrlNamePCS4 = "itemID";
		String strTitlePCS4 = "<font color=#CC0000>*</font> 预算项目";
		long lItemID=-1;
		String strItemNo="";
		String strClientCtrl1="";
		long lSystemID=-1;
		String strBudgetSystemCtrl="budgetSystemID";
		long lIsLeaf=-1;
		String strBudgetItemCtrl="";
		String strFirstTDPCS4 = "";
		String SecondTDPCS4 = "";
		String[] sNextControlsPCS4 = {"budgetPeriodIDCtrl"};
		String strRtnAmountIDCtrl="budgetAmount";
		String strRtnSystemIDCtrl="budgetSystemID";
		String strRtnSystemNoCtrl="budgetSystemIDCtrl";
		String strRtnItemIDCtrl="itemID";
		String strRtnItemNameCtrl="itemName";
		BUDGETMagnifier.createTempletBudgetItemCtrl(
			out,
			lOfficeID,
			lCurrencyID,
			strFormNamePCS4,
			...
			SecondTDPCS4,
			sNextControlsPCS4,
			strRtnSystemIDCtrl,strRtnSystemNoCtrl,
			strRtnItemIDCtrl,strRtnItemNameCtrl
		);
	%>
	</td><td>
<%
...
function doQuery()
{
		...
		if( beginDT.length != 0 && endDT.length != 0 &&  beginDT > endDT)
	{
		...
		showSending();//显示正在执行
		document.form_1.strSuccessPageURL.value="../view/v162.jsp";	//定义操作成功后跳往的页面
		document.form_1.strFailPageURL.value="../view/v162.jsp";		//定义失败后跳往的页面
...
function allFields()
{
		...
		this.a10 = new Array("itemID"," 预算项目","magnifier",1);
		this.a2 = new Array("budgetPeriodID"," 预算周期","magnifier",1);
		this.a3 = new Array("startDate"," 预算区间－从","date",1);
		//this.a4 = new Array("endDate"," 预算区间－到","date",1);
		this.a5 = new Array("startDate"," 预算区间－从","date",0);
		//this.a6 = new Array("endDate"," 预算区间－到","date",0);
}
function getEndDate()
{
