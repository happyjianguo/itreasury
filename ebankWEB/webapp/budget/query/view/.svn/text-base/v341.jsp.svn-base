...
<form name="form_1" method="post" action="../control/c341.jsp">
<!-- 定义页面控制参数 -->
...
try
{
	//请求检测
	/** 权限检查 **/
	String strTableTitle = "分析考核 - 预算单位对比分析";
	...
	/** 显示文件头 **/
	OBHtml.showOBHomeHead(out,sessionMng,"[预算单位对比分析]",Constant.YesOrNo.YES);
	...
	*/
	...
	<TABLE width="80%" height="10" border=0 class=top><TBODY><TR><TD class=FormTitle height=2 width="100%"><B>		分析考核 - 预算单位对比分析</B></TD></TR><TR>
...
<%
		...
		String SecondTDPCS2 = "";
		String[] sNextControlsPCS2 = {"clientIDCtrl"};
...
<%
		String strFormNamePCS1 = "form_1";
		String strCtrlNamePCS1 = "clientID";
		String strTitlePCS1 = "<font color=#CC0000>*</font> 预算单位A";
		long lClientIDPCS1 = -1;
		String strClientNoPCS1 = "";
		String strFirstTDPCS1 = "";
		String SecondTDPCS1 = "";
		String[] sNextControlsPCS1 = {"clientBIDCtrl"};
		String strRtnClientNameCtrlPCS1 = "";
		
	BUDGETMagnifier.createSubClientCtrl(
		out,
		lOfficeID,
		lCurrencyID,
		strFormNamePCS1,
		...
		SecondTDPCS1,
		sNextControlsPCS1,
		strRtnClientNameCtrlPCS1);
 %>
</TD><td>
<%
		String strFormNamePCS5 = "form_1";
		String strCtrlNamePCS5 = "clientBID";
		String strTitlePCS5 = "<font color=#CC0000>*</font> 预算单位B";
		long lClientIDPCS5 = -1;
		String strClientNoPCS5 = "";
		String strFirstTDPCS5 = "";
		String SecondTDPCS5 = "";
		String[] sNextControlsPCS5 = {"startDate"};
		String strRtnClientNameCtrlPCS5 = "";
...
<A href="javascript:show_calendar('form_1.startDate');" onMouseOut="window.status='';return true;"onMouseOver="window.status='Date Picker';return true;"><IMG border="0" height="16"src="/websett/image/calendar.gif" width="17"></A>
 --></td>
<td >到：</td>
<td><input type="text" name="endDate" size="20" maxlength="30" class="box" onFocus="nextfield='submitfunction';" readonly></td>
</TR>
...
function doQuery()
{
		...
		showSending();//显示正在执行
		document.form_1.strSuccessPageURL.value="../view/v342.jsp";	//定义操作成功后跳往的页面
		document.form_1.strFailPageURL.value="../view/v342.jsp";		//定义失败后跳往的页面
...
function allFields()
{
		...
		this.a1 = new Array("clientID"," 预算单位A","magnifier",1);
		this.a2 = new Array("clientBID"," 预算单位B","magnifier",1);
		this.a3 = new Array("budgetPeriodID"," 预算周期","magnifier",1);
		this.a4 = new Array("startDate"," 预算区间－从","date",1);
		//this.a5 = new Array("endDate"," 预算区间－到","date",1);
		this.a6 = new Array("startDate"," 预算区间－从","date",0);
		//this.a7 = new Array("endDate"," 预算区间－到","date",0);
