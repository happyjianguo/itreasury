...
<form name="form_1" method="post" action="../control/c002.jsp">
<!-- 定义页面控制参数 -->
...
try
{
	...
	*/
	%>
	<br>
	<TABLE width="100%" height="10" border=0 class=top><TBODY><TR><TD class=FormTitle height=2 width="100%"><B>		分析考核 - 预算项目单位情况查询</B></TD></TR><TR>
