...
<form name="form_1" method="post" action="../control/c011.jsp">
...
try
{
	//请求检测
	/** 权限检查 **/
	String strTableTitle = "分析考核 - 预算结构分析";
	...
	*/
	...
	<TABLE width="100%" height="10" border=0 class=top><TBODY><TR><TD class=FormTitle height=2 width="100%"><B>		分析考核 - 预算结构分析</B></TD></TR><TR>
...
<td >到：</td>
<td><input type="text" name="endDate" size="20" maxlength="30" class="box" readonly></td>
</TR>
...
function doQuery()
{
		...
		showSending();//显示正在执行
		document.form_1.strSuccessPageURL.value="../view/v012.jsp";	//定义操作成功后跳往的页面
		document.form_1.strFailPageURL.value="../view/v011.jsp";		//定义失败后跳往的页面
