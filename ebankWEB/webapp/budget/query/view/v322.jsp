...
try
{
	...
	*/
	...
	vTemplate = (Vector)request.getAttribute("excuteColl");
	...
	<TABLE width="95%" height="10" border=0 class=top>
       <TBODY>
         <TR>
           <TD class=FormTitle height=2 width="100%"><input type="hidden" name="hdnLevelCount" value="<%=lLevelCount%>"><B>		分析考核 - 预算执行情况分析</B></TD>
         </TR>
         <TR>
           <TR>
...
%>
         ...
         <TD width="100%" vAlign=bottom>           <TABLE align=center border=0 width="100%">
             <TBODY>
               <TR>
                   <td><DIV align=right><input name="Submit32" type="button" class="button" onClick="location.href='../view/v321.jsp';" value=" 返 回 ">&nbsp;&nbsp;</DIV></td>
               </TR>
             </TBODY>
           </TABLE></TD>
         </TR>
