...
<form name="form_1" method="post" action="../control/c321.jsp">
<!-- 定义页面控制参数 -->
...
try
{
	//请求检测
	/** 权限检查 **/
	String strTableTitle = "分析考核 - 预算执行情况分析";
	...
	*/
	...
	<TABLE width="80%" height="10" border=0 class=top><TBODY><TR><TD class=FormTitle height=2 width="100%"><B>		分析考核 - 预算执行情况分析</B></TD></TR><TR>
...
<TD width="30%" height=23><input type=hidden name=clientID value=<%=clientId%>><input type="text" name="lClientIDCtrl2" class="box" maxlength='30' disabled value="<%=BUDGETNameRef.getClientNameByID(clientId)%>"></TD>
