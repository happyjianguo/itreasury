...
try
{
	//请求检测
	/** 权限检查 **/
	String strTableTitle = "系统设置 - 预算单位对比分析";
	...
	*/
	...
	vTemplate = (Vector)request.getAttribute("diffClientColl");
	...
	<TABLE width="95%" height="10" border=0 class=top>
       <TBODY>
         <TR>
           <TD class=FormTitle height=2 width="100%"><B>		分析考核 - 预算单位对比分析</B></TD>
         </TR>
         <TR>
           <TR>
...
%>
         ...
         <TD width="100%" vAlign=bottom>           <TABLE align=center border=0 width="100%">
             <TBODY>
               <TR>
                   <td><DIV align=right><input name="Submit32" type="button" class="button" onClick="location.href='../view/v341.jsp';" value=" 返 回 ">&nbsp;&nbsp;</DIV></td>
               </TR>
             </TBODY>
           </TABLE></TD>
         </TR>
