<%--
/*
 *程序名称：S858-Opt-Fix.jsp
 *功能说明：签认金额设置提交完成页面（新奥--定期）
 *作    者: 周翔
 *完成日期: 2011年4月15日
 */
--%>
...
<form name="form1" action="<%=strContext%>/system/S844-Ctr-Fix.jsp" method="post">
	  ...
	  <tr>
	    <td height="22">
		    <table cellspacing="0" cellpadding="0" class=title_Top1>
				<TR>
			       <td class=title><span class="txt_til2">定期签认金额设置</span></td>
