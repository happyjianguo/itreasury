...
<tr>
	<td width="3"><a class=lab_title1></td>
	<td style="width:150px"class="lab_title2">账号权限管理</td>
	<td width="17"><a class=lab_title3></td>
</tr>
</table>
		...
		<%
			...
			Iterator it = null;
				...
				if (cAccountOfSA != null) {
					...
					out.println("<td class='ItemBody' align='center'>账号</td>");
					out.println("<td class='ItemBody' align='center'>操作权限");
					out.println("<INPUT name='checkalloperate'  type='checkbox' value='checkboxoperate' class='ItemBody' onclick='SelectAllOperate()'>");
					out.println("</td>");
					out.println("<td class='ItemBody' align='center'>查看权限");
	...
	<table width="80%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td width="3"><a class=lab_title1></td>
			<td class="lab_title2" style="width:200px;">银行账号权限管理</td>
...
<tr>
	<td width="3"><a class=lab_title1></td>
	<td style="width:150px"class="lab_title2"> 用户组</td>
	<td width="17"><a class=lab_title3></td>
</tr>
</table>
	<table width=80% border="0" cellspacing="0" cellpadding="0"
