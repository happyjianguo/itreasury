<%--
/*
 * 程序名称：S845-Ctr-Curr.jsp
 * 功能说明：签认金额设置提交控制页面（新奥--活期）
 * 作　　者：周翔
 * 完成日期：2011年4月15日
 */
--%>
...
<%
		...
		/* 调用EJB方法提交信息 */
		lAddResult = obSystem.addSignAmountForCurr(signAmountInfo);
...
<%
		if (lAddResult >=  0)
		{
			...
			pageControllerInfo.setUrl(strContext + "/system/S858-Opt-Curr.jsp");
			//分发
