...
<input type="text" class="box" name="txtIsCPF" style="display:none" value="true">
</form>
...
<table width="774" border="0" align="center" cellpadding="0" cellspacing="0" class="">
  ...
  <tr>
    <td height="10"></td>
            ...
            <table width="774" border="0" align="center" cellpadding="0" cellspacing="0" class=normal id="table1">
              ...
              <tr>
                <td  height="25" width="1"></td>
                <td height="25" width="5" ></td>
                <td height="25" width="128" class="graytext" >收款方银行账号：</td>
                <td height="25" class="graytext" >
                  <%if (rf.getPayeeBankNO()!=null) out.print(rf.getPayeeBankNO()); %>
                </td>
                <td  height="25" width="1"></td>
              </tr>
              <tr>
    ...
    <td height="25" class="graytext" ><%=Env.getClientName()%></td>
                <td  height="25" width="1"></td>
              </tr>
              <tr>
                <td  height="1" colspan="5"></td>
