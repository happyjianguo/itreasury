		...
		<%
			...
			Iterator it = null;
				...
				if (cAccountOfSA != null) {
					...
					out.println("<td class='ItemBody' align='center' width='40%'>账号</td>");
					out.println("<td class='ItemBody' align='center' width='30%'>操作权限");
					out.println("<INPUT name='checkalloperate'  type='checkbox' value='checkboxoperate' class='ItemBody' onclick='SelectAllOperate()'>");
					out.println("</td>");
					out.println("<td class='ItemBody' align='center' width='30%'>查看权限");
