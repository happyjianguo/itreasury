...
<%@page import="java.util.Collection,
				...
				com.iss.itreasury.ebank.obsystem.dao.OB_AcctPrvgByClientDao,
...
<%	
	...
	int num=0;
	String strNextPageURL="../control/c001.jsp";
	Collection con;
	...
	//删除原先的记录
	OBAcctPrvgBiz bz=new OBAcctPrvgBiz();
	OB_AcctPrvgByClientDao obABCD=new OB_AcctPrvgByClientDao();
