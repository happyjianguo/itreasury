...
<form name="form1" method="post" action="../control/c002.jsp">    
	  ...
	  <tr>
	    ...
	    <br>
		    <table cellspacing="0" cellpadding="0" class=title_Top1 width="98%" align="center" >
				<TR>
			       <td class=title><span class="txt_til2">账户授权</span></td>
			       <td class=title_right><a class=img_title></td>
				</TR>
			</TABLE>
 <br/>
    	<table width="98%" border=0 align="center" cellspacing="0" class=normal>
