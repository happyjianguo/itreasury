<%--
/*
 * 程序名称：S844-Ctr-Fix.jsp
 * 功能说明：签认金额设置查找控制页面（新奥--定期）
 * 作　　者：周翔
 * 完成日期：2011年4月15日
 */
--%>
...
<%
		...
		/* 调用方法获取查询信息 */
		signAmountInfo = obSystemDao.querySignAmountForFix(lClientID, lCurrencyID);
...
<%
		...
		pageControllerInfo.setUrl(strContext + "/system/S843-Ipt-Fix.jsp");
		//分发
