...
public class JasperPrintServletForEbank extends HttpServlet {
	...
	private Logger logger = Logger.getLogger(JasperPrintServletForEbank.class);
	 ...
	 */
	public JasperPrintServletForEbank() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) 
		...
		{
			sessionMng = (SessionOB)request.getSession().getAttribute("sessionMng");
		}
