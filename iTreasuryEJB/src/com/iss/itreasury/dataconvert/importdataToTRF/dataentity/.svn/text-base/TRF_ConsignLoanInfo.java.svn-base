 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class TRF_ConsignLoanInfo {
	...
	//委托方收息账户
	private String receiveInterestAccountCode="";
	//委托方存款账户
	private String consignAccountCode="";
	//累计应收利息
    ...
    public String getConsignAccountCode() {
        return consignAccountCode;
    }
    public void setConsignAccountCode(String consignAccountCode) {
        this.consignAccountCode = consignAccountCode;
    }
    ...
    public String getReceiveInterestAccountCode() {
        return receiveInterestAccountCode;
    }
    public void setReceiveInterestAccountCode(String receiveInterestAccountCode) {
        this.receiveInterestAccountCode = receiveInterestAccountCode;
    }
