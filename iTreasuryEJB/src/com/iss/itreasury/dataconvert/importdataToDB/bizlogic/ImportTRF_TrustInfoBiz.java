 ...
 */
public class ImportTRF_TrustInfoBiz extends AbstractImportBiz {
    ...
    private double calcInterest(TRF_TrustLoanInfo trustInfo,
            Loan_PayFormInfo payInfo) {
        return (trustInfo.getStandBalance1() - delayDays
                * trustInfo.getMBalance())
                * payInfo.getMInterestRate() / 100 / 360;
    }

    private Sett_AccountInfo parseSett_Account(TRF_TrustLoanInfo info) {
    ...
    private Sett_SubAccountInfo parseSett_SubAccount(TRF_TrustLoanInfo info,
        ...
        result.setAl_NReceiveInterestAccountId(NameRef
                .getAccountIdByAccountCode(info.getReceiveSuretyAccountCode()));
    ...
    public void importData() {
        Collection c = this.readDataFromTRF("TRF_TrustLoan",
                TRF_TrustLoanInfo.class);
        ...
        try {
            ...
            for (Iterator i = c.iterator(); i.hasNext();) {
                ...
                TRF_TrustLoanInfo trustInfo = (TRF_TrustLoanInfo) i.next();
