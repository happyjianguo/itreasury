...
public class ConvertDataUtil
{
	...
	public static long convertU850Subject(String strType)
	{
		long lTypeID = -1;
		if (strType != null)
		{
	...
	public static String convertVoucherIDToU850(String transNo)
	{
		String result = null;
		if (transNo != null)
		{
	...
	public static String convertVoucherIDFromU850(String transNo, String id)
	{
		String result = null;
