...
public class DiscountContractBillInfo extends BillDataEntity {
...
private long nSellStatusId = -1;//是否可卖出
...
public void setSellStatusId(long nSellStatusId) {
	this.nSellStatusId = nSellStatusId;
	putUsedField("nSellStatusId", nSellStatusId);
}
}