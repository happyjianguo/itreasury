 ...
 */
package com.iss.itreasury.treasuryplan.etl.transform.dataentity;
 ...
 */
public class TPTemplateItemInfo extends TreasuryPlanBaseDataEntity {
	private	String code = null;	//	Name
	private	long id	= -1;//	主键
	private	long lineID	= -1;//	计划行项目ID
	...
	private	long amountDirection = -1;	//	数据增减方向
	private	String parameter = null;	//	自定义参数
	private	long amountFlag = -1;	//	金额标志
