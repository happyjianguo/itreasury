 ...
 */
package com.iss.itreasury.managerquery.report.dataentity;
...
public class ReportCondition implements Serializable
{
	...
	public long getRptNameID() {
		return rptNameID;
	}
	public void setRptNameID(long rptNameID) {
		this.rptNameID = rptNameID;
	}
