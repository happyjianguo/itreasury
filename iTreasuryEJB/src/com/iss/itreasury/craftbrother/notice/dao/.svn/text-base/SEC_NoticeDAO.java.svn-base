package com.iss.itreasury.craftbrother.notice.dao;
...
//																																		
	...
	*/
	 ...
	 * (和交割单关联)
	 */
	public Collection findByMultiOption3(NoticeQueryInfo qInfo,long userID,long CurrencyID,long ActionID,long officeID) throws SecuritiesDAOException
	{
		String sql="";
	...
	public Collection findByMultiOption1(NoticeQueryInfo qInfo) throws SecuritiesDAOException
	{
		...
		try {
			...
			while (rs1 != null && rs1.next()) 
			{
				...
				noticeInfo.setCounterpartName(NameRef.getCounterpartNameByID(rs1.getLong("counterpartId")));	//交易对象
