package com.iss.itreasury.system.pwconfig.dataentity;
...
public class PasswordInfo extends ITreasuryBaseDataEntity{
	...
	private long termDate;					//密码到期日期
	private long remindDate;				//密码提醒日期
	private long forcePerfect;				//是否强制修改密码
