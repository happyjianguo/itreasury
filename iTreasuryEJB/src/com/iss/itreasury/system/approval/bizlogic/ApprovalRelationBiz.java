...
public class ApprovalRelationBiz implements java.io.Serializable
{
    ...
    public long findRelationID(ApprovalRelationInfo qInfo) throws LoanException
    {
    	long lApprovalID = -1;
        ApprovalRelationDao dao = new ApprovalRelationDao();
        ...
        try
        {
        	lApprovalID = dao.findRelationInfo(qInfo);
        } catch (Exception e)
        {
            throw new LoanException("Gen_E001", e);
        }
     ...
     * 删除操作
     */
    public long deleteSec(ApprovalRelationInfo info) throws LoanException
    {
        long lReturn = -1;
        ApprovalRelationDao dao = new ApprovalRelationDao();
    ...
    /**
     * 查找贷款子类型下已设置审批流的操作类型(东方电器)
     */
    public Collection findMultiOption(ApprovalRelationInfo qInfo) throws LoanException
    {
        ApprovalRelationDao dao = new ApprovalRelationDao();
        Collection c = null;
        try
        {
            c = dao.findMultiOption(qInfo);
        } catch (Exception e)
        {
            throw new LoanException("Gen_E001", e);
        }
