...
public class SetDataEntityJN implements Serializable
{
	...
	public PrintInfo getFixDepositWithDrawPrintInfo(long lID) throws Exception
	{
		...
		try
		{
			...
			if (resultInfo != null)
			{
				...
				//2008年12月23日 下列代码导致京能打印通知支取利息单错误
				//---------------------------------------------
				//实付利息,利息支付
	...
	public PrintInfo getFixDepositContinuePrintInfo(long lID) throws Exception
	{
		...
		try
		{
			...
			if (resultInfo != null)
			{
				...
				//2008年12月25日 利息直接取"本次支取利息(mwithdrawinterest)"
				else
				{
					printInfo.setPayableInterest(resultInfo.getWithDrawInterest());
				}
	...
	public HashMap TransformOperationData(PrintInfo printOperationInfo) throws Exception
	{
		...
		else
		{
			...
			else if( printOperationInfo.getPayBankID() > 0 && printOperationInfo.getTransTypeID() != SETTConstant.TransactionType.BANKRECEIVE )
			{
				...
				//2008年12月25日 委托存款付款方走开户行打印付款方名称取付款方客户名称
				if( printOperationInfo.getTransTypeID() == SETTConstant.TransactionType.CONSIGNSAVE )
				{
					usedFields.put("PayAccountName", DataFormat.formatString(NameRef.getClientNameByID(printOperationInfo.getPayClientID())));
				}
				else
				{
			 ...
			 || printOperationInfo.getTransTypeID() == SETTConstant.TransactionType.NOTIFYDEPOSITDRAW )
			{
				...
				if(printOperationInfo.getAccountAmount() > printOperationInfo.getDrawAmount() && printOperationInfo.getInterestStartDate().compareTo(printOperationInfo.getEndDate()) < 0)
		        {
	                ...
	                if(transFixedOpenInfo.getStartDate() != null)
	                {
				...
				if(printOperationInfo.getAccountAmount() > printOperationInfo.getDrawAmount() && printOperationInfo.getTransTypeID() == SETTConstant.TransactionType.NOTIFYDEPOSITDRAW)
				{
	                ...
	                {
	                    String strAbstract = "起息日：" + DataFormat.getChineseDateString(printOperationInfo.getStartDate());
	                    if(printOperationInfo.getAbstract() != null && !printOperationInfo.getAbstract().equals(""))
	                    {
	                        strAbstract = strAbstract + "；";
	        ...
	        if(printOperationInfo.getTransTypeID() == SETTConstant.TransactionType.OPENMARGIN)
	        {
	            ...
	            {
		            usedFields.put("CommissionFee", DataFormat.formatListAmount(printOperationInfo.getCommissionAmount(), 2));
		            ...
		            usedFields.put("ChineseCommissionFee", strChineseAmount);
	            }
	        }
					...
					|| printOperationInfo.getTransTypeID() == SETTConstant.TransactionType.INTERESTFEEPAYMENT )
			{
				...
				if(printOperationInfo.getLoanNoteID() > 0)
				{
					...
					if (printOperationInfo.getRealInterest() > 0)
					{
						...
						//正常利息本金
						usedFields.put("NormalInterestAmount", DataFormat.formatListAmount( printOperationInfo.getAmount(), 2 ) );
						
						//正常利率
						usedFields.put("NormalInterestRate", DataFormat.formatRate(lpfdinfo.getInterestRate(), 6));
						
						//正常利息
						usedFields.put("NormalInterest", DataFormat.formatListAmount( printOperationInfo.getRealInterest(), 2 ) );
					...
					if (printOperationInfo.getRealCompoundInterest() > 0)
					{
						...
						usedFields.put("CompoundInterestAmount", DataFormat.formatListAmount(printOperationInfo.getCompoundAmount(), 2) );
						...
						usedFields.put("CompoundInterest", DataFormat.formatListAmount( printOperationInfo.getRealCompoundInterest(), 2 ));	
					}
					...
					if (printOperationInfo.getRealOverDueInterest() > 0)
					{
						...
						//逾期罚息本金
						usedFields.put("OverInterestAmount",  DataFormat.formatListAmount(printOperationInfo.getOverDueAmount(), 2) );
						if (printOperationInfo.getOverDueAmount() == 0.00)
						{
							usedFields.put("OverInterestAmount",  "0.00");
						}
						...
						usedFields.put("OverInterest", DataFormat.formatListAmount(printOperationInfo.getRealOverDueInterest(), 2) );
					}
					...
					if (printOperationInfo.getRealSuretyFee() > 0)
					{
						...
						usedFields.put("AssureFeeAmount", DataFormat.formatListAmount(printOperationInfo.getSuretyFeeAmount(), 2) );
						if (printOperationInfo.getSuretyFeeAmount() == 0.0)
						{
							usedFields.put("AssureFeeAmount", "0.00" );
						}
						...
						usedFields.put("AssureFee", DataFormat.formatListAmount(printOperationInfo.getRealSuretyFee(), 2) );
					}
					...
					if (printOperationInfo.getRealCommission() > 0)
					{
						...
						usedFields.put("CommissionFeeAmount", DataFormat.formatListAmount( lpfdinfo.getAmount(), 2 ) );
						...
						{
							usedFields.put("CommissionFee", DataFormat.formatListAmount(printOperationInfo.getRealCommission(), 2) );
					...
					{
						usedFields.put("InterestTax", DataFormat.formatListAmount(printOperationInfo.getRealInterestTax(), 2) );
						usedFields.put("ChineseInterestTax", ChineseCurrency.showChinese(printOperationInfo.getRealInterestTax()+"", printOperationInfo.getCurrencyID()));
					}
					...
					if (remitInterest > 0)
					{
						usedFields.put("RemitInterest", DataFormat.formatListAmount( remitInterest ,2 ) );
					}
					...
					if (transferAmount > 0)
					{
						usedFields.put("TransferAmount", DataFormat.formatListAmount( transferAmount ,2 ) );
					}
					...
					{
						//利息合计小写
						usedFields.put("NoticeOpenTotalInterest",
															DataFormat.formatListAmount(
															DataFormat.formatDouble(printOperationInfo.getRealInterest()) + 
															DataFormat.formatDouble(printOperationInfo.getRealCompoundInterest()) + 
															DataFormat.formatDouble(printOperationInfo.getRealOverDueInterest()), 2 ) );
					 ...
					 || printOperationInfo.getTransTypeID() == SETTConstant.TransactionType.CONSIGNLOANRECEIVE)
					{
						...
						if(printOperationInfo.getInterest1()>0)
						{
							if(printOperationInfo.getRate1()!=0)
							{
								...
								usedFields.put("LoanAmass1", DataFormat.formatListAmount( Double.parseDouble(LoanAmass1), 2 ));  //贷款积数1
							}
							
							String Interest11 = DataFormat.formatAmount(printOperationInfo.getInterest1());			
							usedFields.put("Interest11", DataFormat.formatListAmount( Double.parseDouble(Interest11), 2 ));  //利息1					
						}
						if(printOperationInfo.getInterest2()>0)
						{
							if(printOperationInfo.getRate2()!=0)
							{
								...
								usedFields.put("LoanAmass2", DataFormat.formatListAmount( Double.parseDouble(LoanAmass2), 2 ));  //贷款积数2
							}						
							String Interest12 = DataFormat.formatAmount(printOperationInfo.getInterest2());
					
							usedFields.put("Interest12", DataFormat.formatListAmount( Double.parseDouble(Interest12), 2 ));  //利息2					
						}
						if(printOperationInfo.getInterest3()>0)
						{
							if(printOperationInfo.getRate3()!=0)
							{
								...
								usedFields.put("LoanAmass3", DataFormat.formatListAmount( Double.parseDouble(LoanAmass3), 2 ));  //贷款积数3
							}
							
							String Interest13 = DataFormat.formatAmount(printOperationInfo.getInterest3());
							
							usedFields.put("Interest13", DataFormat.formatListAmount( Double.parseDouble(Interest13), 2 ));  //利息3					
						}
						 ...
						 || printOperationInfo.getTransTypeID() == SETTConstant.TransactionType.CONSIGNLOANRECEIVE)
						{
				            ...
				            //利息合计小写 
							usedFields.put("NoticeOpenTotalInterest", this.getFormatAmount( printOperationInfo.getInterest1()+printOperationInfo.getInterest2()+printOperationInfo.getInterest3() ));
						}
					}
				}
			}
			...
			if ( printOperationInfo.getTransTypeID() == SETTConstant.TransactionType.INTERESTFEEPAYMENT )
			{
				...
				if (printOperationInfo.getRealInterest() > 0)
				{
		            ...
		            //利息合计小写 
					usedFields.put("NoticeOpenTotalInterest", this.getFormatAmount( printOperationInfo.getRealInterest() ));
					...
					if(printOperationInfo.getInterest1()>0)
					{
						usedFields.put("LoanAmass1", DataFormat.formatListAmount( printOperationInfo.getSumBlanceAmount1(), 2 ));  //贷款积数1
					...
					if(printOperationInfo.getInterest2()>0)
					{
						usedFields.put("LoanAmass2", DataFormat.formatListAmount( printOperationInfo.getSumBlanceAmount2(), 2 ));  //贷款积数2					}
					...
					if(printOperationInfo.getInterest3()>0)
					{
						usedFields.put("LoanAmass3", DataFormat.formatListAmount( printOperationInfo.getSumBlanceAmount3(), 2 ));  //贷款积数3
			  ...
			  || printOperationInfo.getTransTypeID() == SETTConstant.TransactionType.YT_LOAN_PREDRAW_INTEREST)
			{
				...
				if(printOperationInfo.getRate()!=0)
				{
					...
					usedFields.put("LoanAmass4", DataFormat.formatListAmount( Double.parseDouble(LoanAmass4), 2 ));  //协定积数
				}
					...
					totalInterest = (
							DataFormat.formatAmount(
									DataFormat.formatDouble(
											...
											//2008年12月25日不加,查询赋值时就已经在TransFixedDrawInfo累加
											printOperationInfo.getPayableInterest()
											)));
			...
			{
				usedFields.put("Amount1", DataFormat.formatListAmount( Double.parseDouble(Amount1), 2 ));  //本金1
			}
			if (Amount2 != null && !Amount2.equals(""))
			{
				usedFields.put("Amount2", DataFormat.formatListAmount( Double.parseDouble(Amount2), 2 ));  //本金2
			}
			if (Amount3 != null && !Amount3.equals(""))
			{
				usedFields.put("Amount3", DataFormat.formatListAmount( Double.parseDouble(Amount3), 2 ));  //本金3
			}
			if (Amount4 != null && !Amount4.equals(""))
			{
				usedFields.put("Amount4", DataFormat.formatListAmount( Double.parseDouble(Amount4), 2 ));  //本金4
			}
			
			if (Interest1 != null && !Interest1.equals(""))
			{
				usedFields.put("Interest1", DataFormat.formatListAmount( Double.parseDouble(Interest1), 2 ));  //利息1
			}
			if (Interest2 != null && !Interest2.equals(""))
			{
				usedFields.put("Interest2", DataFormat.formatListAmount( Double.parseDouble(Interest2), 2 ));  //利息2
			}
			if (Interest3 != null && !Interest3.equals(""))
			{
				usedFields.put("Interest3", DataFormat.formatListAmount( Double.parseDouble(Interest3), 2 ));  //利息3
			}
			if (Interest4 != null && !Interest4.equals(""))
			{
				usedFields.put("Interest4", DataFormat.formatListAmount( Double.parseDouble(Interest4), 2 ));  //利息4
			}
			if (Interest5 != null && !Interest5.equals(""))
			{
				usedFields.put("Interest5", DataFormat.formatListAmount( Double.parseDouble(Interest5), 2 ));  //利息5
			}
			if (NegotiateInterest1 != null && !NegotiateInterest1.equals(""))
			{
				usedFields.put("NegotiateInterest1", DataFormat.formatListAmount( Double.parseDouble(NegotiateInterest1), 2 ));  //协定利息1
			}
			if (NegotiateInterest2 != null && !NegotiateInterest2.equals(""))
			{
				usedFields.put("NegotiateInterest2", DataFormat.formatListAmount( Double.parseDouble(NegotiateInterest2), 2 ));  //协定利息2
			}
			...
			{
				usedFields.put("CurrentAmass", DataFormat.formatListAmount( Double.parseDouble(CurrentAmass), 2 ));  //活期积数
			}
			//modify by xwhe 2008-08-21
			if (CurrentAmass1 != null && !CurrentAmass1.equals(""))
			{
				usedFields.put("CurrentAmass1", DataFormat.formatListAmount( Double.parseDouble(CurrentAmass1), 2 ));  //活期积数1
			}
			if (CurrentAmass2 != null && !CurrentAmass2.equals(""))
			{
				usedFields.put("CurrentAmass2", DataFormat.formatListAmount( Double.parseDouble(CurrentAmass2), 2 ));  //活期积数2
			}
			if (CurrentAmass3 != null && !CurrentAmass3.equals(""))
			{
				usedFields.put("CurrentAmass3", DataFormat.formatListAmount( Double.parseDouble(CurrentAmass3), 2 ));  //活期积数3
			}
			
			if (AccordAmass != null && !AccordAmass.equals(""))
			{
				usedFields.put("AccordAmass", DataFormat.formatListAmount( Double.parseDouble(AccordAmass), 2 ));  //协定积数
			...
			{
				usedFields.put("AccordAmass1", DataFormat.formatListAmount( Double.parseDouble(AccordAmass1), 2 ));  //协定积数1
				usedFields.put("CurrentAmassType", "正常");
				usedFields.put("AccordAmassType", "协定");
			}
	       //add by xwhe 2008-08-26
			...
			{
				usedFields.put("AccordAmass2", DataFormat.formatListAmount( Double.parseDouble(AccordAmass2), 2 ));  //协定积数1
				usedFields.put("CurrentAmassType", "正常");
				usedFields.put("AccordAmassType", "协定");
			}
			
			if(totalInterest != null && !totalInterest.equals("") && printOperationInfo.getIsCapitalAndInterestTransfer() == 1)
			{
				//本息合计小写
				usedFields.put("AmountANDInterest", DataFormat.formatListAmount(DataFormat.formatDouble(Double.parseDouble(totalInterest) + printOperationInfo.getAmount()), 2) );
			
				//本息合计大写
				usedFields.put("ChineseAmountANDInterest", ChineseCurrency.showChinese(DataFormat.formatAmount(DataFormat.formatDouble(Double.parseDouble(totalInterest) + printOperationInfo.getAmount())), printOperationInfo.getCurrencyID()) );
			}
			else
			{
				//本息合计小写
			...
			{
				usedFields.put("InterestTotalInterest", DataFormat.formatListAmount( Double.parseDouble(totalInterest), 2) );
			}
