...
import com.iss.itreasury.integratedCredit.bizlogic.CustomerfeedbackBean;
...
public class IntegratedCreditPrintDao {
	 ...
	 * @exception Exception
	 */
//	public List makeContent(long lClientID, long lCreditgradeID, long lOperationType) throws Exception
//	{
//		final int[] itemID = {
