...
public class PayNoticeInfo implements Serializable{
		...
		private String ConsignAccount = "" ; //委托方账号
		...
		private String GrantCurrentAccount = "" ; //活期账号
		...
		private String AccountBankCode = "" ; //银行账号
