package com.iss.itreasury.ebank.obfreeapply.dataentity;
...
public class FreeApplyInfo implements java.io.Serializable{
	...
	private String ConsignClientAccount = "";   //委托贷款单位账号
	...
	private double InterestRate=0;         //贷款利率
	...
	private double LoanPayAmount=0;       //放款金额
	private double LoanPayBalance=0;      //放款余额
	private double LoanPayInterest=0;	  //放款利息
	...
	private long StatusID=0;              //免还状态 已提交、已审核
    ...
    private Timestamp PayLoanStartDate=null;        //放款开始时间
    private Timestamp PayLoanEndDate=null;          //放款开始时间
     ...
     * return Timestamp
     */
    public Timestamp getPayLoanEndDate()
    {
        return PayLoanEndDate;
    }
     ...
     * return Timestamp
     */
    public Timestamp getPayLoanStartDate()
    {
        return PayLoanStartDate;
    }
     ...
     * return void
     */
    public void setPayLoanEndDate(Timestamp timestamp)
    {
        PayLoanEndDate = timestamp;
    }
     ...
     * return void
     */
    public void setPayLoanStartDate(Timestamp timestamp)
    {
        PayLoanStartDate = timestamp;
    }
