...
public class OBRepayPlanEJB implements SessionBean {
	...
	**/
	...
	{
		OBRepayPlanInfo info = new OBRepayPlanInfo();
		OBRepayPlanDao RepayPlanDAO = new OBRepayPlanDao();
		try
		{
			info = RepayPlanDAO.findPlanDetailByID(lID,sInfo);
		}
