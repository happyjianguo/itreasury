...
public class PagedStatement
{
	...
	public String intiQuerySQL(String sql)
	{
		...
		querySQL.append(" (SELECT my_table.*,rownum as my_rownum, ### as ResultSize");
	 ...
	 * @param pageSize 每页容量     
	 */
	public PagedStatement(Connection conn, String sql, long pageNo, long pageSize)
	{
		this.psConn = conn;
		this.pageNo = pageNo;
		if (pageSize>0)
		...
		this.startIndex = getStartOfAnyPage(pageNo, pageSize);
