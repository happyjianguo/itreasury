...
import com.iss.itreasury.ebank.approval.dao.ApprovalSettingDao;
...
public class ApprovalSettingBiz extends Object implements java.io.Serializable
{
		...
		Exception
	{
		...
		{			
			...
			if(approvaldao.checkByApprovalName(ASInfo.getID(),ASInfo.getName())>0)
			{
	 ...
	 */
	public ApprovalSettingInfo findApprovalItem(long lApprovalID, long lLevel, long lUserID, long lCurrencyID,long lOfficeID,long lclientID) throws
		Exception
	{
		Connection con = null;
		ApprovalSettingDao approvaldao = null;
		...
		try
		{
			...
			//查询审批用户权限信息
			ASInfo = approvaldao.findApprovalItem(lApprovalID,lLevel,lUserID,lCurrencyID,lOfficeID,lclientID);
	...
	public static void main(String[] args){
	    ...
	    try {
	    	info=c.findApprovalItem(1,1,1,1,1,1);
