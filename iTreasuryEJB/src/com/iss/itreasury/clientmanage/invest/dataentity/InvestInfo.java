...
package com.iss.itreasury.clientmanage.invest.dataentity;
...
*企业对外投资信息DataEntity，
* */
public class InvestInfo extends CimsBaseDataEntity {
	
	
	private long clientid=-1;//客户id
	private long systemFlag=2;//系统标志,1=资本构成信息 (PartnerInstruction),2=对外投资信息(outInversity)
	...
	private Timestamp stockHolderPassDate;//股东资格批准时间
