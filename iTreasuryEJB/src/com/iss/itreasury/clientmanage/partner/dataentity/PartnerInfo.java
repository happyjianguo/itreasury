...
package com.iss.itreasury.clientmanage.partner.dataentity;
...
/**
*企业资本构成信息DataEntity，对应于表PartnerOfClient
* */
public class PartnerInfo extends CimsBaseDataEntity {
	
	private long clientid=-1;//客户id
	private long systemFlag=1;//系统标志,1=资本构成信息 (PartnerInstruction),2=对外投资信息(outInversity)
	...
	private Timestamp contributiveDate;//资金到位时间 
	...
	private long isStockHoder = -1; //是否控股人
	private long nCurrencyId=-1; //added by mzh_fu 2007/03/29
	...
	public void setSystemFlag(long systemFlag) {
		putUsedField("systemFlag",systemFlag);
	...
	public long getIsStockHoder() {
		return isStockHoder;
	}

	public void setIsStockHoder(long isStockHoder) {
		this.isStockHoder = isStockHoder;
		putUsedField("isStockHoder",isStockHoder);
	}
	...
	public void setStockHoldertype(long stockHoldertype) {
		...
		putUsedField("stockHoldertype",stockHoldertype);
	}
}
