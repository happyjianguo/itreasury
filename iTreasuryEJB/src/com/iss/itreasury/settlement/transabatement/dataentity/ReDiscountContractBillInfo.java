...
public class ReDiscountContractBillInfo {
	...
	private long id = -1 ;                //票据id
	private double amount = 0.0;           //票据金额
	
	private long billSourceTypeId = -1;   //票据来源类型
	private long nSerialNo = -1;               //序列号
	private String sCode ="";                   //汇票号码
	//汇票金额
	private long nContractId =-1;              //贴现合同 //贴现凭证 
	private long discountCredenceId = -1;       //对应贴现凭证id
	
	private long nReContractId = -1;           //转贴现买入合同
	private long reDiscountCredenceId = -1;     //转贴现凭证 
	private Timestamp dtCreate =null;            //出票日 
	private Timestamp dtEnd = null;               //到期日 
	private long nAcceptpoTypeId =-1;          //汇票类型 
