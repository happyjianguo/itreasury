 ...
 */
public class OffBalanceDAOException extends OffBalanceException {
	private Log4j log = new Log4j(Constant.ModuleType.SETTLEMENT, this);

	public OffBalanceDAOException(String errorMessage,Throwable cause)  {
		super("Sett_E200",cause);		
		log.error(errorMessage);
	}

	public OffBalanceDAOException(ITreasuryException cause){
		super("Sett_E200",cause);		
	}
}