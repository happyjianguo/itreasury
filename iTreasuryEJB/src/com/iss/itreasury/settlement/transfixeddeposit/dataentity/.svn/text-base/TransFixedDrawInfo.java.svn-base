 ...
 * Window>Preferences>Java>Code Generation>Code and Comments
 */
public class TransFixedDrawInfo implements Serializable
{
	//主信息
	...
	private String accountName = ""; //定期账户名
	...
	private double MinSingleAmount = 0.0;//起点金额
	...
	private long notifyId = -1;//通知指令id
	private InutParameterInfo inutParameterInfo = null;
	
	//add by qhzhou 2007.6.20
	private String newDepositNo="";     //定期提前部分支取新开立存单号
	private Timestamp drawDate=null;	//支取日期
	private double remainAmount=0.0;	//本金余额
	...
	public void setNewDepositNo(String newDepositNo) {
		this.newDepositNo = newDepositNo;
	}
	...
	public void setMinSingleAmount(double minSingleAmount) {
		MinSingleAmount = minSingleAmount;
	}
	/**
	 * 获取 -- 摘要
	 * @return
