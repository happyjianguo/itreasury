 ...
 *	2、包含变量、类型、默认值、说明
 *  3. 里面的变量主要是从定期开立INFO里面转换过来的，在此加上一些换开定期存单所特有的信息
 * To change the template for this generated type comment go to
 * Window>Preferences>Java>Code Generation>Code and Comments
 */
public class TransFixedChangeInfo implements Serializable
{
	//主信息
	...
	//换开定期存单特有的INFO信息（2006-03-21日添加）
	private String DepositBillNO =""; //换开定期存单的 定期存款单据号
	private long DepositBillStatusID=-1; //换开定期存单的 交易状态
	private long DepositBillInputUserID=-1;	//换开定期存单的 输入人ID
	private long DepositBillCheckUserID=-1;	//换开定期存单的 复核人ID
	private Timestamp DepositBillInputDate = null; //换开定期存单的 输入日
	private Timestamp DepositBillCheckDate = null; //换开定期存单的  复核日
	private String DepositBillABSTRACT = ""; //换开定期存单的 录入摘要
	private String DepositBillCHECKABSTRACT = ""; //换开定期存单的 复核/取消复核摘要
	...
	//新增换开定期存单的INFO对应的SET/GET方法
	
	/**
	 * @return Returns the deDositBillCheckDate.
	 */
	public Timestamp getDepositBillCheckDate() {
		return DepositBillCheckDate;
	}
	/**
	 * @param deDositBillCheckDate The deDositBillCheckDate to set.
	 */
	public void setDepositBillCheckDate(Timestamp depositBillCheckDate) {
		DepositBillCheckDate = depositBillCheckDate;
	}
	/**
	 * @return Returns the depositBillABSTRACT.
	 */
	public String getDepositBillABSTRACT() {
		return DepositBillABSTRACT;
	}
	/**
	 * @param depositBillABSTRACT The depositBillABSTRACT to set.
	 */
	public void setDepositBillABSTRACT(String depositBillABSTRACT) {
		if(depositBillABSTRACT!=null)
			DepositBillABSTRACT = depositBillABSTRACT;
	
	}
	/**
	 * @return Returns the depositBillCHECKABSTRACT.
	 */
	public String getDepositBillCHECKABSTRACT() {
		return DepositBillCHECKABSTRACT;
	}
	/**
	 * @param depositBillCHECKABSTRACT The depositBillCHECKABSTRACT to set.
	 */
	public void setDepositBillCHECKABSTRACT(String depositBillCHECKABSTRACT) {
		if(depositBillCHECKABSTRACT!=null)
			DepositBillCHECKABSTRACT = depositBillCHECKABSTRACT;
	}
	/**
	 * @return Returns the depositBillCheckUserID.
	 */
	public long getDepositBillCheckUserID() {
		return DepositBillCheckUserID;
	}
	/**
	 * @param depositBillCheckUserID The depositBillCheckUserID to set.
	 */
	public void setDepositBillCheckUserID(long depositBillCheckUserID) {
		DepositBillCheckUserID = depositBillCheckUserID;
	}
	/**
	 * @return Returns the depositBillInputUserID.
	 */
	public long getDepositBillInputUserID() {
		return DepositBillInputUserID;
	}
	/**
	 * @param depositBillInputUserID The depositBillInputUserID to set.
	 */
	public void setDepositBillInputUserID(long depositBillInputUserID) {
		DepositBillInputUserID = depositBillInputUserID;
	}
	/**
	...
	public void setDepositBillNO(String depositBillNO) {
		if(depositBillNO!=null)
			DepositBillNO = depositBillNO;
	}
	/**
	 * @return Returns the depositBillStatusID.
	 */
	public long getDepositBillStatusID() {
		return DepositBillStatusID;
	}
	/**
	 * @param depositBillStatusID The depositBillStatusID to set.
	 */
	public void setDepositBillStatusID(long depositBillStatusID) {
		DepositBillStatusID = depositBillStatusID;
	}
	/**
	 * @return Returns the dtDepositBillInputDate.
	 */
	public Timestamp getDepositBillInputDate() {
		return DepositBillInputDate;
	}
	/**
	 * @param dtDepositBillInputDate The dtDepositBillInputDate to set.
	 */
	public void setDepositBillInputDate(Timestamp depositBillInputDate) {
		this.DepositBillInputDate = depositBillInputDate;
	}
