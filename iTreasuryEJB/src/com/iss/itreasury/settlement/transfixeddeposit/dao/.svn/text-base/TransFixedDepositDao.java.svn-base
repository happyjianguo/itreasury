...
public class TransFixedDepositDao {
	
	public String queryTransFixedDepositSQL(QueryByStatusConditionInfo qInfo){
		...
		if (qInfo.getTypeID() == 0) 
		{
			...
			sbSQL.append("select aa.*,'通知开立' as biztypename \n");
			...
			sbSQL.append("and sBillNo is null \n");
		}
