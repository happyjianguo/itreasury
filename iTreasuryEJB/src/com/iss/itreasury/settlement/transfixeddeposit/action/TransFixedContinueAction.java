...
import com.iss.itreasury.settlement.transfixeddeposit.bizlogic.TransFixedContinueBiz;
import com.iss.itreasury.settlement.transfixeddeposit.dataentity.QueryByStatusConditionInfo;
import com.iss.itreasury.settlement.util.SETTConstant;
import com.iss.sysframe.pager.dataentity.PagerInfo;
import java.sql.Timestamp;

public class TransFixedContinueAction {
	TransFixedContinueBiz fixedContinueBiz = new TransFixedContinueBiz();
	/*
	 * 定期开立--链接查询
	 */
