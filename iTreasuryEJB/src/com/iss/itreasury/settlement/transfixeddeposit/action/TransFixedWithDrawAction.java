...
import com.iss.itreasury.settlement.transfixeddeposit.bizlogic.TransFixedWithDrawBiz;
import com.iss.itreasury.settlement.transfixeddeposit.dataentity.QueryByStatusConditionInfo;
import com.iss.itreasury.settlement.util.SETTConstant;
import com.iss.sysframe.pager.dataentity.PagerInfo;
import java.sql.Timestamp;

public class TransFixedWithDrawAction {
	TransFixedWithDrawBiz fixedWithDrawBiz = new TransFixedWithDrawBiz();
	/*
	 * 定期开立--链接查询
	 */
	public PagerInfo findByConditions(Map map) throws Exception{
		...
		{               
			...
			pagerInfo = fixedWithDrawBiz.findByConditions(depositInfo);
		} 
		catch (Exception e) {
