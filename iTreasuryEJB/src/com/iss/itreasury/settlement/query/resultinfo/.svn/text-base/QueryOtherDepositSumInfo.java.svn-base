 ...
 *  
 */
public class QueryOtherDepositSumInfo
{
    public double DepositBalanceSum = 0.0;   //存款余额
    public double DepositAmountSum = 0.0;   //存款金额 
    public double DepositInterestSum = 0.0;   //累计存款利息 
    
    /**
     * @return Returns the depositAmountSum.
     */
    ...
    /**
     * @param depositAmountSum The depositAmountSum to set.
     */
    ...
    /**
     * @return Returns the depositInterestSum.
     */
    ...
    /**
     * @param depositInterestSum The depositInterestSum to set.
     */
    public void setDepositInterestSum(double depositInterestSum)
    {
        DepositInterestSum = depositInterestSum;
    }
}
