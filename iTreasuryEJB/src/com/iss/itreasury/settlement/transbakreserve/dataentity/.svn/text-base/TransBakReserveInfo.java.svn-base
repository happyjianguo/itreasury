package com.iss.itreasury.settlement.transbakreserve.dataentity;

import java.sql.Timestamp;
import com.iss.itreasury.settlement.base.SettlementBaseDataEntity;

public class TransBakReserveInfo extends SettlementBaseDataEntity{
	...
	private long sextaccountID=-1;			//银行帐户id/外部账户id
	private String sextaccountno ="";       //银行帐户号(外部账户)
	private String sextclientname ="";      //银行客户名称(银行账户名称)
	...
	//String SPayeeBankExchangeNo="";
	//String SPayeeBankorgNo="";
	//String CNAPSNO="";
	...
	/**
	 * @return the sextaccountID
	 */
	public long getSextaccountID() {
		return sextaccountID;
	}
	/**
	 * @param sextaccountID the sextaccountID to set
	 */
	public void setSextaccountID(long sextaccountID) {
		this.sextaccountID = sextaccountID;
	}
