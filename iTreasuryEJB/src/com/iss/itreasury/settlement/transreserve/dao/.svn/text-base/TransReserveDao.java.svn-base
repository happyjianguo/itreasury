package com.iss.itreasury.settlement.transreserve.dao;
...
public class TransReserveDao extends SettlementDAO{
	...
	public long add(TransReserveInfo info) throws Exception
	{
		long mID=-1;
		Connection con = null;
		PreparedStatement ps = null;
	...
	public long updateBakReserveInfo(TransReserveInfo info) throws Exception
	{
		long lReturn = -1;
		Connection con = null;
		PreparedStatement ps = null;
		...
		try
		{
			...
			strSQLBuffer.append("update   \n");
			strSQLBuffer.append(strTableName + " \n");
			strSQLBuffer.append(" set " + getFieldsSQLString(-1, DAO_OPERATION_UPDATE, info) + " \n");
	...
	*/
	private String getFieldsSQLString(long transactionType, int operation, TransReserveInfo info)
	{
		StringBuffer strSQLBuffer = new StringBuffer();
		String strRes = "";
	 ...
	 * 
	 */
	private int addDatatoPrepareStatement(TransReserveInfo info, PreparedStatement stmt, int operation) throws Exception
	{
		...
		{
			index = 1;
			if(info.getStransno()!=null &&info.getStransno().length()>0)
			{
	 ...
	 * @throws IException
	 */
	public TransReserveInfo findByID(long lID) throws Exception
	{
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		TransReserveInfo res = null;
		try
		{
			con = getConnection();
			StringBuffer strSQLBuffer = new StringBuffer();
			...
			{
				res = (TransReserveInfo) ((ArrayList) c).get(0);
			}
	 ...
	 * @return Collection
	 */
	public Collection findByConditions(TransReserveInfo info, int orderByType, boolean isDesc) throws Exception
	{
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
	 ...
	 * @return Sett_TransCurrentDepositInfo
	 */
	public TransReserveInfo match(TransReserveInfo info) throws Exception
	{
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
