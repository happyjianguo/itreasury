 ...
 */
public class PrintSecuritiesBalanceInfo extends SECBaseDataEntity implements Serializable
{
	private long id                        = -1;
	//securitiesId
	...
	/**
	 * @return Returns the endCounterPartBalace.
	 */
	public double getEndCounterPartBalance() {
		return endCounterPartBalance;
	}
	/**
	 * @param endCounterPartBalace The endCounterPartBalace to set.
	 */
	...
	/**
	 * @return Returns the startCounterPartBalace.
	 */
	public double getStartCounterPartBalance() {
		return startCounterPartBalance;
	}
	/**
	 * @param startCounterPartBalace The startCounterPartBalace to set.
	 */
