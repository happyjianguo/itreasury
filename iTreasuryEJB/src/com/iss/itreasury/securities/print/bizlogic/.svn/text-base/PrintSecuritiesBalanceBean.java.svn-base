...
public class PrintSecuritiesBalanceBean {
	...
	private void initialSql(PrintSecuritiesBalanceParam parameter) 
	{
		...
		**/
		...
		sbFrom.append("---------**拼写第一个表(主表是cc)：自营证券和短期投资**   \n");
		...
		**/
		...
		sbFrom.append("---------**拼写第一个表(主表是bb)：自营证券和短期投资**   \n");
		sbFrom.append("   SELECT  \n");
		sbFrom.append("  	aa.subjectTypeId  subjectTypeId, \n");
		sbFrom.append("	  	aa.subjectName  subjectName, \n");
		sbFrom.append("		cc.capitaldirection  capitaldirection, \n");
		...
		**/
		...
		sbFrom.append("--------------**拼写第二个表：债券回购（主表是cc,businessTypeId is 26 & 27）**  \n");
		...
		**/
		...
		sbFrom.append(" union \n");
		sbFrom.append("--------------**拼写第二个表：债券回购（主表是bb,businessTypeId is 26 & 27）**  \n");
		sbFrom.append(" SELECT  \n");
		sbFrom.append("  aa.subjectTypeId  subjectTypeId, \n");
		sbFrom.append("	 aa.subjectName  subjectName, \n");
		sbFrom.append("	 cc.capitaldirection  capitaldirection, \n");
		...
		**/
		...
		//{
			...
			sbFrom.append("----------------**拼写第三个表：（主表是cc）买入回购资产，卖出回购资产款，结构性投资**  \n");
			...
			**/
			...
			sbFrom.append("----------------**拼写第三个表：（主表是bb）买入回购资产，卖出回购资产款，结构性投资**  \n");
			sbFrom.append(" SELECT  \n");
			sbFrom.append("  aa.subjectTypeId  subjectTypeId, \n");
			sbFrom.append("	 aa.subjectName  subjectName, \n");
			sbFrom.append("	 cc.capitaldirection  capitaldirection, \n");
