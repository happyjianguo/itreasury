 ...
 * 窗口 > 首选项 > Java > 代码生成 > 代码和注释
 */
public class PrintSecuritiesChangeFundBean {
	...
	private void getSQL(PrintSecuritiesStockChangeParam queryParam) {
		...
		String[] fundCounterPartIds = queryParam.getFundCounterPartIds();
				...
				sbFrom.append("   end_table.counterPartId,  --基金管理公司  \n");
				...
				sbFrom.append("  my_DailyStock.counterPartId,  --基金管理公司\n");
	...
	private void getMyTable(
		...
		sbFrom.append("      Sec_CounterPArt.id as counterPartId,  --基金管理公司 \n");
		...
		sbFrom.append( "and SEC_Securities.TypeID in (6) \n");				
		//条件一：业务通知单录入日期开始日
		...
		sbFrom.append("     ) my_DailyStock --开放式基金\n");
	}
	 ...
	 *         SecuritiesException
	 */
	public PageLoader printSecuritiesChangeFund(PrintSecuritiesStockChangeParam printParam)
