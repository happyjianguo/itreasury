 ...
 * Window - Preferences - Java - Code Generation - Code and Comments
 */
public class PrintSecuritiesProfitAndLossBankBean {
	...
	private void getSQL(SecuritiesProfitAndLossParam printParam) {
		...
		sbFrom.append("	(SELECT --在PrintSecuritiesProfitAndLossBankBean中拼写 \n");
		...
		sbFrom.append("		AND sec_Securities.typeID IN (10,11,12,13,14) \n");
	 ...
	 */
	public PageLoader PrintSecuritiesProfitAndLossForBank(SecuritiesProfitAndLossParam printParam) throws SecuritiesException {
		...
		pageLoader.initPageLoader(
			...
			"com.iss.itreasury.securities.print.dataentity.SecuritiesProfitAndLossBankInfo",
			null);
	...
	private void getSQLForCnmef(SecuritiesProfitAndLossParam printParam) {
		...
		sbFrom.append("	WHERE 1 = 1 \n");
		sbFrom.append("		AND sec_DailyStock.securitiesID = sec_Securities.ID \n");
		sbFrom.append("		AND sec_Securities.typeID IN ("+
			SECConstant.SecuritiesType.BANK_NATIONAL_BOND+","+
			SECConstant.SecuritiesType.BANK_BOND_REPURCHASE+","+
			SECConstant.SecuritiesType.CENTRAL_BANK_NOTE+","+
			SECConstant.SecuritiesType.POLICY_RELATED_FINANCIAL_BOND+","+
	 ...
	 * @throws SecuritiesException
	 */
	public PageLoader PrintSecuritiesProfitAndLossForBankForCnmef(SecuritiesProfitAndLossParam printParam) throws SecuritiesException {
