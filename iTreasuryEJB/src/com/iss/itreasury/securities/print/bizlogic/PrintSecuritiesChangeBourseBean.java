 ...
 * 窗口 > 首选项 > Java > 代码生成 > 代码和注释
 */
public class PrintSecuritiesChangeBourseBean {
	...
	private void getSQL(PrintSecuritiesStockChangeParam queryParam) {
		...
		String[] fundCounterPartIds = queryParam.getFundCounterPartIds();
				...
				sbFrom.append("   sum(end_table.endCost) as endCost,--实际成本(全价)  \n");
				sbFrom.append("   sum(end_table.endCostNet) as endCostNet--实际成本(净价)  \n");		
				...
				sbFrom.append("  my_DailyStock.Quantity*my_DailyStock.PledgeRate/100 as startQuantityConvert,--期初库存余额(已折合) \n");//搞了半天，就是为了这个字段
				sbFrom.append("  0 as endQuantity,--期末库存余额(正常) \n");
				sbFrom.append("  0 as endQuantityConvert,--期末库存余额(已折合) \n");
				sbFrom.append("  0 as endCost, --实际成本(全价) \n");
				sbFrom.append("  0 as endCostNet--实际成本(净价) \n");
		...
		sbFrom.append("  my_DailyStock.Quantity*my_DailyStock.PledgeRate/100 as endQuantityConvert,--期末库存余额(已折合) \n");
		sbFrom.append("  my_DailyStock.cost as endCost, --实际成本(全价) \n");
		sbFrom.append("  my_DailyStock.NetCost as endCostNet--实际成本(净价) \n");
	...
	private void getMyTable(
		...
		sbFrom.append("      sec_dailyStock.Cost, --实际成本(全价) \n");
		sbFrom.append("      sec_dailyStock.NetCost--实际成本(净价) \n");
		...
		sbFrom.append( "and SEC_Securities.TypeID in (3,4,7,8,9) \n");				
		//条件一：业务通知单录入日期开始日
		...
		sbFrom.append("     ) my_DailyStock  --交易所\n");
	}
	 ...
	 *         SecuritiesException
	 */
	public PageLoader printSecuritiesChangeBourse(PrintSecuritiesStockChangeParam printParam)
