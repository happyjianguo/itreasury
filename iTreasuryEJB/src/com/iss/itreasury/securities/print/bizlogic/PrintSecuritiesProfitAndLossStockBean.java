 ...
 * Window - Preferences - Java - Code Generation - Code and Comments
 */
public class PrintSecuritiesProfitAndLossStockBean {
	...
	private void getSQL(SecuritiesProfitAndLossParam printParam) {
		...
		sbSelect.append("	NVL(a.netcost, 0.0)								cost, \n");
		...
		sbFrom.append("		AND sec_Securities.typeID IN (1,2) \n");
	 ...
	 */
	public PageLoader PrintSecuritiesProfitAndLossStock(SecuritiesProfitAndLossParam printParam) throws SecuritiesException {
		...
		pageLoader.initPageLoader(
			...
			"com.iss.itreasury.securities.print.dataentity.SecuritiesProfitAndLossStockInfo",
			null);
	...
	private void getSQLForCnmef(SecuritiesProfitAndLossParam printParam) {
		...
		sbFrom.append("	WHERE 1 = 1 \n");
		sbFrom.append("		AND sec_DailyStock.securitiesID = sec_Securities.ID \n");
		sbFrom.append("		AND sec_Securities.typeID IN ("+SECConstant.SecuritiesType.STOCK_A+","+SECConstant.SecuritiesType.STOCK_B+") \n");
		sbFrom.append("		AND sec_DailyStock.accountID = sec_Account.ID(+) \n");
		//时间
		if (printParam.getDailyAccountDate() != null) {
			sbFrom.append("		AND sec_DailyStock.stockDate = TO_DATE('"+DataFormat.getDateString(printParam.getDailyAccountDate())+"','YYYY-MM-DD') \n");
		...
		sbFrom.append("		AND c.typeID IN ("+SECConstant.SecuritiesType.STOCK_A+","+SECConstant.SecuritiesType.STOCK_B+") \n");
		//业务单位ID
		if (printParam.getClientId() > 0) {
	 ...
	 * @throws SecuritiesException
	 */
	public PageLoader PrintSecuritiesProfitAndLossStockForCnmef(SecuritiesProfitAndLossParam printParam) throws SecuritiesException {
