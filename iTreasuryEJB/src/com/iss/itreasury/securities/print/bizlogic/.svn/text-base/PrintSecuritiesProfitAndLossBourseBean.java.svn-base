 ...
 * Window - Preferences - Java - Code Generation - Code and Comments
 */
public class PrintSecuritiesProfitAndLossBourseBean {
	...
	private void getSQL(SecuritiesProfitAndLossParam printParam) {
		...
		sbFrom.append("	(SELECT --在PrintSecuritiesProfitAndLossBourseBean中拼写 \n");
	 ...
	 */
	public PageLoader PrintSecuritiesProfitAndLossForBourse(SecuritiesProfitAndLossParam printParam) throws SecuritiesException  {
		...
		pageLoader.initPageLoader(
			...
			"com.iss.itreasury.securities.print.dataentity.SecuritiesProfitAndLossBourseInfo",
			null);
	 ...
	 * @throws SecuritiesException
	 */
	public PageLoader PrintSecuritiesProfitAndLossForBourseForCnmef(SecuritiesProfitAndLossParam printParam) throws SecuritiesException  {
