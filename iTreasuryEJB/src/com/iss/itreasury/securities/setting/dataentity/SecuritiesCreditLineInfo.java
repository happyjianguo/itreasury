 ...
 */
public class SecuritiesCreditLineInfo extends SECBaseDataEntity {
	private long id = -1;
	...
	private long QuerySecuritiesId = -1;
	...
	/**
	 * @param securitiesTypeId
	 *            The securitiesTypeId to set.
	 */
	...
	/**
	 * @param queryCreditLineFrom
	 *            The queryCreditLineFrom to set.
	 */
	...
	/**
	 * @param queryCreditLineTo
	 *            The queryCreditLineTo to set.
	 */
	...
	/**
	 * @param queryInputUserId
	 *            The queryInputUserId to set.
	 */
	public void setQueryInputUserId(long queryInputUserId) {
		QueryInputUserId = queryInputUserId;
	}
	/**
	 * @return Returns the querySecuritiesId.
	 */
	public long getQuerySecuritiesId() {
		return QuerySecuritiesId;
	}
	/**
	 * @param querySecuritiesId
	 *            The querySecuritiesId to set.
	 */
	public void setQuerySecuritiesId(long querySecuritiesId) {
		QuerySecuritiesId = querySecuritiesId;
	}
	/**
	...
	/**
	 * @param querySecuritiesTypeId
	 *            The querySecuritiesTypeId to set.
	 */
