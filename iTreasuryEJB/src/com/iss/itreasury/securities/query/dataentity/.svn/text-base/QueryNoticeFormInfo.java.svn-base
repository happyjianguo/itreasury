 ...
 */
public class QueryNoticeFormInfo extends SECBaseDataEntity	implements Serializable {
	...
	//是否虚拟交割单
	private long isRelatedByNoticeForm = -1;
	//合同id
	 ...
	 * @param l
	 */
	public void setIsRelatedByNoticeForm(long l)
	{
		isRelatedByNoticeForm = l;
	}
