 ...
 */
public class QueryBusinessAttributeInfo extends SECBaseDataEntity implements
        Serializable {

    private long businessAttributeID = -1;//ID

    private String code = "";//业务性质编号

    private String name = "";//业务性质名称
