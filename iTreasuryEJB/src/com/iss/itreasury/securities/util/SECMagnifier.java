 ...
 * 
 * Magnifier0130: createClientBankCtrl()				//公司开户行放大镜,返回NAME,带出账户CODE和NAME,使用视图SEC_VClientBankMagnifier
 * 
 * Magnifier0140: createUserCtrl()						//用户放大镜,收办事处币种限制,可以过滤掉当前用户
 * 
 * Magnifier0150: createStockHolderAccountCtrl()		//股东账户放大镜,显示账户Code,带出名称
 * Magnifier0151: createStockHolderAccountCtrl()		//股东账户放大镜,显示名称,受业务单位影响
 * Magnifier0160: createStockHolderAccountCtrl()		//股东账户放大镜,显示账户名称
 * 
 * 
 * 
 ...
 * 
 * Magnifier0200: createAccountCtrl()					//资金账户(typeId=0) / 交易账户(typeId=1)放大镜,受业务单位ID元素影响,返回Account Code,
 * 										当显示资金账户时,带出股东账户代码和股东账户名称,显示交易账户时带出基金账户代码和名称,反带出业务单位和交易对手的名称和ID
 * Magnifier0201: createAccountCtrl()					//资金账户(typeId=0) / 交易账户(typeId=1)放大镜,受业务单位ID元素影响,返回Account Code,
 * 										当显示资金账户时,带出股东账户代码和股东账户名称,显示交易账户时带出基金账户代码和名称,反带出业务单位和交易对手的名称和ID,和交易对手的代码
 *
 ...
 * 
 * Magnifier0091: createSettAccountCtrl()				//活期账户放大镜,多文本框,显示结算账户表中的活期账户
 * 									此放大镜显示四个文本框,分别显示活期账户的四个部分,命名都为%accountName%+Ctrl,如果页面置焦点需要以数组控制
 */
...
public class SECMagnifier
{
	...
	public static void createClientCtrl(
		...
		String[] strListTitleDisplayNames={"业务单位编号","业务单位名称"}; 	//放大镜弹出页面的显示名称=;可以有多列
		String[] strListTitleDisplayFields={"CODE","NAME"}; 			//显示名称的对应字段

		String[] strnextFocusElementNames=nextFocusElementNames;	//下一个焦点
			
		String strWindowTitle="业务单位放大镜";	//放大镜弹出窗口标题
	//	String strWindowTitle="证券-业务单位放大镜";//放大镜弹出窗口标题
	...
	public static void createCounterPartCtrl(
		...
		if (counterpartTypeFields.length == 1 && counterpartTypeFields[0].equals("IsBankOfDeposit")){
			...
			strListTitleDisplayNames=new String[]{"交易对手编号","交易对手名称","业务单位"}; 	//放大镜弹出页面的显示名称=;可以有多列
		...
		String strWindowTitle="";					//放大镜弹出窗口标题
		if (counterpartTypeFields.length == 1 && counterpartTypeFields[0].equals("IsBankOfDeposit")){
			strWindowTitle="开户营业部放大镜";
			//strWindowTitle="证券-开户营业部放大镜";
		}
		else{
			strWindowTitle="交易对手放大镜";
		...
		if (counterpartTypeFields.length == 1 && 
			...
			strListTitleDisplayNames=new String[]{"交易对手编号","交易对手名称"}; 	//放大镜弹出页面的显示名称=;可以有多列
...
/**Magnifier0050
	...
	public static void createApplyFormCtrl(
		...
		//ZCQ 于2007年4月4日修改该放大镜显示域，原因是验收人员认为不能显示申请书ID
		String[] strListTitleDisplayNames={"申请书代码"}; 	//放大镜弹出页面的显示名称=;可以有多列
		String[] strListTitleDisplayFields={"CODE"}; 			//显示名称的对应字段
		
		String[] strnextFocusElementNames=nextFocusElementNames;	//下一个焦点
		String strWindowTitle="申请书放大镜";	
	 ...
	 * @throws Exception
	 */
	public static void createRepurchaseApplyFormCtrl(
			JspWriter out,
			String displayElementName,
			String idElementName,
			long idElementIniValue,
	...
	public static void createDeliveryOrderCtrl(
		...
		String[] strListTitleDisplayNames={"交割单编码"}; 	//放大镜弹出页面的显示名称=;可以有多列
		String[] strListTitleDisplayFields={"CODE"}; 	//显示名称的对应字段

		String[] strnextFocusElementNames=nextFocusElementNames;	//下一个焦点
		
		String strWindowTitle="交割单放大镜";
	 ...
	 * 
	 * ---------影响元素
	 * @param accountCode							//开户账户代码
	 * @param accountName							//开户账户名称
	 * 
	 * @param visibleElementProperty
	 * @param nextFocusElementNames
	 * @param showOnly
	...
	public static void createCounterpartBankCtrl(
		...
		String[] strListTitleDisplayNames={"交易对手开户行名称","银行账户名称"};//放大镜弹出页面的显示名称=;可以有多列
		String[] strListTitleDisplayFields={"BANKNAME","BANKACCOUNTNAME"}; 		//显示名称的对应字段

		String[] strnextFocusElementNames=nextFocusElementNames;	//下一个焦点
		String strWindowTitle="交易对手开户行放大镜";
	 ...
	 * @throws Exception
	 */
	public static void createSECBankCtrl(
			JspWriter out,
			String displayElementName,
			String idElementName,
			long idElementIniValue,
		...
		String[] strListTitleDisplayNames={"证券公司开户行名称","银行账户名称"};//放大镜弹出页面的显示名称=;可以有多列
		String[] strListTitleDisplayFields={"BANKNAME","BANKACCOUNTNAME"}; 		//显示名称的对应字段

		String[] strnextFocusElementNames=nextFocusElementNames;	//下一个焦点
		
		String strWindowTitle="证券-证券公司开户行放大镜";					//放大镜弹出窗口标题
		int intListAnchorPosition=0;								//放大镜页面弹出时默认停留的位置
	...
	public static void createClientBankCtrl(
		...
		String[] strCtrlValues = {String.valueOf(officeId),String.valueOf(currencyId),"1"};
		String[] strCtrlFields = {"NOFFICEID","NCURRENCYID","nStatusID"};
		...
		String[] strListTitleDisplayNames={"公司开户行代码","公司开户行名称","账户代码"};//放大镜弹出页面的显示名称=;可以有多列
		String[] strListTitleDisplayFields={"SCODE","SNAME","SBANKACCOUNTCODE"}; 		//显示名称的对应字段

		String[] strnextFocusElementNames=nextFocusElementNames;	//下一个焦点
		String strWindowTitle="公司开户行放大镜";
		//String strWindowTitle="证券-公司开户行放大镜";					//放大镜弹出窗口标题
		int intListAnchorPosition=0;								//放大镜页面弹出时默认停留的位置
	...
	public static void createUserCtrl(
		 ...
		 * 操作符
		 */
		String[] strOperators = {"like","=","=","not in"};
		/**
		 * 逻辑操作符
		 */
	 ...
	 * @throws Exception
	 */
	public static void createSpecialUserCtrl(
			JspWriter out,
			String displayElementName,
			String idElementName,
			long idElementIniValue,
		...
		String[] strCtrlValues = {String.valueOf(officeId),exceptUserId};
		String[] strCtrlFields = {"nOfficeId","id"};
	...
	/**Magnifier0150
		 ...
		 * @param hiddenElementValue				客户ID的初始值
		 * 
		 * @param accountNameElementName			股东账户名称元素名称
		 * 
		 * @param visibleElementProperty			主显示元素的自定义属性
		 * @param nextFocusElementNames				下一个焦点位置
		 * @param showOnly							是否仅作为显示内容(用于复核页面)
		...
		public static void createStockHolderAccountCtrl(
			...
			String[] strListTitleDisplayNames={"股东账户编号","股东账户名称"}; 	//放大镜弹出页面的显示名称=;可以有多列
			String[] strListTitleDisplayFields={"CODE","NAME"}; 			//显示名称的对应字段

			String[] strnextFocusElementNames=nextFocusElementNames;	//下一个焦点
			
			String strWindowTitle="证券-股东账户信息放大镜";					//放大镜弹出窗口标题
			int intListAnchorPosition=0;								//放大镜页面弹出时默认停留的位置
	...
	/**Magnifier0160
		 * 股东账户信息
		 * @param out								jspWriter
		 * @param mainElementName					页面客户名称显示文本框名称,返回股东账户名称
		 * @param hiddenElementName					客户ID隐含域的名称
		 * @param hiddenElementValue				客户ID的初始值
		 * 
		 * 
	...
	/**Magnifier0170
		 ...
		 * @param hiddenElementValue				客户ID的初始值
		 * 
		 * @param exchangeCenterElementName			股东账户名称元素名称
		 * 
		 * @param visibleElementProperty			主显示元素的自定义属性
		 * @param nextFocusElementNames				下一个焦点位置
		 * @param showOnly							是否仅作为显示内容(用于复核页面)
		...
		public static void createExchangeCenterCodeCtrl(
			...
			String[] strListTitleDisplayNames={"证券交易市场编号","证券交易市场名称"}; 	//放大镜弹出页面的显示名称=;可以有多列
			String[] strListTitleDisplayFields={"CODE","NAME"}; 			//显示名称的对应字段

			String[] strnextFocusElementNames=nextFocusElementNames;	//下一个焦点
			
			String strWindowTitle="证券-证券交易市场资料放大镜";					//放大镜弹出窗口标题
			int intListAnchorPosition=0;								//放大镜页面弹出时默认停留的位置
	...
	/**
	 * 资金账户/交易账户放大镜Magnifier0200
	 * @param out
	 * @param displayElementName							//资金账户Name元素名称
	 * @param idElementName									//资金账户Id元素名称
	 * @param idElementIniValue								//资金账户Id初始值
	 * 控制元素
	 * @param clientIdElementName							//业务单位放大镜,会影响到资金账户放大镜内容
	 * 控制值
	 * @param currencyId									//币种
	 * 
	 * 带出值
	 * @param holderAccountCodeElementName					//放大镜带出的账户Code元素名称,资金账户带出股东账号,交易账户带出基金账号
	 * @param holderAccountNameElementName					//放大镜带出的账户Name元素名称,资金账户带出股东账户,交易账户带出基金账户
	 ...
	 * 带出值
	 * 
	 * @param typeId										//类型码 0:用于资金账户 1:用户交易账户
	 * @param visibleElementProperty
	 * @param nextFocusElementNames
	 * @param showOnly
	 * @throws Exception
	...
	public static void createAccountCtrl(
			...
			//校验typeId
		if (!(typeId == 0 || typeId == 1)){
			throw new SecuritiesException("资金账户放大镜传入的typeId错误",null);
		}
		...
		String systemDate = Env.getSystemDateString();
		if (typeId == 0){					//资金账户
			strCtrlValues = new String[]{String.valueOf(SECConstant.SettingStatus.CHECKED),String.valueOf(currencyId),String.valueOf(SECConstant.AccountType.SECURITIES_ACCOUNT),systemDate};
			strCtrlFields = new String[]{"STATUSID","CURRENCYID","ACCOUNTTYPEID","-OPENDATE"};
		}
		else if (typeId == 1){				//交易账户
			strCtrlValues = new String[]{String.valueOf(SECConstant.SettingStatus.CHECKED),String.valueOf(currencyId),String.valueOf(SECConstant.AccountType.OPENFUND_ACCOUNT),systemDate};
			strCtrlFields = new String[]{"STATUSID","CURRENCYID","ACCOUNTTYPEID","-OPENDATE"};
		}
		
		String[] strOperators = {"like","like","=","=","=","=","=","<="};
		String[] strLogicOperators = {"or","and","and","and","and","and","and"};
		...
		if (typeId == 0){
			strListTitleDisplayNames = new String[]{"资金账户代码","资金账户名称"}; 	//放大镜弹出页面的显示名称=;可以有多列
		}
		else if (typeId == 1){
			strListTitleDisplayNames = new String[]{"交易账户代码","交易账户名称"}; 	//放大镜弹出页面的显示名称=;可以有多列
		}
		...
		String strWindowTitle="证券-资金账户放大镜";					//放大镜弹出窗口标题
		
		if (typeId == 1){
			strWindowTitle="证券-交易账户放大镜";					//放大镜弹出窗口标题
		}
	...
	/**Magnifier0012:业务类型放大镜,返回名称,带出业务属性ID
		...
		public static void createBusinessTypeCtrl(
			...
			//申请查询
				...
				strCtrlValues = new String[]{String.valueOf(SECConstant.SettingStatus.CHECKED),"6,11,12,13,41,42,71,73,75,77,79,81,83,85,87,89,91,93"};
			...
			//交割单查询
				...
				strCtrlValues = new String[]{String.valueOf(SECConstant.SettingStatus.CHECKED),"6,11,12,13,41,42,71,73,75,77,79,81,83,89,93"};
				strCtrlFields = new String[]{"STATUSID","ID"};
			...
			//业务通知单查询
				...
				strCtrlValues = new String[]{String.valueOf(SECConstant.SettingStatus.CHECKED),"17,18,21,22,26,31,32,33,36,37,46,52,57,61,62,63,64,85"};
				strCtrlFields = new String[]{"STATUSID","ID"};
			...
			//审批流关联设置
				...
				strCtrlValues = new String[]{String.valueOf(SECConstant.SettingStatus.CHECKED),"16,17,18,26,27,31,32,33,34,36,37,41,42,46,47,51,52,53,54,56,57,58,61,62,63,64,85,92"};
				strCtrlFields = new String[]{"STATUSID","ID"};
	...
	public static void createTransactionTypeCtrl(
		...
		//审批流关联设置
			...
			strCtrlValues = new String[]{String.valueOf(SECConstant.SettingStatus.CHECKED),"16,17,18,26,27,31,32,33,34,36,37,41,42,46,47,51,52,53,54,56,57,58,61,62,63,64,85,92"};
			strCtrlFields = new String[]{"STATUSID","businesstypeid"};
		...
		public static void createSubjectCtrl(
			...
			String[] strCtrlValues = {"1",String.valueOf(currencyId),String.valueOf(officeId)};
			String[] strCtrlFields = {"NSTATUS","NCURRENCYID","NOFFICEID"};
			
			String[] strOperators = {"like","like","=","=","="};
			String[] strLogicOperators = {"or","and","and","and"};
			...
			String subjectIdTmp = NameRef.getSubjectIDByCode(codeElementIniValue,officeId,currencyId);
			long subjectId = -1;
	...
	/**Magnifier0010
		...
		public static void createSettAccountCtrl(
			...
			String[] strListTitleDisplayNames={"账户编号","账户名称"}; 	//放大镜弹出页面的显示名称=;可以有多列
			String[] strListTitleDisplayFields={"SACCOUNTNO","SNAME"}; 			//显示名称的对应字段

			String[] strnextFocusElementNames=nextFocusElementNames;	//下一个焦点
			
			String strWindowTitle="证券-账户放大镜";					//放大镜弹出窗口标题
			int intListAnchorPosition=0;								//放大镜页面弹出时默认停留的位置
	...
	public String buildSql(String[] strFields,String[] strCtrlFields,String[] strOperators,String[] strCtrlValues,String[] strLogics,String strTableName){
		...
		StringBuffer sbOrder = new StringBuffer(100);
			...
			for (int n=0;n<strCtrlFields.length;n++){
				...
				if (strCtrlValues[n]!=null && strCtrlValues[n].length()>0 && !strCtrlValues[n].equals("-1")){
					...
					if (intSpecialOperatorType >= 0){		//current operator is special operator
						...
						else if(strCtrlFields[n].startsWith("-")){
							strExpressionTemp = strCtrlFields[n].substring(1) + strOperators[n] + "to_date('" + strCtrlValues[n] + "','yyyy-mm-dd')";
						}else{
		...
		for (int n=0;n<strFields.length;n++){
			if (strFields[n].equals("ID")){
				sbOrder.append("\n order by "+strFields[n]+" ");
				break;
			}
		}
	...
	public static void CreateSubLoanTypeCtrl(long lOfficeID, long lCurrencyID,
		...
		try {
			...
			out
					.println("	sql += \" where a.ID = b.subLoanTypeID and a.LOANTYPEID=b.LOANTYPEID and a.statusID = 1 \";");
			out.println(" ");
