 ...
 * Window>Preferences>Java>Code Generation>Code and Comments
 */
public class DeliveryOrderEJB implements SessionBean
{
	...
	*/
	 ...
	 *资金划转的提交操作
	*/
	public long submit(DeliveryOrderInfo deliveryOrderInfo, NoticeInfo nInfo) throws java.rmi.RemoteException,SecuritiesException
	{
		try{
			//初始化数据库联接
...
//		初始化数据库联接
		 ...
		 * 初始化登记簿操作类
		 */
		RegisterOperation operation = new RegisterOperation(false); 
	...
	*/
	...
	public Collection getAllNotRepayDeliveryOrder(DeliveryOrderConditionInfo conditionInfo) throws java.rmi.RemoteException,SecuritiesException{
		...
		DeliveryOrderServiceOperation operation = new DeliveryOrderServiceOperation();
