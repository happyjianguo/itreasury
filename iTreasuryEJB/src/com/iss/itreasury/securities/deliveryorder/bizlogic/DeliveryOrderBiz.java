 ...
 * Window>Preferences>Java>Code Generation>Code and Comments
 */
public class DeliveryOrderBiz implements SessionBean
{
	...
	*/
	public long submit(DeliveryOrderInfo deliveryOrderInfo) throws java.rmi.RemoteException,SecuritiesException
	{
		try{
			...
			//新增该通知单	
			long savedNoticeID = noticeDelegation.save(noticeInfo);
			
			noticeInfo = (NoticeInfo)noticeDelegation.findByID(savedNoticeID);
...
//			更新交割单状态为已保存
			...
			throw new SecuritiesDAOException("Sec_E100",e);
		} 
	 ...
	 *交割单的保存操作
 	*/
	public void save(DeliveryOrderInfo deliveryOrderInfo) throws Exception
	{
		//初始化数据库联接
		SEC_DeliveryOrderDAO deliveryOrderDAO = new SEC_DeliveryOrderDAO();
		SEC_ApplyDAO applyDAO = new SEC_ApplyDAO();
		DeliveryOrderServiceBiz deliveryOrderServiceOperation = new DeliveryOrderServiceBiz(); 
		...
		try {
...

			{
				...
				map.put("officeID",String.valueOf(deliveryOrderInfo.getOfficeId()));
				map.put("currencyID",String.valueOf(deliveryOrderInfo.getCurrencyId()));
				map.put("moduleID",String.valueOf(Constant.ModuleType.CRAFTBROTHER));
				map.put("transTypeID",String.valueOf(deliveryOrderInfo.getTypeId()));
				map.put("actionID",String.valueOf(deliveryOrderInfo.getActionTypeId()));
				map.put("subActionID",String.valueOf(deliveryOrderInfo.getTransactionTypeId()));
				String applyCode=CreateCodeManager.createCode(map);
				deliveryOrderInfo.setCode(applyCode);
			...
			{		
				...
				if(sTemp.equals("85")||sTemp.equals("71")||sTemp.equals("73")||sTemp.equals("77")||sTemp.equals("81")) {
					...
					//修改保存，删除登记簿
					deliveryOrderServiceOperation.deleteDeliveryOrder(doInfo);
				}
				if(deliveryOrderInfo.getQuantity() == 0){
					deliveryOrderInfo.setNetPriceAmount(deliveryOrderInfo.getAmount());
				}
			...
			if(Long.toString(deliveryOrderInfo.getTransactionTypeId()).substring(0,2).equals("85")) {
				...
				registerID = deliveryOrderServiceOperation.saveDeliveryOrder(deliveryOrderInfo);
	...
	*/
	public void check(DeliveryOrderInfo deliveryOrderInfo) throws java.rmi.RemoteException,SecuritiesException
	{
		...
		if(sTemp.equals("85")||sTemp.equals("71")||sTemp.equals("73")||sTemp.equals("77")||sTemp.equals("81")) {
			...
			DeliveryOrderServiceBiz deliveryOrderServiceOperation = new DeliveryOrderServiceBiz(); 
			deliveryOrderServiceOperation.checkDeliveryOrder(deliveryOrderInfo);
		}
	}
	/**
	 *交割单的批量复核操作
...
//				更新交割单
		...
		if(Long.toString(deliveryOrderInfo.getTransactionTypeId()).substring(0,2).equals("85")) {
			...
			DeliveryOrderServiceBiz deliveryOrderServiceOperation = new DeliveryOrderServiceBiz(); 
			deliveryOrderServiceOperation.cancelCheckDeliveryOrder(deliveryOrderInfo);
		}
	}	
	/**
	 *交割单的批量取消复核操作
...
//		初始化数据库联接
	...
	*/
	...
	public Collection getAllNotRepayDeliveryOrder(DeliveryOrderConditionInfo conditionInfo) throws java.rmi.RemoteException,SecuritiesException{
		...
		col = dao.getDeliveryOrderByIds(conditionInfo,deliveryOrderIds,1);
	...
	*/
	...
	public Map getDeliveryOrderSumInfo(DeliveryOrderConditionInfo deliveryOrderConditionInfo) throws java.rmi.RemoteException,SecuritiesException 
	{
		SEC_DeliveryOrderDAO deliveryOrderDAO = new SEC_DeliveryOrderDAO();
		return deliveryOrderDAO.getDeliveryOrderSumInfo(deliveryOrderConditionInfo);
	}	
