...
public class BudgetException extends ITreasuryException{
    ...
    public BudgetException(SessionContext sc) {
        super("Gen_E001", null,sc);
     ...
     */
    public BudgetException(Throwable cause,SessionContext sc) {
     ...
     */
    public BudgetException(String errorCode, Throwable cause) {
     ...
     * @param sc          容器的上下文
     */
    public BudgetException(String errorCode, Throwable cause, SessionContext sc) {
     ...
     * @param cause       产生本异常的异常或错误，如果没有传入null
     */
    public BudgetException(String errorCode, String str1, Throwable cause) {
     ...
     * @param cause       产生本异常的异常或错误，如果没有传入null
     */
    public BudgetException(String errorCode, String str1, Throwable cause, SessionContext sc) {
        super(errorCode, str1, cause);
        if (sc != null)
    		sc.setRollbackOnly();
    }
     ...
     * @param cause       产生本异常的异常或错误，如果没有传入null
     */
    public BudgetException(String errorCode, String astr1, String astr2, Throwable cause) {
     ...
     * @param cause       产生本异常的异常或错误，如果没有传入null
     */
    public BudgetException(String errorCode, String astr1, String astr2, Throwable cause, SessionContext sc) {
        super(errorCode, astr1, astr2, cause);
        this.cause = cause;
        if (sc != null)
    		sc.setRollbackOnly();
     ...
     * @param cause       产生本异常的异常或错误，如果没有传入null
     */
    public BudgetException(String errorCode, String astr[], Throwable cause) {
     ...
     * @param cause       产生本异常的异常或错误，如果没有传入null
     */
    public BudgetException(String errorCode, String astr[], Throwable cause, SessionContext sc) {
        super(errorCode, astr, cause);
        this.cause = cause;
        if (sc != null)
    		sc.setRollbackOnly();
