...
public class DateUtil
{
	 ...
	 * @return
	 */
	public static Date getLocationDateTime(long regionUTCTime) throws SystemException
	{
		return getLocationDateTime(Env.getUTCDateTime().getTime(),regionUTCTime);
	}
	public static Date getLocationDateTime(long curUTCTime,long regionUTCTime) throws SystemException
	{
