...
import com.iss.itreasury.loan.mywork.bizlogic.LoanCalWorksBiz;
import com.iss.itreasury.loan.mywork.dataentity.LoanMyWorkInfo;
import com.iss.itreasury.loan.util.LOANConstant;
import com.iss.sysframe.pager.dataentity.PagerInfo;

public class LoanCalWorkAction {

	LoanCalWorksBiz biz = new LoanCalWorksBiz();
	...
	public PagerInfo queryLoanTransActionWork(Map map) throws Exception {
		...
		try {
			...
			qInfo.setQueryPurpose(LOANConstant.WorkType.CANCELAPPROVAL);
