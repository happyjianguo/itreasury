...
public class LoanContractStatusChangeDao extends LoanMyWorkDao {	
	...
	protected Collection queryCurrentWork(
		...
		sbSQL.append("from ");
		sbSQL.append(" v_loan_contractstatuschange vl,sys_approvalrecord ar");
		...
		sbSQL.append(" and ar.transId = vl.Id  and ar.actionId = "+ApprovalAction.CONTRACT_STATUS);
...
//				workInfo.setActionName(transRS.getString("actionName"));
				workInfo.setOldStatus(transRS.getLong("oldstatus"));
				workInfo.setChangeStatus(transRS.getLong("changestatus"));
	...
	protected void getFinishedWorkSql(LoanMyWorkInfo loanMyWorkInfo) {
		...
		m_sbFrom.append("  v_os_histroystep his,sys_approvalrecord re,V_LOAN_CONTRACTSTATUSCHANGE vl \n");
		m_sbFrom.append("  ,(SELECT max(his.id) hisid  FROM  v_os_histroystep his,sys_approvalrecord re,V_LOAN_CONTRACTSTATUSCHANGE vl \n");
		m_sbFrom.append("  WHERE his.entry_id = re.approvalentryid and re.transid = vl.Id and re.transtypeid =  vl.loanSubTypeId \n");
	...
	protected void getRefuseWorkSql(LoanMyWorkInfo loanMyWorkInfo) throws IException {
		...
		m_sbFrom = new StringBuffer();
		m_sbFrom.append(" (select distinct t.officeid,t.currencyid,t.moduleid,t.transtypeid,t.actionid,t.transid from sys_approvalrecord t) re,v_loan_contractstatuschange vl \n");
	...
	protected Collection queryWaitDealWithWork(LoanMyWorkInfo loanMyWorkInfo) throws IException {
		...
		sbSQL.append(" from v_loan_contractstatuschange vl ");
	...
	protected void getCancelApprovalSql(LoanMyWorkInfo loanMyWorkInfo)
		...
		// from
		m_sbFrom = new StringBuffer();
		m_sbFrom.append(" sys_approvalrecord re,v_loan_contractstatuschange vl");
