...
public class ClientInfo implements java.io.Serializable
{
	...
	//上海电气 4 个扩展属性 added by zntan 2004-12-14
	...
	//上海电气 显示行业分类 added by zntan 2005-1-19
	private long industryTypeID = -1;
	private String Name1="";//客户别称1 added by weihuang
	private String Name2="";//客户别称2 added by weihuang
	private long nIsfinancingcollection= -1;//是否资金规集 added by weihuang
    /**
     * function 得到客户标识
     * return ClientID
     */
