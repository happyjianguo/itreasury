 ...
 */
public class AssureManagementNoticeInfo extends LoanBaseDataEntity
{
    ...
    private long CurrentAccountID = -1;			//活期账户
    ...
    public void setAssureChargeRate(double assureChargeRate)
    {
        ...
        putUsedField("AssureChargeRate", AssureChargeRate);
    }
    /**
    ...
    public void setNextCheckUserName(String nextCheckUserName)
    {
        ...
        putUsedField("NextCheckUserName", NextCheckUserName);
    }
    /**
    ...
    public void setReceiveAccount(String receiveAccount)
    {
        ...
        putUsedField("ReceiveAccount", ReceiveAccount);
    }
    /**
    ...
    public void setReceiveClientName(String receiveClientName)
    {
        ...
        putUsedField("ReceiveClientName", ReceiveClientName);
    }
    /**
    ...
    public void setRemitInBank(String remitInBank)
    {
        ...
        putUsedField("RemitInBank", RemitInBank);
    }
    /**
    ...
    public void setRemitInCity(String remitInCity)
    {
        ...
        putUsedField("RemitInCity", RemitInCity);
    }
    /**
    ...
    public void setRemitInProvince(String remitInProvince)
    {
        ...
        putUsedField("RemitInProvince", RemitInProvince);
    }    
    /**
    ...
    public void setAmendsAmount(double amendsAmount)
    {
        ...
        putUsedField("AmendsAmount", AmendsAmount);
    }
    /**
    ...
    public void setCurrentAccountBalance(double currentAccountBalance)
    {
        ...
        putUsedField("CurrentAccountBalance", CurrentAccountBalance);
    }
    /**
