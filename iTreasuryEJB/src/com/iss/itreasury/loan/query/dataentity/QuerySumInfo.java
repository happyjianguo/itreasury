...
public class QuerySumInfo implements Serializable
{
    ...
    //指定余额日期贷款余额合计
    private double TotalDailyBalance=0;
    
    //展期金额合计
    private double TotalExtendAmount=0;
	...
	//贴现利息
	private double sumAllDiscountInterest=0.0;
	
	//贴现总金额
    private double TotalDiscountAmount=0;
	
	//贴现实付金额
	private double sumCheckAmount = 0.0;
	...
	/**
	 * @return Returns the sumCheckAmount.
	 */
	public double getSumCheckAmount()
	{
		return sumCheckAmount;
	}
	/**
	 * @param sumCheckAmount The sumCheckAmount to set.
	 */
	public void setSumCheckAmount(double sumCheckAmount)
	{
		this.sumCheckAmount = sumCheckAmount;
	}


	public double getSumAllDiscountInterest() {
		return sumAllDiscountInterest;
	}

	public void setSumAllDiscountInterest(double sumAllDiscountInterest) {
		this.sumAllDiscountInterest = sumAllDiscountInterest;
	}
	...
	public double getTotalDailyBalance() {
		return TotalDailyBalance;
	}

	public void setTotalDailyBalance(double totalDailyBalance) {
		TotalDailyBalance = totalDailyBalance;
	}

	public double getTotalExtendAmount() {
		return TotalExtendAmount;
	}

	public void setTotalExtendAmount(double totalExtendAmount) {
