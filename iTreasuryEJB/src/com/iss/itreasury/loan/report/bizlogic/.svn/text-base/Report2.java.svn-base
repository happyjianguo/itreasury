...
import com.iss.itreasury.loan.report.dao.Report2Dao;
...
// Referenced classes of package com.iss.itreasury.loan.report.bizlogic:
//            CommonBiz
...
public class Report2
{
     ...
     */ 
     ...
     throws Exception
 {
     ReportResultInfo infosFrom[] = (new Report2Dao()).queryLoanOperationBalanceDetail(wInfo);
