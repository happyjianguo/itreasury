 ...
 * @version 3.0
 */
public class Report1Dao extends LoanDAO {
	/** select */
	 ...
	 * @exception Exception
	 */
	public ReportResultInfo[] queryLoanOperationBalanceDetail(
...
//		m_sbWhere.append(" and (aa.ntypeid3="+LOANConstant.IndustryType2.PLATFORM+" or aa.ntypeid3="+LOANConstant.IndustryType2.LOCAL+")");
	...
	public static void main(String[] args) {
        ...
        try {
            ...
            Collection queryResults=(Collection)v;
		    Iterator iterator=queryResults.iterator();
		    System.out.println(v.size());
		    while(iterator!=null && iterator.hasNext())
		    {					  
			    com.iss.itreasury.loan.report.dataentity.ReportResultInfo tempInfo =( com.iss.itreasury.loan.report.dataentity.ReportResultInfo)iterator.next();
		        //System.out.println("====================");
			    System.out.println(DataFormat.formatString(tempInfo.getStringColumn1()));
			    System.out.println(DataFormat.formatString(tempInfo.getStringColumn3()));
		        System.out.println(DataFormat.formatDisabledAmount(tempInfo.getDoubleColumn1(),2));
		    }    
