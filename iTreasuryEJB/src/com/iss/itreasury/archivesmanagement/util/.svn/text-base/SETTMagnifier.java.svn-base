...
//					保证金显示单据号、可用余额、开户日期
	...
	//	String[] strDisplayFields = { "BranchNo", "BranchName" };//原显示列字段
		...
		if (strAccountCtrl != null && !strAccountCtrl.trim().equals(""))
		{
			strSQL = "getBranchSQLForZj(" + lOfficeID + "," + lCurrencyID + "," + lIsSingleBank + "," + strAccountCtrl + ".value," + strCtrlName + "Ctrl.value)";
		}
		else
		{
			strSQL = "getBranchSQLForZj(" + lOfficeID + "," + lCurrencyID + "," + lIsSingleBank + ",-1," + strCtrlName + "Ctrl.value)";
		}
		try
		{					
		...
		String strRtnBankNameCtrl)
	{
		...
		int nIndex = 0;
		String strSQL = "getExtAcctSQL(" + lOfficeID + "," + strCtrlName + "Ctrl.value)";
		try
		{
			SETTMagnifier.showZoomCtrl(
				out,
		...
		String strRtnBankNameCtrl)
	{
		...
		String[] strMainNames = { strCtrlName , strRtnAccountNoCtrl + "Ctrl", strRtnProvinceCtrl, strRtnCityCtrl, strRtnBankNameCtrl };
		String[] strMainFields = { "ExtAcctName", "ExtAcctNo", "ExtProvince", "ExtCity", "ExtBankName" };
...
//			}
	 ...
	 * @param strRtnBankAccountNoCtrl 返回值（银行账户编号）对应的控件名
	 */
	public static void createBranchCtrlForZj_tmp(
		JspWriter out,
		long lOfficeID,
		long lCurrencyID,
		String strFormName,
	...
	//	String[] strDisplayFields = { "BranchNo", "BranchName" };//原显示列字段
		...
		if (strAccountCtrl != null && !strAccountCtrl.trim().equals(""))
		{
			strSQL = "getBranchSQLForZj_tmp(" + lOfficeID + "," + lCurrencyID + "," + lIsSingleBank + "," + strAccountCtrl + ".value," + strCtrlName + "Ctrl.value)";
		}
		else
		{
			strSQL = "getBranchSQLForZj_tmp(" + lOfficeID + "," + lCurrencyID + "," + lIsSingleBank + ",-1," + strCtrlName + "Ctrl.value)";
		}
		try
		{					
